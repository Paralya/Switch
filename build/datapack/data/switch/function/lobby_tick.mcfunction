...
# Duality Jump (tick)
execute if score #players_in_lobby switch.data matches 1.. if block 20 79 94 stone_button[powered=true] run summon spectral_arrow 21.00 80.38 93.50 {Tags:["detached"],Motion:[1.5,0.085,0.0],Rotation:[90f,0f],pickup:0b,life:1170s}
...
execute if score #players_in_lobby switch.data matches 1.. if block 28 79 90 stone_button[powered=true] run summon spectral_arrow 26.95 80.38 90.50 {Tags:["detached"],Motion:[-1.5,0.093,0.0],Rotation:[-90f,0f],pickup:0b,life:1170s}
