...
execute positioned ~ ~ ~ facing entity @s eyes positioned as @s run tp @s ~ ~ ~ ~ ~

# Rotate 180 degrees (+ or -)
execute store result score #random switch.data run random value 0..1
execute if score #random switch.data matches 0 at @s run tp @s ~ ~ ~ ~-180 ~
execute if score #random switch.data matches 1 at @s run tp @s ~ ~ ~ ~180 ~
