...
#
# @within	switch:cinematic/launch {x:19.5, y:82.5, z:23.5, pitch:30, yaw:-15, time:60, with:{particle:1}}
#

## /execute as @s positioned 0 69 0 rotated -55 10 run function switch:cinematic/launch {x:19.5, y:82.5, z:23.5, pitch:30, yaw:-15, time:60, with:{particle:1}}
# TODO: Add rotation
...
# Get the arguments (target position (type: double), and time in ticks)
