...
data modify storage switch:main input set value {player:"@s", current_game:""}
data modify storage switch:main input.player set from block 0 13 0 Items[0].components."minecraft:profile".name
data modify storage switch:main input.current_game set from storage switch:main current_game
setblock 0 13 0 air
