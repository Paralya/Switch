...
#			switch:modes/layers_2_teams/tick {function:"switch:utils/classic_death"}
#			switch:modes/layers_4_teams/tick {function:"switch:utils/classic_death"}
...
#			switch:modes/murder_mystery/tick {function:"switch:utils/classic_death"}
#			switch:modes/one_shot/tick {function:"switch:modes/one_shot/death"}
#			switch:modes/panic_chase/tick {function:"switch:utils/classic_death"}
#			switch:modes/pillars_of_fortune/tick {function:"switch:utils/classic_death"}
...
#			switch:modes/sheepwars/tick {function:"switch:utils/classic_death"}
#			switch:modes/shoot_da_sheep/tick {function:"switch:utils/classic_death"}
