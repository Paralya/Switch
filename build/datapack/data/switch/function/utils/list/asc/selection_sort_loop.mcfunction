...
#> switch:utils/list/asc/selection_sort_loop
#
# @within	switch:utils/list/asc/sort
#			switch:utils/list/asc/selection_sort_loop
#
...
function switch:utils/list/asc/move_min_element with storage sorter:temp args
...
execute if score #sorted_count sorter.val matches ..14 if data storage sorter:temp original_array[0] run return run function switch:utils/list/asc/selection_sort_loop

# If limit reached, append remaining elements without sorting
execute if score #sorted_count sorter.val matches 15 run function switch:utils/list/asc/append_remaining
