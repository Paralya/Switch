...
#
# @within	switch:modes/layers_2_teams/start {id:"layers_2_teams", maps:["layers_2_teams"]}
...
#			switch:modes/race/start {id:"race", maps:["bowser_castle","snow_travel","mario_circuit","plains_routine","sakura_land","hills_land","airship_fortress","dk_mountain","clock_circuit","boat_race_1","boat_race_2"]}
