...
execute if score @s smithed.data matches 0 store result score @s smithed.data if score count smithed.data matches 1 if data storage smithed.crafter:input {"recipe": [{"count": 1, "components": {"minecraft:custom_data": {"switch": {"californium_block": true}}}}]} run loot replace block ~ ~ ~ container.16 loot switch:i/californium_ingot_x9
execute if score @s smithed.data matches 0 store result score @s smithed.data if score count smithed.data matches 1 if data storage smithed.crafter:input {"recipe": [{"count": 1, "components": {"minecraft:custom_data": {"switch": {"californium_ingot": true}}}}]} run loot replace block ~ ~ ~ container.16 loot switch:i/californium_nugget_x9
execute if score @s smithed.data matches 0 store result score @s smithed.data if score count smithed.data matches 1 if data storage smithed.crafter:input {"recipe": [{"count": 1, "components": {"minecraft:custom_data": {"switch": {"uranium_block": true}}}}]} run loot replace block ~ ~ ~ container.16 loot switch:i/uranium_ingot_x9
execute if score @s smithed.data matches 0 store result score @s smithed.data if score count smithed.data matches 1 if data storage smithed.crafter:input {"recipe": [{"count": 1, "components": {"minecraft:custom_data": {"switch": {"uranium_ingot": true}}}}]} run loot replace block ~ ~ ~ container.16 loot switch:i/uranium_nugget_x9
