...
execute if score #found simplenergy.data matches 0 store result score #found simplenergy.data if data storage simplenergy:main pulverizer.input{"components": {"minecraft:custom_data": {"switch": {"awakened_stardust": true}}}} run loot replace entity @s contents loot switch:i/awakened_stardust
execute if score #found simplenergy.data matches 0 store result score #found simplenergy.data if data storage simplenergy:main pulverizer.input{"components": {"minecraft:custom_data": {"switch": {"awakened_stardust_ore": true}}}} run loot replace entity @s contents loot switch:i/awakened_stardust_x2
