...
execute if score #dependency_error switch.data matches 0 if score $bs.dump.major load.status matches 4 unless score $bs.dump.minor load.status matches 1.. run scoreboard players set #dependency_error switch.data 1
...
execute if score #dependency_error switch.data matches 0 if score $bs.interaction.major load.status matches 4 unless score $bs.interaction.minor load.status matches 1.. run scoreboard players set #dependency_error switch.data 1
...
execute if score #dependency_error switch.data matches 0 if score $bs.random.major load.status matches 4 unless score $bs.random.minor load.status matches 1.. run scoreboard players set #dependency_error switch.data 1
...
execute if score #dependency_error switch.data matches 0 if score $bs.raycast.major load.status matches 4 unless score $bs.raycast.minor load.status matches 1.. run scoreboard players set #dependency_error switch.data 1
...
execute if score #dependency_error switch.data matches 0 if score $bs.spline.major load.status matches 4 unless score $bs.spline.minor load.status matches 1.. run scoreboard players set #dependency_error switch.data 1
...
execute if score #dependency_error switch.data matches 0 if score $bs.string.major load.status matches 4 unless score $bs.string.minor load.status matches 1.. run scoreboard players set #dependency_error switch.data 1
...
execute if score #dependency_error switch.data matches 0 if score #sheepwars.major load.status matches 2 if score #sheepwars.minor load.status matches 4 unless score #sheepwars.patch load.status matches 1.. run scoreboard players set #dependency_error switch.data 1
...
execute if score #dependency_error switch.data matches 0 if score #golf_ball.major load.status matches 1 unless score #golf_ball.minor load.status matches 6.. run scoreboard players set #dependency_error switch.data 1
...
execute if score #dependency_error switch.data matches 0 if score #shopping_kart.major load.status matches 1 if score #shopping_kart.minor load.status matches 4 unless score #shopping_kart.patch load.status matches 1.. run scoreboard players set #dependency_error switch.data 1
