...
execute if score #dependency_error switch.data matches 0 if score #smithed.custom_block.major load.status matches 0 unless score #smithed.custom_block.minor load.status matches 9.. run scoreboard players set #dependency_error switch.data 1
...
execute if score #dependency_error switch.data matches 0 if score #smithed.crafter.major load.status matches 0 unless score #smithed.crafter.minor load.status matches 9.. run scoreboard players set #dependency_error switch.data 1
...
execute if score #dependency_error switch.data matches 0 if score $bs.dump.major load.status matches 3 if score $bs.dump.minor load.status matches 2 unless score $bs.dump.patch load.status matches 2.. run scoreboard players set #dependency_error switch.data 1
...
execute if score #dependency_error switch.data matches 0 if score $bs.interaction.major load.status matches 3 if score $bs.interaction.minor load.status matches 2 unless score $bs.interaction.patch load.status matches 2.. run scoreboard players set #dependency_error switch.data 1
...
execute if score #dependency_error switch.data matches 0 if score $bs.random.major load.status matches 3 if score $bs.random.minor load.status matches 2 unless score $bs.random.patch load.status matches 2.. run scoreboard players set #dependency_error switch.data 1
execute if score #dependency_error switch.data matches 0 unless score $bs.raycast.major load.status matches 3.. run scoreboard players set #dependency_error switch.data 1
execute if score #dependency_error switch.data matches 0 if score $bs.raycast.major load.status matches 3 unless score $bs.raycast.minor load.status matches 2.. run scoreboard players set #dependency_error switch.data 1
execute if score #dependency_error switch.data matches 0 if score $bs.raycast.major load.status matches 3 if score $bs.raycast.minor load.status matches 2 unless score $bs.raycast.patch load.status matches 2.. run scoreboard players set #dependency_error switch.data 1
...
execute if score #dependency_error switch.data matches 0 if score $bs.spline.major load.status matches 3 if score $bs.spline.minor load.status matches 2 unless score $bs.spline.patch load.status matches 2.. run scoreboard players set #dependency_error switch.data 1
