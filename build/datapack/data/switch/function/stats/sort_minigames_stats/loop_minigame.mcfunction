...
#
# @within	switch:stats/sort_minigames_stats/loop_minigame with storage switch:main copy[0]
#			switch:stats/sort_minigames_stats/main with storage switch:main copy[0]
#
