...
#
# @within	switch:modes/feed_fast/calls/start
#
...
function switch:maps/choose_map_for {id:"feed_fast", maps:["mushroom_plains","friends_pvpbox_ice","friends_pvpbox_hills","friends_pvpbox_end","kart_racer_relai","nature_house"]}
