...
#> switch:modes/mlg_a_coudre/tick
#
# @within	switch:modes/mlg_a_coudre/calls/tick
#
...
execute if score #detect_end switch.data matches 0 unless entity @a[tag=!detached,gamemode=adventure] if entity @a[tag=!detached] run function switch:modes/mlg_a_coudre/next_player
