...
execute at @e[type=warden,tag=!switch.glowed] if predicate switch:chance/0.25 run summon spider ~ ~ ~ {attributes:[{id:"minecraft:scale",base:0.35},{id:"minecraft:max_health",base:2}],Health:2f}
