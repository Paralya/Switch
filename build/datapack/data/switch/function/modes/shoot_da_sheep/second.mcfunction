...
execute as @a[predicate=switch:chance/0.5] if score #shoot_da_sheep_seconds switch.data matches 0.. in minecraft:overworld run function switch:modes/shoot_da_sheep/summon_sheep
