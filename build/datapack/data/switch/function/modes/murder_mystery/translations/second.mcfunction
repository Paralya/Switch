...
#> switch:modes/murder_mystery/translations/second
#
# @within	switch:modes/murder_mystery/second
#

# French
execute if score #murder_mystery_seconds switch.data matches 0 run title @a[scores={switch.lang=0,switch.temp.role=1..},tag=!detached] title {"text":"Vous êtes"}
...
# English
execute if score #murder_mystery_seconds switch.data matches 0 run title @a[scores={switch.lang=1,switch.temp.role=1..},tag=!detached] title {"text":"You are"}
