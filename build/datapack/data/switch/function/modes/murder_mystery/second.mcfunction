...
execute if score #murder_mystery_seconds switch.data matches 0 as @a[scores={switch.temp.role=3}] if data entity @s {SelectedItemSlot:0} run item replace entity @s hotbar.1 with golden_sword[custom_data={switch:{murder_knife:true}},unbreakable={show_in_tooltip:0b},attribute_modifiers={modifiers:[{type:"attack_damage",slot:"mainhand",id:"switch.weapon",amount:11111111,operation:"add_value"}],show_in_tooltip:0b},consumable={consume_seconds:1024}]
execute if score #murder_mystery_seconds switch.data matches 0 as @a[scores={switch.temp.role=3}] unless data entity @s {SelectedItemSlot:0} run item replace entity @s hotbar.0 with golden_sword[custom_data={switch:{murder_knife:true}},unbreakable={show_in_tooltip:0b},attribute_modifiers={modifiers:[{type:"attack_damage",slot:"mainhand",id:"switch.weapon",amount:11111111,operation:"add_value"}],show_in_tooltip:0b},consumable={consume_seconds:1024}]
