...
data modify storage switch:layout kit set value {reserved:[],items:[{i:0,role:"melee",claim:1,canon:1,sibling:0},{i:1,role:"ranged",claim:1,canon:2,sibling:0},{i:2,role:"mobility",claim:1,canon:3,sibling:0},{i:3,role:"tool",claim:1,canon:4,sibling:0},{i:4,role:"axe",claim:1,canon:5,sibling:0},{i:5,role:"ammo",claim:1,canon:7,sibling:0},{i:6,role:"blocks",claim:1,canon:8,sibling:0},{i:7,role:"heal",claim:1,canon:9,sibling:0},{i:8,role:"special",claim:1,canon:6,sibling:0}]}
function switch:player/layout/resolve
function switch:modes/castagne/give_items/items with storage switch:layout out
