...
item replace entity @s hotbar.0 with bow[unbreakable=true,tooltip_display={"hidden_components":["minecraft:unbreakable"]},enchantments={"power":1},can_break={blocks:"#switch:rush_the_point/can_break"}]
