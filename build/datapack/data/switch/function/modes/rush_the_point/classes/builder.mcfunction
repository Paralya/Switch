...
item replace entity @s hotbar.0 with iron_sword[unbreakable=true,tooltip_display={"hidden_components":["minecraft:unbreakable"]},enchantments={"knockback":1},can_break={blocks:"#switch:rush_the_point/can_break"}]
