...
item replace entity @s[team=switch.rush_the_point.blue] armor.head with leather_helmet[unbreakable={show_in_tooltip:false},dyed_color=546752,enchantments={"protection":4}]
item replace entity @s[team=switch.rush_the_point.blue] armor.legs with leather_leggings[unbreakable={show_in_tooltip:false},dyed_color=546752,enchantments={"protection":4}]
...
item replace entity @s[team=switch.rush_the_point.red] armor.head with leather_helmet[unbreakable={show_in_tooltip:false},dyed_color=13369344,enchantments={"protection":4}]
item replace entity @s[team=switch.rush_the_point.red] armor.legs with leather_leggings[unbreakable={show_in_tooltip:false},dyed_color=13369344,enchantments={"protection":4}]
