...
#> switch:modes/kart_racer/second
#
# @within	switch:modes/kart_racer/calls/second
#
...
execute if score #kart_racer_seconds switch.data matches 0.. as @a[tag=!detached] run attribute @s gravity base reset
