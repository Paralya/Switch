...
#> switch:modes/kart_racer/map_tick/dk_mountain_tp
#
# @within	switch:modes/kart_racer/map_tick/dk_mountain
#
...
execute if score @s switch.temp.compteur matches 1 run playsound entity.generic.explode block @a[tag=!detached] 19982 117 20542
