...
#> switch:modes/kart_racer/classement/main
#
# @within	switch:modes/kart_racer/second
#
...
execute as @a[tag=!detached] run function switch:modes/kart_racer/classement/find_anyone_in_same_cp
execute as @a[tag=!detached] run function switch:modes/kart_racer/classement/try
