...
#> switch:modes/kart_racer/checkpoints/remember/
#
...
execute as @e[tag=shopping_kart.kart,predicate=switch:have_temp_player_passenger] run function switch:modes/kart_racer/checkpoints/remember/get_from_kart
