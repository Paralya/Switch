...
execute at @a[tag=!detached,gamemode=!spectator] run fill ~-10 ~-10 ~-10 ~10 ~10 ~10 command_block{Command:"function switch:modes/fish_fight/block_disappear/replace_white",auto:true} replace white_concrete
execute at @a[tag=!detached,gamemode=!spectator] run fill ~-10 ~-10 ~-10 ~10 ~10 ~10 command_block{Command:"function switch:modes/fish_fight/block_disappear/replace_blue",auto:true} replace blue_concrete
execute at @a[tag=!detached,gamemode=!spectator] run fill ~-10 ~-10 ~-10 ~10 ~10 ~10 command_block{Command:"function switch:modes/fish_fight/block_disappear/replace_red",auto:true} replace red_concrete
