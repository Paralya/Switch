...
item replace entity @s armor.chest with golden_chestplate[enchantments={binding_curse:1,"switch:invulnerable":1},attribute_modifiers=[{type:"knockback_resistance",slot:"chest",id:"switch.invulnerable",amount:100,operation:"add_value"}]]
