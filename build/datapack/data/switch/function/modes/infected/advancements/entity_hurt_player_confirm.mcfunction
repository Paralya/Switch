...
#
# @within	switch:modes/infected/advancements/entity_hurt_player
#
...
execute if score #zombie_attacker switch.data matches 1 if score #temp switch.data matches 1 run scoreboard players operation #damage switch.data *= #2 switch.data
