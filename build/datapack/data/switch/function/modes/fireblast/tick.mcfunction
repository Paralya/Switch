...
execute if score #fireblast_seconds switch.data matches 1.. if score #remaining_players switch.data matches ..0 run function switch:modes/fireblast/process_end
