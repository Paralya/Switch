...
execute as @a[tag=!detached,gamemode=adventure,scores={switch.right_click=1..},nbt={SelectedItem:{components:{}}}] unless score @s switch.temp.cooldown matches 1.. at @s run function switch:modes/fireblast/fireball/right_click
