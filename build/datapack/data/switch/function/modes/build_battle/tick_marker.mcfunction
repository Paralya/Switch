...
execute if score #build_battle_state switch.data matches ..1 unless block ~3 ~7 ~3 #switch:build_battle_antiground unless blocks ~3 ~7 ~3 ~3 ~7 ~3 ~3 ~-2 ~3 masked run function switch:modes/build_battle/building_time/change_ground
