...
#
# @within	switch:modes/race/classement/has_same_classement [ at @e[type=marker,tag=switch.checkpoint,predicate=switch:has_same_checkpoint,sort=nearest,limit=1] & as @a[tag=!...,sort=nearest] ]
#
