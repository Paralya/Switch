...
# @executed	at @s
#
# @within	switch:modes/kart_racer/map_tick/clock_circuit_tp
#			switch:modes/race/map_tick/clock_circuit [ as @e[tag=switch.vehicle,scores={switch.temp.compteur=1..}] & at @s ]
#
