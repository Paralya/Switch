...
#> switch:modes/race/map_tick/airship_fortress_tp
#
# @executed	as @e[tag=shopping_kart.kart,scores={switch.temp.compteur=1..}]
#
# @within	switch:modes/kart_racer/map_tick/airship_fortress_tp
#			switch:modes/race/map_tick/airship_fortress [ as @e[tag=switch.vehicle,scores={switch.temp.compteur=1..}] ]
#
