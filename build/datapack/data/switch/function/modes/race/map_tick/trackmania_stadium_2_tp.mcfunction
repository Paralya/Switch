...
#
# @within	switch:modes/kart_racer/map_tick/trackmania_stadium_2_tp
#			switch:modes/race/map_tick/trackmania_stadium_2 [ as @e[tag=switch.vehicle,scores={switch.temp.compteur=1..}] ]
#
