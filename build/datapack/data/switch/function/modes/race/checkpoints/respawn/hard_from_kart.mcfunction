...
#
# @within	switch:modes/race/checkpoints/respawn/hard [ at @e[tag=switch.checkpoint,predicate=switch:has_same_respawn_cp_id] & as @e[tag=shopping_kart.kart,predicate=switch:have_temp_player_passenger] ]
#
