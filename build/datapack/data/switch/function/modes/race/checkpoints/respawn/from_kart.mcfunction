...
#
# @within	switch:modes/kart_racer/checkpoints/respawn/from_kart
#			switch:modes/race/checkpoints/respawn/from_marker [ at @s & as @n[tag=switch.vehicle,predicate=switch:have_temp_player_passenger] ]
#
