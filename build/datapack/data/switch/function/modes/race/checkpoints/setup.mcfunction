...
execute store result score @s switch.temp.x run data get entity @s Pos[0]
execute store result score @s switch.temp.y run data get entity @s Pos[1]
execute store result score @s switch.temp.z run data get entity @s Pos[2]
