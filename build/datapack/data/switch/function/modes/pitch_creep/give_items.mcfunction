...
execute if score #random switch.data matches 0 run item replace entity @s hotbar.1 with bow[unbreakable={show_in_tooltip:false},enchantments={"punch":3}]
execute if score #random switch.data matches 1 run item replace entity @s hotbar.1 with bow[unbreakable={show_in_tooltip:false},enchantments={"punch":3}]
execute if score #random switch.data matches 2 run item replace entity @s hotbar.1 with bow[unbreakable={show_in_tooltip:false},enchantments={"punch":3}]
