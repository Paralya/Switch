...
# Spawning creepers
execute if score #pitch_creep_seconds switch.data matches 0.. at @n[type=marker,tag=switch.selected_map] run summon creeper ~-.2 ~ ~ {Health:2048.0f,Tags:["switch.new"],attributes:[{id:"generic.max_health",base:2048.0},{id:"generic.follow_range",base:128}]}
execute if score #pitch_creep_seconds switch.data matches 0.. at @n[type=marker,tag=switch.selected_map] run summon creeper ~.2 ~ ~ {Health:2048.0f,Tags:["switch.new"],attributes:[{id:"generic.max_health",base:2048.0},{id:"generic.follow_range",base:128}]}
