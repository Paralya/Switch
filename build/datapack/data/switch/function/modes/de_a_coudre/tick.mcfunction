...
execute unless score #rounds switch.data matches 0 if score #detect_end switch.data matches 0 unless entity @a[tag=!detached,gamemode=adventure] if entity @a[tag=!detached] run function switch:modes/de_a_coudre/next_player
