...
#> switch:modes/minigolf/check_lost_ball
#
...
execute if entity @s[tag=switch.in_hole] run scoreboard players set #finished switch.data 1
...
# Gave up
function switch:modes/minigolf/translations/check_lost_ball
