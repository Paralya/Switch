...
#> switch:modes/spectres_game/tick
#
# @within	switch:modes/spectres_game/calls/tick
#
...
execute as @e[tag=switch.task_obsidian] at @s unless block ~ ~-1 ~ #minecraft:air run function switch:modes/spectres_game/place_obsidian_from_chicken
