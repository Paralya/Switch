...
#
# @within	switch:modes/beat_the_kings/calls/start
#
...
give @r[team=switch.temp.king] splash_potion[custom_name='{"text":"Potion dévastatrice du tyran","italic":false}',lore=['{"text":"À lancer sur les civils","color":"white","italic":false}'],potion_contents={potion:"minecraft:water",custom_color:7039516,custom_effects:[{id:"slowness",amplifier:0b,duration:400,show_particles:0b},{id:"mining_fatigue",amplifier:0b,duration:400,show_particles:0b},{id:"blindness",amplifier:0b,duration:110,show_particles:0b}]}]
give @r[team=switch.temp.king] splash_potion[custom_name='{"text":"Potion destructrice du tyran","italic":false}',lore=['{"text":"À lancer sur les civils","color":"white","italic":false}'],potion_contents={potion:"minecraft:water",custom_color:5711412,custom_effects:[{id:"slowness",amplifier:0b,duration:400,show_particles:0b},{id:"nausea",amplifier:1b,duration:200,show_particles:0b},{id:"poison",amplifier:0b,duration:320,show_particles:0b}]}]
give @r[team=switch.temp.king] splash_potion[custom_name='{"text":"Potion de malnutrition du tyran","italic":false}',lore=['{"text":"À lancer sur les civils","color":"white","italic":false}'],potion_contents={custom_color:12763581,custom_effects:[{id:"mining_fatigue",amplifier:1b,duration:60},{id:"hunger",amplifier:1b,duration:300},{id:"poison",amplifier:1b,duration:40}]}]
