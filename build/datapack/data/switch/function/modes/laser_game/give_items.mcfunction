...
item replace entity @s hotbar.0 with warped_fungus_on_a_stick[unbreakable={show_in_tooltip:0b},custom_name='{"text":"Fusil-Laser","italic":false}',lore=['{"text":"[Une balle par seconde]","color":"gray","italic":false}'],custom_model_data=2010000]
