...
function switch:maps/choose_map_for {id:"traitors_game", maps:["traitor_original","mushroom_plains","trials_run","hider_mansion","bancalvivor_s3","stardust_pvp_zone","la_fromagerie"]}
...
scoreboard players set #traitors_game_seconds switch.data -6
...
scoreboard objectives add switch.temp.announced dummy
