...
#> switch:modes/capture_the_flag/classes/tank/items
#
# @executed	as the player & at current position
#
# @within	switch:modes/capture_the_flag/classes/tank with storage switch:layout out
#
# @args		s0 (unknown)
#			s1 (unknown)
#			s2 (unknown)
...
$item replace entity @s $(s2) with golden_apple 2
...
$item replace entity @s[team=switch.temp.red] $(s4) with red_wool 18
$item replace entity @s[team=switch.temp.blue] $(s4) with blue_wool 18
$item replace entity @s $(s5) with bread 21
