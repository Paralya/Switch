...
execute positioned 2997 128 2997 as @a[tag=!detached,dx=6,dy=3,dz=6] run function switch:modes/glassrunner/ctp/center/adding_timer
execute positioned 2997 128 2997 unless entity @a[tag=!detached,dx=6,dy=3,dz=6] run function switch:modes/glassrunner/ctp/center/reset
...
data modify storage switch:main input set value {red:0,blue:0,mins:0,secs:0,zero:""}
...
execute store result storage switch:main input.mins int 1 run scoreboard players get #mins switch.data
execute store result storage switch:main input.secs int 1 run scoreboard players get #secs switch.data
execute if score #secs switch.data matches 0..9 run data modify storage switch:main input.zero set value "0"
