...
#
# @within	switch:modes/pitchout/calls/start
#
...
function switch:maps/choose_map_for {id:"pitchout", maps:["pitchout_1","pitchout_halloween"]}
...
scoreboard players set #pitchout_seconds switch.data -4
