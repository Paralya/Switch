...
#> switch:modes/memory_mine/second
#
# @within	switch:modes/memory_mine/calls/second
#
...
execute if score #temp switch.data matches 5 in minecraft:overworld run function switch:modes/memory_mine/zone/summon
