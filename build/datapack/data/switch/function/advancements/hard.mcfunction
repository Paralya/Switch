...
#			advancement switch:visible/18
#			advancement switch:visible/22
#			advancement switch:visible/24
#			advancement switch:visible/25
#			advancement switch:visible/27
#			advancement switch:visible/30
#			advancement switch:visible/39
...
#			advancement switch:visible/53
#			advancement switch:visible/54
#			advancement switch:visible/57
#			advancement switch:visible/60
