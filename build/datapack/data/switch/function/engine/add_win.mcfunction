...
#
# @within	switch:modes/_common/process_end/winner_by_points [ as @a[tag=!...] & at @s ]
#			switch:modes/_common/process_end/last_survivor [ as @a[tag=!detached,gamemode=adventure] & at @s ]
#			switch:modes/_common/process_end/winner_by_health [ as @a[tag=!detached,gamemode=survival] & at @s ]
...
#			switch:modes/glassrunner/end/process_end [ as @a[tag=!detached,team=switch.glassrunner.red] & at @s ]
#			switch:modes/glassrunner/end/process_end [ as @a[tag=!detached,team=switch.glassrunner.blue] & at @s ]
...
#			switch:modes/one_shot/process_end [ as @a[tag=!detached] & at @s ]
...
#			switch:modes/race/process_end [ as @a[team=switch.temp.1,tag=!detached,scores={switch.alive=2}] & at @s ]
