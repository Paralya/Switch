...
#
# @within	switch:tick
#			switch:engine/disable [ in switch:game ]
#			switch:engine/restart [ in switch:game ]
#

execute unless score #engine_state switch.data matches 3 unless score #disable switch.data matches 1 in minecraft:overworld run tp @a[tag=!detached] 0 69 0
