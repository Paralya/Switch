...
#> switch:choose_map_for/beat_the_kings
#
...
data modify storage switch:main maps_to_choose set from storage switch:main beat_the_kings_maps
...
# Passage en paramètre de la liste des maps à charger
data modify storage switch:main copy set from storage switch:main beat_the_kings_maps

# Suppression de la map chargée de la liste des maps à charger
function switch:maps/storage_map_list/remove_from_storage

# Application de la nouvelle liste des maps à charger
data modify storage switch:main beat_the_kings_maps set from storage switch:main new
