...
#> switch:music/ticks/at_the_speed_of_light
#
...
execute if score #temp switch.data >= #at_the_speed_of_light switch.music.progress run function switch:music/music_over
