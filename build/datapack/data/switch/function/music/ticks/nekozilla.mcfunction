...
data modify storage switch:temp input set value {tick:0,name:"nekozilla"}
...
execute if score #temp switch.data >= #nekozilla switch.music.progress run function switch:music/music_over
