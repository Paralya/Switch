...
data modify storage switch:temp input set value {tick:0,name:"mayday"}
...
execute if score #temp switch.data >= #mayday switch.music.progress run function switch:music/music_over
