...
data modify storage switch:temp input set value {tick:0,name:"main_theme"}
...
execute if score #temp switch.data >= #main_theme switch.music.progress run function switch:music/music_over
