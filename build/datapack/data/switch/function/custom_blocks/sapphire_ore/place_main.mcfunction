...
#> switch:custom_blocks/sapphire_ore/place_main
#
...
execute align xyz positioned ~0.5 ~0.5 ~0.5 summon item_display at @s run function switch:custom_blocks/sapphire_ore/place_secondary
...
scoreboard players add #total_sapphire_ore switch.data 1
