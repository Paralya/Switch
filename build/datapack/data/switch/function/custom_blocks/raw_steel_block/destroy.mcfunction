...
execute as @e[type=item,nbt={Item:{id:"minecraft:raw_iron_block"}},limit=1,sort=nearest,distance=..1] run function switch:custom_blocks/raw_steel_block/replace_item
