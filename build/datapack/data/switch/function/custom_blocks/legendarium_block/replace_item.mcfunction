...
#
# @executed	as @n[type=item,nbt={Item:{id:"minecraft:lime_concrete"}},distance=..1]
#
# @within	switch:custom_blocks/legendarium_block/destroy [ as @n[type=item,nbt={Item:{id:"minecraft:lime_concrete"}},distance=..1] ]
#
