...
execute if data storage smithed.custom_block:main blockApi{id:"switch:stardust_block"} run function switch:custom_blocks/stardust_block/place_main
execute if data storage smithed.custom_block:main blockApi{id:"switch:stardust_ore"} run function switch:custom_blocks/stardust_ore/place_main
execute if data storage smithed.custom_block:main blockApi{id:"switch:deepslate_stardust_ore"} run function switch:custom_blocks/deepslate_stardust_ore/place_main
execute if data storage smithed.custom_block:main blockApi{id:"switch:awakened_stardust_block"} run function switch:custom_blocks/awakened_stardust_block/place_main
execute if data storage smithed.custom_block:main blockApi{id:"switch:awakened_stardust_ore"} run function switch:custom_blocks/awakened_stardust_ore/place_main
execute if data storage smithed.custom_block:main blockApi{id:"switch:legendarium_block"} run function switch:custom_blocks/legendarium_block/place_main
execute if data storage smithed.custom_block:main blockApi{id:"switch:solarium_block"} run function switch:custom_blocks/solarium_block/place_main
execute if data storage smithed.custom_block:main blockApi{id:"switch:darkium_block"} run function switch:custom_blocks/darkium_block/place_main
...
execute if data storage smithed.custom_block:main blockApi{id:"switch:ender_stardust_ore"} run function switch:custom_blocks/ender_stardust_ore/place_main
execute if data storage smithed.custom_block:main blockApi{id:"switch:nether_stardust_ore"} run function switch:custom_blocks/nether_stardust_ore/place_main
