...
#> switch:custom_blocks/sapphire_block/place_main
#
...
execute align xyz positioned ~0.5 ~0.5 ~0.5 summon item_display at @s run function switch:custom_blocks/sapphire_block/place_secondary
...
scoreboard players add #total_sapphire_block switch.data 1
