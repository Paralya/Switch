...
# Selling Snow blocks
execute if score @s switch.trigger.shop matches 10301 if score @s switch.spleef.snow_block matches 1 store success score #success switch.data run scoreboard players add @s switch.money 40
execute if score @s switch.trigger.shop matches 10301 if score @s switch.spleef.snow_block matches 2 store success score #success switch.data run scoreboard players add @s switch.money 80
execute if score @s switch.trigger.shop matches 10301 if score @s switch.spleef.snow_block matches 3 store success score #success switch.data run scoreboard players add @s switch.money 120
execute if score @s switch.trigger.shop matches 10301 if score @s switch.spleef.snow_block matches 4 store success score #success switch.data run scoreboard players add @s switch.money 160
execute if score @s switch.trigger.shop matches 10301 if score @s switch.spleef.snow_block matches 5 store success score #success switch.data run scoreboard players add @s switch.money 200
execute if score @s switch.trigger.shop matches 10301 if score @s switch.spleef.snow_block matches 6.. store success score #success switch.data run scoreboard players add @s switch.money 240

execute if score @s switch.trigger.shop matches 10301 if score #success switch.data matches 1.. run scoreboard players remove @s switch.spleef.snow_block 1
execute if score @s switch.trigger.shop matches 10301 if score #success switch.data matches 1.. run playsound entity.player.levelup ambient @s
...
# Selling Powder snow
execute if score @s switch.trigger.shop matches 10302 if score @s switch.spleef.powder_snow matches 1 store success score #success switch.data run scoreboard players add @s switch.money 40
execute if score @s switch.trigger.shop matches 10302 if score @s switch.spleef.powder_snow matches 2 store success score #success switch.data run scoreboard players add @s switch.money 80
execute if score @s switch.trigger.shop matches 10302 if score @s switch.spleef.powder_snow matches 3 store success score #success switch.data run scoreboard players add @s switch.money 120
execute if score @s switch.trigger.shop matches 10302 if score @s switch.spleef.powder_snow matches 4.. store success score #success switch.data run scoreboard players add @s switch.money 160

execute if score @s switch.trigger.shop matches 10302 if score #success switch.data matches 1.. run scoreboard players remove @s switch.spleef.powder_snow 1
execute if score @s switch.trigger.shop matches 10302 if score #success switch.data matches 1.. run playsound entity.player.levelup ambient @s
