...
execute if score @s switch.trigger.shop matches 10401 if score @s switch.sheepwars.kit_health matches 1 store success score #success switch.data run scoreboard players add @s switch.money 80
execute if score @s switch.trigger.shop matches 10401 if score @s switch.sheepwars.kit_health matches 2 store success score #success switch.data run scoreboard players add @s switch.money 120
execute if score @s switch.trigger.shop matches 10401 if score @s switch.sheepwars.kit_health matches 3 store success score #success switch.data run scoreboard players add @s switch.money 160
execute if score @s switch.trigger.shop matches 10401 if score @s switch.sheepwars.kit_health matches 4.. store success score #success switch.data run scoreboard players add @s switch.money 200

execute if score @s switch.trigger.shop matches 10401 if score #success switch.data matches 1.. run scoreboard players remove @s switch.sheepwars.kit_health 1
execute if score @s switch.trigger.shop matches 10401 if score #success switch.data matches 1.. run playsound entity.player.levelup ambient @s
...
execute if score @s switch.trigger.shop matches 10402 if score @s switch.sheepwars.kit_bow matches 1 store success score #success switch.data run scoreboard players add @s switch.money 80
execute if score @s switch.trigger.shop matches 10402 if score @s switch.sheepwars.kit_bow matches 2 store success score #success switch.data run scoreboard players add @s switch.money 120
execute if score @s switch.trigger.shop matches 10402 if score @s switch.sheepwars.kit_bow matches 3 store success score #success switch.data run scoreboard players add @s switch.money 160
execute if score @s switch.trigger.shop matches 10402 if score @s switch.sheepwars.kit_bow matches 4.. store success score #success switch.data run scoreboard players add @s switch.money 200

execute if score @s switch.trigger.shop matches 10402 if score #success switch.data matches 1.. run scoreboard players remove @s switch.sheepwars.kit_bow 1
execute if score @s switch.trigger.shop matches 10402 if score #success switch.data matches 1.. run playsound entity.player.levelup ambient @s
...
execute if score @s switch.trigger.shop matches 10403 if score @s switch.sheepwars.kit_sword matches 1 store success score #success switch.data run scoreboard players add @s switch.money 80
execute if score @s switch.trigger.shop matches 10403 if score @s switch.sheepwars.kit_sword matches 2 store success score #success switch.data run scoreboard players add @s switch.money 120
execute if score @s switch.trigger.shop matches 10403 if score @s switch.sheepwars.kit_sword matches 3 store success score #success switch.data run scoreboard players add @s switch.money 160
execute if score @s switch.trigger.shop matches 10403 if score @s switch.sheepwars.kit_sword matches 4.. store success score #success switch.data run scoreboard players add @s switch.money 200

execute if score @s switch.trigger.shop matches 10403 if score #success switch.data matches 1.. run scoreboard players remove @s switch.sheepwars.kit_sword 1
execute if score @s switch.trigger.shop matches 10403 if score #success switch.data matches 1.. run playsound entity.player.levelup ambient @s
...
execute if score @s switch.trigger.shop matches 10404 if score @s switch.sheepwars.kit_more_sheep matches 1 store success score #success switch.data run scoreboard players add @s switch.money 80
execute if score @s switch.trigger.shop matches 10404 if score @s switch.sheepwars.kit_more_sheep matches 2 store success score #success switch.data run scoreboard players add @s switch.money 120
execute if score @s switch.trigger.shop matches 10404 if score @s switch.sheepwars.kit_more_sheep matches 3 store success score #success switch.data run scoreboard players add @s switch.money 160
execute if score @s switch.trigger.shop matches 10404 if score @s switch.sheepwars.kit_more_sheep matches 4.. store success score #success switch.data run scoreboard players add @s switch.money 200

execute if score @s switch.trigger.shop matches 10404 if score #success switch.data matches 1.. run scoreboard players remove @s switch.sheepwars.kit_more_sheep 1
execute if score @s switch.trigger.shop matches 10404 if score #success switch.data matches 1.. run playsound entity.player.levelup ambient @s
...
# Selling Kit 'Builder'
execute if score @s switch.trigger.shop matches 10405 if score @s switch.sheepwars.kit_builder matches 1 store success score #success switch.data run scoreboard players add @s switch.money 80
execute if score @s switch.trigger.shop matches 10405 if score @s switch.sheepwars.kit_builder matches 2 store success score #success switch.data run scoreboard players add @s switch.money 120
execute if score @s switch.trigger.shop matches 10405 if score @s switch.sheepwars.kit_builder matches 3 store success score #success switch.data run scoreboard players add @s switch.money 160
execute if score @s switch.trigger.shop matches 10405 if score @s switch.sheepwars.kit_builder matches 4.. store success score #success switch.data run scoreboard players add @s switch.money 200

execute if score @s switch.trigger.shop matches 10405 if score #success switch.data matches 1.. run scoreboard players remove @s switch.sheepwars.kit_builder 1
execute if score @s switch.trigger.shop matches 10405 if score #success switch.data matches 1.. run playsound entity.player.levelup ambient @s
...
execute if score @s switch.trigger.shop matches 10406 if score @s switch.sheepwars.kit_mobility matches 1 store success score #success switch.data run scoreboard players add @s switch.money 80
execute if score @s switch.trigger.shop matches 10406 if score @s switch.sheepwars.kit_mobility matches 2 store success score #success switch.data run scoreboard players add @s switch.money 120
execute if score @s switch.trigger.shop matches 10406 if score @s switch.sheepwars.kit_mobility matches 3 store success score #success switch.data run scoreboard players add @s switch.money 160
execute if score @s switch.trigger.shop matches 10406 if score @s switch.sheepwars.kit_mobility matches 4.. store success score #success switch.data run scoreboard players add @s switch.money 200

execute if score @s switch.trigger.shop matches 10406 if score #success switch.data matches 1.. run scoreboard players remove @s switch.sheepwars.kit_mobility 1
execute if score @s switch.trigger.shop matches 10406 if score #success switch.data matches 1.. run playsound entity.player.levelup ambient @s
...
execute if score @s switch.trigger.shop matches 10407 if score @s switch.sheepwars.kit_armored_sheep matches 1 store success score #success switch.data run scoreboard players add @s switch.money 80
execute if score @s switch.trigger.shop matches 10407 if score @s switch.sheepwars.kit_armored_sheep matches 2 store success score #success switch.data run scoreboard players add @s switch.money 120
execute if score @s switch.trigger.shop matches 10407 if score @s switch.sheepwars.kit_armored_sheep matches 3 store success score #success switch.data run scoreboard players add @s switch.money 160
execute if score @s switch.trigger.shop matches 10407 if score @s switch.sheepwars.kit_armored_sheep matches 4.. store success score #success switch.data run scoreboard players add @s switch.money 200

execute if score @s switch.trigger.shop matches 10407 if score #success switch.data matches 1.. run scoreboard players remove @s switch.sheepwars.kit_armored_sheep 1
execute if score @s switch.trigger.shop matches 10407 if score #success switch.data matches 1.. run playsound entity.player.levelup ambient @s


# Messages
execute if score @s switch.trigger.shop matches 400 run playsound block.note_block.bell ambient @s
function switch:shop/translations/sheepwars
