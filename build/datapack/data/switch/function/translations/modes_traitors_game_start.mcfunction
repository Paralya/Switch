...
#> switch:translations/modes_traitors_game_start
#
...
# English
tellraw @a[scores={switch.lang=1},tag=!detached] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Launching the Traitors Game, traitors will be present in the game with some peculiarities, you will receive your role in a few seconds!"}]
