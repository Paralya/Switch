...
#> switch:translations/modes_kart_racer_finished
#
# @executed	as @a[tag=!detached,predicate=switch:has_same_checkpoint]
#
# @within	switch:modes/kart_racer/finished
#
...
# English
tellraw @a[scores={switch.lang=1},tag=!detached] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" "},{"selector":"@s","color":"green"},{"text":" finished the race in "},{"score":{"name":"#kart_racer_seconds","objective":"switch.data"}},{"text":","},{"score":{"name":"#digit","objective":"switch.data"}},{"text":" seconds!\n"}]
