...
tellraw @s[scores={switch.lang=0,switch.trigger.help=-11..}] ["",{"text":"➤ ","color":"gold"},{"text":"/money : ","color":"yellow"},{"text":"Affiche votre argent actuel"}]
...
tellraw @s[scores={switch.lang=0,switch.trigger.help=-11..}] ["",{"text":"➤ ","color":"gold"},{"text":"/stats : ","color":"yellow"},{"text":"Affiche vos statistiques"}]
tellraw @s[scores={switch.lang=0,switch.trigger.help=-11..}] ["",{"text":"➤ ","color":"gold"},{"text":"/succes : ","color":"yellow"},{"text":"Affiche l'intégralité des succès"}]
