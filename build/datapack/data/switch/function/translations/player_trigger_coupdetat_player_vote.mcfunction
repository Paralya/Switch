...
# French
tellraw @s[scores={switch.lang=0}] [{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Vous avez décider de souteneir ce coup d'état ! Attendez la fin du vote pour savoir si vous avez réussi à renverser le gouvernement."}]
