...
$tellraw @s[scores={switch.lang=0}] [{"text":"➤ ","color":"yellow"},{"score":{"name":"$(player)","objective":"switch.money"},"color":"gold"},{"text":" pièces"}]
...
$tellraw @s[scores={switch.lang=1}] [{"text":"➤ ","color":"yellow"},{"score":{"name":"$(player)","objective":"switch.money"},"color":"gold"},{"text":" coins"}]
