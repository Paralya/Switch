...
# French
execute if score #detect_end switch.data matches 1 run tellraw @a[scores={switch.lang=0},tag=!detached] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Stupéfaction ! ","color":"green"},{"selector":"@s","color":"aqua"},{"text":" a réussi son coup d'état pour lancer le mini-jeu ","color":"green"},{"nbt":"coupdetat.name_fr","storage":"switch:main","color":"yellow"},{"text":" !\n","color":"green"}]
...
# English
execute if score #detect_end switch.data matches 1 run tellraw @a[scores={switch.lang=1},tag=!detached] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Stupefaction! ","color":"green"},{"selector":"@s","color":"aqua"},{"text":" successfully completed their coup d'état to launch the minigame ","color":"green"},{"nbt":"coupdetat.name_en","storage":"switch:main","color":"yellow"},{"text":"!\n","color":"green"}]
