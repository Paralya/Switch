...
execute if score #game_state switch.data matches 1 run tellraw @a[scores={switch.lang=0},tag=!detached] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Fin de partie, victoire des "},{"text":"gays","color":"light_purple"},{"text":" ! GG à "},{"selector":"@a[tag=!detached,gamemode=adventure,team=switch.temp.gays]"}]
...
execute if score #game_state switch.data matches 1 run tellraw @a[scores={switch.lang=1},tag=!detached] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Game over, victory for "},{"text":"gays","color":"light_purple"},{"text":"! GG to "},{"selector":"@a[tag=!detached,gamemode=adventure,team=switch.temp.gays]"}]
execute if score #game_state switch.data matches 2 run tellraw @a[scores={switch.lang=1},tag=!detached] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Game over, GG win"},{"text":"shooters","color":"gray"},{"text":"! GG to "},{"selector":"@a[tag=!detached,gamemode=adventure,team=switch.temp.shooters]"}]
