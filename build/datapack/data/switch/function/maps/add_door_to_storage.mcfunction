...
#			switch:maps/survival/ghost_town/scan_doors_on_marker {name:"ghost_town",additional_height:0}
#			switch:maps/survival/abandoned_city_spawn_circle/scan_doors_on_marker {name:"abandoned_city_spawn_circle",additional_height:0}
#			switch:maps/survival/abandoned_city/scan_doors_on_marker {name:"abandoned_city",additional_height:101}
#			switch:maps/survival/new_grounds/scan_doors_on_marker {name:"new_grounds",additional_height:0}
#			switch:maps/survival/cookie_wars/scan_doors_on_marker {name:"cookie_wars",additional_height:0}
#			switch:maps/survival/snow_hills/scan_doors_on_marker {name:"snow_hills",additional_height:0}
#			switch:maps/survival/boat_race_2/scan_doors_on_marker {name:"boat_race_2",additional_height:0}
