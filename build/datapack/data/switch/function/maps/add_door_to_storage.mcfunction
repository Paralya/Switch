...
# @executed	at @s
#
# @within	switch:maps/survival/switch_space/scan_doors_on_marker {name:"switch_space",additional_height:0} [ at @s ]
...
#			switch:maps/survival/elytra_box/scan_doors_on_marker {name:"elytra_box",additional_height:0} [ at @s ]
#			switch:maps/survival/enchanting_island/scan_doors_on_marker {name:"enchanting_island",additional_height:0} [ at @s ]
#			switch:maps/survival/friends_oneforall/scan_doors_on_marker {name:"friends_oneforall",additional_height:0} [ at @s ]
#			switch:maps/survival/friends_cube_jump/scan_doors_on_marker {name:"friends_cube_jump",additional_height:0} [ at @s ]
#			switch:maps/survival/warden_forest/scan_doors_on_marker {name:"warden_forest",additional_height:0} [ at @s ]
#			switch:maps/survival/friends_pvpbox_ice/scan_doors_on_marker {name:"friends_pvpbox_ice",additional_height:0} [ at @s ]
#			switch:maps/survival/friends_pvpbox_hills/scan_doors_on_marker {name:"friends_pvpbox_hills",additional_height:0} [ at @s ]
#			switch:maps/survival/friends_pvpbox_end/scan_doors_on_marker {name:"friends_pvpbox_end",additional_height:0} [ at @s ]
#			switch:maps/survival/friends_cube_lobby/scan_doors_on_marker {name:"friends_cube_lobby",additional_height:0} [ at @s ]
#			switch:maps/survival/coupdetat/scan_doors_on_marker {name:"coupdetat",additional_height:0} [ at @s ]
#			switch:maps/survival/flamingosaurus_mariokart/scan_doors_on_marker {name:"flamingosaurus_mariokart",additional_height:0} [ at @s ]
#			switch:maps/survival/mario_circuit/scan_doors_on_marker {name:"mario_circuit",additional_height:0} [ at @s ]
#			switch:maps/survival/fast_circuit/scan_doors_on_marker {name:"fast_circuit",additional_height:0} [ at @s ]
#			switch:maps/survival/plains_routine/scan_doors_on_marker {name:"plains_routine",additional_height:0} [ at @s ]
#			switch:maps/survival/city_race/scan_doors_on_marker {name:"city_race",additional_height:0} [ at @s ]
#			switch:maps/survival/sakura_land/scan_doors_on_marker {name:"sakura_land",additional_height:0} [ at @s ]
#			switch:maps/survival/hills_land/scan_doors_on_marker {name:"hills_land",additional_height:0} [ at @s ]
#			switch:maps/survival/airship_fortress/scan_doors_on_marker {name:"airship_fortress",additional_height:0} [ at @s ]
#			switch:maps/survival/dk_mountain/scan_doors_on_marker {name:"dk_mountain",additional_height:0} [ at @s ]
#			switch:maps/survival/clock_circuit/scan_doors_on_marker {name:"clock_circuit",additional_height:0} [ at @s ]
#			switch:maps/survival/baby_park/scan_doors_on_marker {name:"baby_park",additional_height:0} [ at @s ]
#			switch:maps/survival/bowser_castle/scan_doors_on_marker {name:"bowser_castle",additional_height:0} [ at @s ]
#			switch:maps/survival/snow_travel/scan_doors_on_marker {name:"snow_travel",additional_height:0} [ at @s ]
#			switch:maps/survival/rainbow_road/scan_doors_on_marker {name:"rainbow_road",additional_height:0} [ at @s ]
#			switch:maps/survival/trackmania_stadium_1/scan_doors_on_marker {name:"trackmania_stadium_1",additional_height:0} [ at @s ]
#			switch:maps/survival/cathedrale_liege/scan_doors_on_marker {name:"cathedrale_liege",additional_height:0} [ at @s ]
#			switch:maps/survival/layers_2_teams/scan_doors_on_marker {name:"layers_2_teams",additional_height:0} [ at @s ]
#			switch:maps/survival/spleef_1/scan_doors_on_marker {name:"spleef_1",additional_height:24} [ at @s ]
#			switch:maps/survival/de_a_coudre_1/scan_doors_on_marker {name:"de_a_coudre_1",additional_height:0} [ at @s ]
#			switch:maps/survival/mlg_a_coudre_1/scan_doors_on_marker {name:"mlg_a_coudre_1",additional_height:0} [ at @s ]
#			switch:maps/survival/zonweeb_main/scan_doors_on_marker {name:"zonweeb_main",additional_height:0} [ at @s ]
#			switch:maps/survival/adraik_big_ball/scan_doors_on_marker {name:"adraik_big_ball",additional_height:0} [ at @s ]
...
#			switch:maps/survival/ghost_town/scan_doors_on_marker {name:"ghost_town",additional_height:0} [ at @s ]
#			switch:maps/survival/abandoned_city_spawn_circle/scan_doors_on_marker {name:"abandoned_city_spawn_circle",additional_height:0} [ at @s ]
#			switch:maps/survival/abandoned_city/scan_doors_on_marker {name:"abandoned_city",additional_height:101} [ at @s ]
#			switch:maps/survival/old_japan/scan_doors_on_marker {name:"old_japan",additional_height:0} [ at @s ]
#			switch:maps/survival/new_grounds/scan_doors_on_marker {name:"new_grounds",additional_height:0} [ at @s ]
#			switch:maps/survival/cookie_wars/scan_doors_on_marker {name:"cookie_wars",additional_height:0} [ at @s ]
#			switch:maps/survival/snow_hills/scan_doors_on_marker {name:"snow_hills",additional_height:0} [ at @s ]
#			switch:maps/survival/boat_race_2/scan_doors_on_marker {name:"boat_race_2",additional_height:0} [ at @s ]
#			switch:maps/survival/vilarles_castillo/scan_doors_on_marker {name:"vilarles_castillo",additional_height:0} [ at @s ]
#			switch:maps/survival/zonweeb_highschool/scan_doors_on_marker {name:"zonweeb_highschool",additional_height:0} [ at @s ]
#			switch:maps/survival/cluedo_camping/scan_doors_on_marker {name:"cluedo_camping",additional_height:0} [ at @s ]
#			switch:maps/survival/sudoku_craft/scan_doors_on_marker {name:"sudoku_craft",additional_height:0} [ at @s ]
#			switch:maps/survival/la_juste_recette/scan_doors_on_marker {name:"la_juste_recette",additional_height:0} [ at @s ]
#			switch:maps/survival/scartmania/scan_doors_on_marker {name:"scartmania",additional_height:0} [ at @s ]
#			switch:maps/survival/la_fromagerie/scan_doors_on_marker {name:"la_fromagerie",additional_height:0} [ at @s ]
#			switch:maps/survival/slimy_ground/scan_doors_on_marker {name:"slimy_ground",additional_height:0} [ at @s ]
#			switch:maps/survival/eternal_void/scan_doors_on_marker {name:"eternal_void",additional_height:0} [ at @s ]
#			switch:maps/survival/floor_is_lava/scan_doors_on_marker {name:"floor_is_lava",additional_height:0} [ at @s ]
#			switch:maps/survival/leather_boots/scan_doors_on_marker {name:"leather_boots",additional_height:0} [ at @s ]
#			switch:maps/survival/ocean_waste/scan_doors_on_marker {name:"ocean_waste",additional_height:0} [ at @s ]
...
#			switch:maps/survival/layers_4_teams/scan_doors_on_marker {name:"layers_4_teams",additional_height:0} [ at @s ]
#			switch:maps/survival/sky_island_tower/scan_doors_on_marker {name:"sky_island_tower",additional_height:0} [ at @s ]
#			switch:maps/survival/survival_boat/scan_doors_on_marker {name:"survival_boat",additional_height:0} [ at @s ]
#			switch:maps/survival/nature_house/scan_doors_on_marker {name:"nature_house",additional_height:0} [ at @s ]
#			switch:maps/survival/whity_lab/scan_doors_on_marker {name:"whity_lab",additional_height:0} [ at @s ]
#			switch:maps/survival/floating_island/scan_doors_on_marker {name:"floating_island",additional_height:0} [ at @s ]
#			switch:maps/survival/lightium_spawn/scan_doors_on_marker {name:"lightium_spawn",additional_height:0} [ at @s ]
#			switch:maps/survival/paralya_uhc_lobbies/scan_doors_on_marker {name:"paralya_uhc_lobbies",additional_height:0} [ at @s ]
#			switch:maps/survival/paralya_lobby/scan_doors_on_marker {name:"paralya_lobby",additional_height:0} [ at @s ]
#			switch:maps/survival/sheepwars_dirigeables/scan_doors_on_marker {name:"sheepwars_dirigeables",additional_height:0} [ at @s ]
#			switch:maps/survival/stardust_spawn/scan_doors_on_marker {name:"stardust_spawn",additional_height:0} [ at @s ]
#			switch:maps/survival/stardust_boss_zone/scan_doors_on_marker {name:"stardust_boss_zone",additional_height:0} [ at @s ]
#			switch:maps/survival/stardust_boss_zone_nether/scan_doors_on_marker {name:"stardust_boss_zone_nether",additional_height:0} [ at @s ]
#			switch:maps/survival/stardust_pvp_zone/scan_doors_on_marker {name:"stardust_pvp_zone",additional_height:0} [ at @s ]
#			switch:maps/survival/stardust_prison/scan_doors_on_marker {name:"stardust_prison",additional_height:0} [ at @s ]
#			switch:maps/survival/stardust_vip_zone/scan_doors_on_marker {name:"stardust_vip_zone",additional_height:0} [ at @s ]
#			switch:maps/survival/tnt_run_futuristic/scan_doors_on_marker {name:"tnt_run_futuristic",additional_height:0} [ at @s ]
#			switch:maps/survival/block_party/scan_doors_on_marker {name:"block_party",additional_height:163} [ at @s ]
#			switch:maps/survival/nuketown_no_barrier/scan_doors_on_marker {name:"nuketown_no_barrier",additional_height:0} [ at @s ]
#			switch:maps/survival/snowball_painter/scan_doors_on_marker {name:"snowball_painter",additional_height:0} [ at @s ]
#			switch:maps/survival/gay_shooter/scan_doors_on_marker {name:"gay_shooter",additional_height:0} [ at @s ]
#			switch:maps/survival/the_four_elements/scan_doors_on_marker {name:"the_four_elements",additional_height:0} [ at @s ]
#			switch:maps/survival/remelta_cluedo/scan_doors_on_marker {name:"remelta_cluedo",additional_height:0} [ at @s ]
#			switch:maps/survival/arti_box/scan_doors_on_marker {name:"arti_box",additional_height:0} [ at @s ]
#			switch:maps/survival/bombardement/scan_doors_on_marker {name:"bombardement",additional_height:0} [ at @s ]
#			switch:maps/survival/nether_storm/scan_doors_on_marker {name:"nether_storm",additional_height:0} [ at @s ]
#			switch:maps/survival/shoot_da_sheep/scan_doors_on_marker {name:"shoot_da_sheep",additional_height:0} [ at @s ]
#			switch:maps/survival/minigolf/scan_doors_on_marker {name:"minigolf",additional_height:16} [ at @s ]
#			switch:maps/survival/gg_grass_1/scan_doors_on_marker {name:"gg_grass_1",additional_height:16} [ at @s ]
#			switch:maps/survival/gg_grass_2/scan_doors_on_marker {name:"gg_grass_2",additional_height:16} [ at @s ]
#			switch:maps/survival/gg_grass_3/scan_doors_on_marker {name:"gg_grass_3",additional_height:16} [ at @s ]
#			switch:maps/survival/gg_snow_1/scan_doors_on_marker {name:"gg_snow_1",additional_height:16} [ at @s ]
#			switch:maps/survival/gg_snow_2/scan_doors_on_marker {name:"gg_snow_2",additional_height:16} [ at @s ]
#			switch:maps/survival/gg_ice_1/scan_doors_on_marker {name:"gg_ice_1",additional_height:16} [ at @s ]
#			switch:maps/survival/gg_temple/scan_doors_on_marker {name:"gg_temple",additional_height:16} [ at @s ]
#			switch:maps/survival/gg_volcano/scan_doors_on_marker {name:"gg_volcano",additional_height:16} [ at @s ]
#			switch:maps/survival/gg_desert_1/scan_doors_on_marker {name:"gg_desert_1",additional_height:16} [ at @s ]
#			switch:maps/survival/gg_end_1/scan_doors_on_marker {name:"gg_end_1",additional_height:16} [ at @s ]
#			switch:maps/survival/gg_chamber/scan_doors_on_marker {name:"gg_chamber",additional_height:16} [ at @s ]
#			switch:maps/survival/pitchout_halloween/scan_doors_on_marker {name:"pitchout_halloween",additional_height:0} [ at @s ]
#			switch:maps/survival/cigogne/scan_doors_on_marker {name:"cigogne",additional_height:0} [ at @s ]
#			switch:maps/survival/ancienne_egypte_2013/scan_doors_on_marker {name:"ancienne_egypte_2013",additional_height:0} [ at @s ]
#			switch:maps/survival/old_japan_apocalypse/scan_doors_on_marker {name:"old_japan_apocalypse",additional_height:0} [ at @s ]
#			switch:maps/survival/lost_graveyard_remastered/scan_doors_on_marker {name:"lost_graveyard_remastered",additional_height:0} [ at @s ]
#			switch:maps/survival/jn_nature_box/scan_doors_on_marker {name:"jn_nature_box",additional_height:0} [ at @s ]
#			switch:maps/survival/jn_countries_castle/scan_doors_on_marker {name:"jn_countries_castle",additional_height:0} [ at @s ]
#			switch:maps/survival/jn_murder_mystery/scan_doors_on_marker {name:"jn_murder_mystery",additional_height:0} [ at @s ]
#			switch:maps/survival/jn_sakura_pvpbox/scan_doors_on_marker {name:"jn_sakura_pvpbox",additional_height:0} [ at @s ]
#			switch:maps/survival/charly_murder_2018/scan_doors_on_marker {name:"charly_murder_2018",additional_height:0} [ at @s ]
#			switch:maps/survival/jn_one_in_the_chamber_1/scan_doors_on_marker {name:"jn_one_in_the_chamber_1",additional_height:0} [ at @s ]
#			switch:maps/survival/jn_one_in_the_chamber_2/scan_doors_on_marker {name:"jn_one_in_the_chamber_2",additional_height:0} [ at @s ]
#			switch:maps/survival/jn_biomes_relief/scan_doors_on_marker {name:"jn_biomes_relief",additional_height:0} [ at @s ]
#			switch:maps/survival/luxium_spectres_remake/scan_doors_on_marker {name:"luxium_spectres_remake",additional_height:0} [ at @s ]
#			switch:maps/survival/sheepwars_bonbons/scan_doors_on_marker {name:"sheepwars_bonbons",additional_height:0} [ at @s ]
#			switch:maps/survival/sheepwars_plateforme/scan_doors_on_marker {name:"sheepwars_plateforme",additional_height:0} [ at @s ]
#			switch:maps/survival/sheepwars_ilots/scan_doors_on_marker {name:"sheepwars_ilots",additional_height:0} [ at @s ]
#			switch:maps/survival/ctf_plains_castles/scan_doors_on_marker {name:"ctf_plains_castles",additional_height:0} [ at @s ]
#			switch:maps/survival/ctf_mountains_castles/scan_doors_on_marker {name:"ctf_mountains_castles",additional_height:0} [ at @s ]
#			switch:maps/survival/ctf_flowers/scan_doors_on_marker {name:"ctf_flowers",additional_height:0} [ at @s ]
#			switch:maps/survival/ctf_nether/scan_doors_on_marker {name:"ctf_nether",additional_height:0} [ at @s ]
#			switch:maps/survival/ctf_forest_castles/scan_doors_on_marker {name:"ctf_forest_castles",additional_height:0} [ at @s ]
#			switch:maps/survival/luxio_fish_fight/scan_doors_on_marker {name:"luxio_fish_fight",additional_height:0} [ at @s ]
#			switch:maps/survival/arti_tnt_run_tower/scan_doors_on_marker {name:"arti_tnt_run_tower",additional_height:0} [ at @s ]
#			switch:maps/survival/memory_mine/scan_doors_on_marker {name:"memory_mine",additional_height:0} [ at @s ]
#			switch:maps/survival/sheepwars_colored_sheeps/scan_doors_on_marker {name:"sheepwars_colored_sheeps",additional_height:0} [ at @s ]
#			switch:maps/survival/elza_dual_biomes/scan_doors_on_marker {name:"elza_dual_biomes",additional_height:0} [ at @s ]
#			switch:maps/survival/airdox_fish_fight/scan_doors_on_marker {name:"airdox_fish_fight",additional_height:0} [ at @s ]
#			switch:maps/survival/arti_ancient_city/scan_doors_on_marker {name:"arti_ancient_city",additional_height:0} [ at @s ]
#			switch:maps/survival/yeti_in_panic/scan_doors_on_marker {name:"yeti_in_panic",additional_height:0} [ at @s ]
#			switch:maps/survival/cluedo_casino/scan_doors_on_marker {name:"cluedo_casino",additional_height:0} [ at @s ]
#			switch:maps/survival/octogone_nether_ice/scan_doors_on_marker {name:"octogone_nether_ice",additional_height:0} [ at @s ]
#			switch:maps/survival/pillars_of_fortune/scan_doors_on_marker {name:"pillars_of_fortune",additional_height:0} [ at @s ]
#			switch:maps/survival/even_old_japan/scan_doors_on_marker {name:"even_old_japan",additional_height:0} [ at @s ]
#			switch:maps/survival/fireblast_bubulle/scan_doors_on_marker {name:"fireblast_bubulle",additional_height:0} [ at @s ]
