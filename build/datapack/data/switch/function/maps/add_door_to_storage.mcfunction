...
#			switch:maps/survival/adraik_big_ball/scan_doors_on_marker {name:"adraik_big_ball",additional_height:0}
...
#			switch:maps/survival/bancalvivor_s4/scan_doors_on_marker {name:"bancalvivor_s4",additional_height:0}
...
#			switch:maps/survival/caddie_league/scan_doors_on_marker {name:"caddie_league",additional_height:0}
...
#			switch:maps/survival/old_japan/scan_doors_on_marker {name:"old_japan",additional_height:0}
...
#			switch:maps/survival/cluedo_camping/scan_doors_on_marker {name:"cluedo_camping",additional_height:0}
#			switch:maps/survival/sudoku_craft/scan_doors_on_marker {name:"sudoku_craft",additional_height:0}
#			switch:maps/survival/la_juste_recette/scan_doors_on_marker {name:"la_juste_recette",additional_height:0}
#			switch:maps/survival/scartmania/scan_doors_on_marker {name:"scartmania",additional_height:0}
#			switch:maps/survival/la_fromagerie/scan_doors_on_marker {name:"la_fromagerie",additional_height:0}
#			switch:maps/survival/slimy_ground/scan_doors_on_marker {name:"slimy_ground",additional_height:0}
#			switch:maps/survival/eternal_void/scan_doors_on_marker {name:"eternal_void",additional_height:0}
...
#			switch:maps/survival/jn_nature_box/scan_doors_on_marker {name:"jn_nature_box",additional_height:0}
#			switch:maps/survival/jn_countries_castle/scan_doors_on_marker {name:"jn_countries_castle",additional_height:0}
#			switch:maps/survival/jn_murder_mystery/scan_doors_on_marker {name:"jn_murder_mystery",additional_height:0}
#			switch:maps/survival/jn_sakura_pvpbox/scan_doors_on_marker {name:"jn_sakura_pvpbox",additional_height:0}
#			switch:maps/survival/charly_murder_2018/scan_doors_on_marker {name:"charly_murder_2018",additional_height:0}
#			switch:maps/survival/jn_one_in_the_chamber_1/scan_doors_on_marker {name:"jn_one_in_the_chamber_1",additional_height:0}
#			switch:maps/survival/jn_one_in_the_chamber_2/scan_doors_on_marker {name:"jn_one_in_the_chamber_2",additional_height:0}
#			switch:maps/survival/jn_biomes_relief/scan_doors_on_marker {name:"jn_biomes_relief",additional_height:0}
#			switch:maps/survival/luxium_spectres_remake/scan_doors_on_marker {name:"luxium_spectres_remake",additional_height:0}
#			switch:maps/survival/sheepwars_bonbons/scan_doors_on_marker {name:"sheepwars_bonbons",additional_height:0}
#			switch:maps/survival/sheepwars_plateforme/scan_doors_on_marker {name:"sheepwars_plateforme",additional_height:0}
#			switch:maps/survival/sheepwars_ilots/scan_doors_on_marker {name:"sheepwars_ilots",additional_height:0}
#			switch:maps/survival/ctf_plains_castles/scan_doors_on_marker {name:"ctf_plains_castles",additional_height:0}
#			switch:maps/survival/ctf_mountains_castles/scan_doors_on_marker {name:"ctf_mountains_castles",additional_height:0}
#			switch:maps/survival/ctf_flowers/scan_doors_on_marker {name:"ctf_flowers",additional_height:0}
#			switch:maps/survival/ctf_nether/scan_doors_on_marker {name:"ctf_nether",additional_height:0}
#			switch:maps/survival/ctf_forest_castles/scan_doors_on_marker {name:"ctf_forest_castles",additional_height:0}
#			switch:maps/survival/luxio_fish_fight/scan_doors_on_marker {name:"luxio_fish_fight",additional_height:0}
#			switch:maps/survival/arti_tnt_run_tower/scan_doors_on_marker {name:"arti_tnt_run_tower",additional_height:0}
#			switch:maps/survival/memory_mine/scan_doors_on_marker {name:"memory_mine",additional_height:0}
#			switch:maps/survival/sheepwars_colored_sheeps/scan_doors_on_marker {name:"sheepwars_colored_sheeps",additional_height:0}
#			switch:maps/survival/elza_dual_biomes/scan_doors_on_marker {name:"elza_dual_biomes",additional_height:0}
#			switch:maps/survival/airdox_fish_fight/scan_doors_on_marker {name:"airdox_fish_fight",additional_height:0}
#			switch:maps/survival/arti_ancient_city/scan_doors_on_marker {name:"arti_ancient_city",additional_height:0}
