...
#			switch:maps/survival/paralya_uhc_lobbies/scan_doors_on_marker {name:"paralya_uhc_lobbies",additional_height:0}
#			switch:maps/survival/paralya_lobby/scan_doors_on_marker {name:"paralya_lobby",additional_height:0}
#			switch:maps/survival/sheepwars_dirigeables/scan_doors_on_marker {name:"sheepwars_dirigeables",additional_height:0}
#			switch:maps/survival/stardust_spawn/scan_doors_on_marker {name:"stardust_spawn",additional_height:0}
#			switch:maps/survival/stardust_boss_zone/scan_doors_on_marker {name:"stardust_boss_zone",additional_height:0}
#			switch:maps/survival/stardust_boss_zone_nether/scan_doors_on_marker {name:"stardust_boss_zone_nether",additional_height:0}
#			switch:maps/survival/stardust_pvp_zone/scan_doors_on_marker {name:"stardust_pvp_zone",additional_height:0}
#			switch:maps/survival/stardust_prison/scan_doors_on_marker {name:"stardust_prison",additional_height:0}
#			switch:maps/survival/stardust_vip_zone/scan_doors_on_marker {name:"stardust_vip_zone",additional_height:0}
#			switch:maps/survival/tnt_run_futuristic/scan_doors_on_marker {name:"tnt_run_futuristic",additional_height:0}
#			switch:maps/survival/block_party/scan_doors_on_marker {name:"block_party",additional_height:163}
#			switch:maps/survival/nuketown_no_barrier/scan_doors_on_marker {name:"nuketown_no_barrier",additional_height:0}
#			switch:maps/survival/snowball_painter/scan_doors_on_marker {name:"snowball_painter",additional_height:0}
#			switch:maps/survival/gay_shooter/scan_doors_on_marker {name:"gay_shooter",additional_height:0}
#			switch:maps/survival/the_four_elements/scan_doors_on_marker {name:"the_four_elements",additional_height:0}
#			switch:maps/survival/remelta_cluedo/scan_doors_on_marker {name:"remelta_cluedo",additional_height:0}
#			switch:maps/survival/arti_box/scan_doors_on_marker {name:"arti_box",additional_height:0}
#			switch:maps/survival/bombardement/scan_doors_on_marker {name:"bombardement",additional_height:0}
...
#			switch:maps/survival/old_japan_apocalypse/scan_doors_on_marker {name:"old_japan_apocalypse",additional_height:0}
#			switch:maps/survival/lost_graveyard_remastered/scan_doors_on_marker {name:"lost_graveyard_remastered",additional_height:0}
