...
#> switch:maps/adventure/trackmania_stadium_2/
#
...
execute as @a[tag=!detached,sort=random] run function switch:maps/adventure/trackmania_stadium_2/teleport_players
