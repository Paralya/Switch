...
#> switch:maps/adventure/trackmania_stadium_2/if_kart_racer
#
...
summon marker 36907 151 36963 {Tags:["switch.effect_block","switch.kart_racer.engine_off_block"]}
summon marker 37086 101 36963 {Tags:["switch.effect_block","switch.kart_racer.reactor_boost_block"]}
summon marker 37074 101 37056 {Tags:["switch.effect_block","switch.kart_racer.no_grip_block"]}
summon marker 37034 101 37057 {Tags:["switch.effect_block","switch.kart_racer.reactor_boost_block"]}
