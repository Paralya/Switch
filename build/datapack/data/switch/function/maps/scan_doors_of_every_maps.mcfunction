...
data modify storage switch:maps to_scan.friends_black_ball set value 1b
...
data modify storage switch:maps to_scan.pitch_creep_2 set value 1b
...
data modify storage switch:maps to_scan.huge_cargo set value 1b
