...
data modify storage switch:maps to_scan.adraik_big_ball set value 1b
...
data modify storage switch:maps to_scan.old_japan set value 1b
...
data modify storage switch:maps to_scan.cluedo_camping set value 1b
data modify storage switch:maps to_scan.sudoku_craft set value 1b
data modify storage switch:maps to_scan.la_juste_recette set value 1b
data modify storage switch:maps to_scan.scartmania set value 1b
data modify storage switch:maps to_scan.la_fromagerie set value 1b
...
data modify storage switch:maps to_scan.void_desert set value 1b
