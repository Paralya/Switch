...
data modify storage switch:maps to_regenerate.adraik_big_ball set value 1b
...
data modify storage switch:maps to_regenerate.old_japan set value 1b
...
data modify storage switch:maps to_regenerate.cluedo_camping set value 1b
data modify storage switch:maps to_regenerate.sudoku_craft set value 1b
data modify storage switch:maps to_regenerate.la_juste_recette set value 1b
data modify storage switch:maps to_regenerate.scartmania set value 1b
data modify storage switch:maps to_regenerate.la_fromagerie set value 1b
