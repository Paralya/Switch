...
data modify storage switch:maps to_regenerate.friends_black_ball set value 1b
...
data modify storage switch:maps to_regenerate.pitch_creep_2 set value 1b
...
data modify storage switch:maps to_regenerate.huge_cargo set value 1b
