...
#> switch:maps/load_adventure
#
# @within	switch:maps/load_gamemode
#

## This file is used to load the maps that are supposed to be loaded in the adventure mode
## It's not auto-generated like the survival one.

# Load the adventure maps
...
execute if data storage switch:main {map:"epsilon_lthc_circuit"} run function switch:maps/adventure/epsilon_lthc_circuit/
