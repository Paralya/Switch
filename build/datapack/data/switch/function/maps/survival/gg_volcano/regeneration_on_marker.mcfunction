...
execute if score #rg_gg_volcano_mod switch.data matches 0 at @s run clone from minecraft:overworld 124124 ~ 124001 124144 ~ 124046 to switch:game 124124 ~16 124001 strict replace force
...
execute if score #rg_gg_volcano_mod switch.data matches 1 at @s run clone from minecraft:overworld 124144 ~ 124001 124164 ~ 124046 to switch:game 124144 ~16 124001 strict replace force
