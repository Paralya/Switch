...
execute if score #rg_nature_house_mod switch.data matches 0 at @s run clone from minecraft:overworld 88000 ~ 88000 88023 ~ 88068 to switch:game 88000 ~0 88000 replace force
...
execute if score #rg_nature_house_mod switch.data matches 1 at @s run clone from minecraft:overworld 88023 ~ 88000 88045 ~ 88068 to switch:game 88023 ~0 88000 replace force
...
execute if score #rg_nature_house_mod switch.data matches 2 at @s run clone from minecraft:overworld 88045 ~ 88000 88068 ~ 88068 to switch:game 88045 ~0 88000 replace force
