...
execute if score #rg_pitchout_halloween_mod switch.data matches 0 at @s run clone from minecraft:overworld 125000 ~ 125000 125020 ~ 125122 to switch:game 125000 ~0 125000 strict replace force
...
execute if score #rg_pitchout_halloween_mod switch.data matches 1 at @s run clone from minecraft:overworld 125020 ~ 125000 125041 ~ 125122 to switch:game 125020 ~0 125000 strict replace force
...
execute if score #rg_pitchout_halloween_mod switch.data matches 2 at @s run clone from minecraft:overworld 125041 ~ 125000 125061 ~ 125122 to switch:game 125041 ~0 125000 strict replace force
...
execute if score #rg_pitchout_halloween_mod switch.data matches 3 at @s run clone from minecraft:overworld 125061 ~ 125000 125081 ~ 125122 to switch:game 125061 ~0 125000 strict replace force
...
execute if score #rg_pitchout_halloween_mod switch.data matches 4 at @s run clone from minecraft:overworld 125081 ~ 125000 125102 ~ 125122 to switch:game 125081 ~0 125000 strict replace force
...
execute if score #rg_pitchout_halloween_mod switch.data matches 5 at @s run clone from minecraft:overworld 125102 ~ 125000 125122 ~ 125122 to switch:game 125102 ~0 125000 strict replace force
