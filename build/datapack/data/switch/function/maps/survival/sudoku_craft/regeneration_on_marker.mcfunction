...
execute if score #rg_sudoku_craft_mod switch.data matches 0 at @s run clone from minecraft:overworld 55000 ~ 55000 55017 ~ 55138 to switch:game 55000 ~0 55000 strict replace force
...
execute if score #rg_sudoku_craft_mod switch.data matches 1 at @s run clone from minecraft:overworld 55017 ~ 55000 55035 ~ 55138 to switch:game 55017 ~0 55000 strict replace force
...
execute if score #rg_sudoku_craft_mod switch.data matches 2 at @s run clone from minecraft:overworld 55035 ~ 55000 55052 ~ 55138 to switch:game 55035 ~0 55000 strict replace force
...
execute if score #rg_sudoku_craft_mod switch.data matches 3 at @s run clone from minecraft:overworld 55052 ~ 55000 55070 ~ 55138 to switch:game 55052 ~0 55000 strict replace force
...
execute if score #rg_sudoku_craft_mod switch.data matches 4 at @s run clone from minecraft:overworld 55070 ~ 55000 55087 ~ 55138 to switch:game 55070 ~0 55000 strict replace force
...
execute if score #rg_sudoku_craft_mod switch.data matches 5 at @s run clone from minecraft:overworld 55087 ~ 55000 55105 ~ 55138 to switch:game 55087 ~0 55000 strict replace force
...
execute if score #rg_sudoku_craft_mod switch.data matches 6 at @s run clone from minecraft:overworld 55105 ~ 55000 55122 ~ 55138 to switch:game 55105 ~0 55000 strict replace force
