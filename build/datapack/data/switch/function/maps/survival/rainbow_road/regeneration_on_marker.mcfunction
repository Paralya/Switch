...
execute if score #rg_rainbow_road_mod switch.data matches 0 at @s run clone from minecraft:overworld 24000 ~ 24000 24017 ~ 24137 to switch:game 24000 ~0 24000 strict replace force
...
execute if score #rg_rainbow_road_mod switch.data matches 1 at @s run clone from minecraft:overworld 24017 ~ 24000 24035 ~ 24137 to switch:game 24017 ~0 24000 strict replace force
...
execute if score #rg_rainbow_road_mod switch.data matches 2 at @s run clone from minecraft:overworld 24035 ~ 24000 24052 ~ 24137 to switch:game 24035 ~0 24000 strict replace force
...
execute if score #rg_rainbow_road_mod switch.data matches 3 at @s run clone from minecraft:overworld 24052 ~ 24000 24070 ~ 24137 to switch:game 24052 ~0 24000 strict replace force
...
execute if score #rg_rainbow_road_mod switch.data matches 4 at @s run clone from minecraft:overworld 24070 ~ 24000 24087 ~ 24137 to switch:game 24070 ~0 24000 strict replace force
...
execute if score #rg_rainbow_road_mod switch.data matches 5 at @s run clone from minecraft:overworld 24087 ~ 24000 24105 ~ 24137 to switch:game 24087 ~0 24000 strict replace force
...
execute if score #rg_rainbow_road_mod switch.data matches 6 at @s run clone from minecraft:overworld 24105 ~ 24000 24122 ~ 24137 to switch:game 24105 ~0 24000 strict replace force
