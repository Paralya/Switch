...
execute if score #rg_pillars_of_fortune_mod switch.data matches 0 at @s run clone from minecraft:overworld 161000 ~ 161000 161020 ~ 161100 to switch:game 161000 ~0 161000 strict replace force
...
execute if score #rg_pillars_of_fortune_mod switch.data matches 1 at @s run clone from minecraft:overworld 161020 ~ 161000 161040 ~ 161100 to switch:game 161020 ~0 161000 strict replace force
...
execute if score #rg_pillars_of_fortune_mod switch.data matches 2 at @s run clone from minecraft:overworld 161040 ~ 161000 161060 ~ 161100 to switch:game 161040 ~0 161000 strict replace force
...
execute if score #rg_pillars_of_fortune_mod switch.data matches 3 at @s run clone from minecraft:overworld 161060 ~ 161000 161080 ~ 161100 to switch:game 161060 ~0 161000 strict replace force
...
execute if score #rg_pillars_of_fortune_mod switch.data matches 4 at @s run clone from minecraft:overworld 161080 ~ 161000 161100 ~ 161100 to switch:game 161080 ~0 161000 strict replace force
