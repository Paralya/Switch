...
execute if score #rg_even_old_japan_mod switch.data matches 0 at @s run clone from minecraft:overworld 162000 ~ 162000 162020 ~ 162100 to switch:game 162000 ~0 162000 strict replace force
...
execute if score #rg_even_old_japan_mod switch.data matches 1 at @s run clone from minecraft:overworld 162020 ~ 162000 162040 ~ 162100 to switch:game 162020 ~0 162000 strict replace force
...
execute if score #rg_even_old_japan_mod switch.data matches 2 at @s run clone from minecraft:overworld 162040 ~ 162000 162060 ~ 162100 to switch:game 162040 ~0 162000 strict replace force
...
execute if score #rg_even_old_japan_mod switch.data matches 3 at @s run clone from minecraft:overworld 162060 ~ 162000 162080 ~ 162100 to switch:game 162060 ~0 162000 strict replace force
...
execute if score #rg_even_old_japan_mod switch.data matches 4 at @s run clone from minecraft:overworld 162080 ~ 162000 162100 ~ 162100 to switch:game 162080 ~0 162000 strict replace force
