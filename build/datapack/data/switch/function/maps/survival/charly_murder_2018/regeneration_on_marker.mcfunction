...
execute if score #rg_charly_murder_2018_mod switch.data matches 0 at @s run clone from minecraft:overworld 136000 ~ 136000 136026 ~ 136053 to switch:game 136000 ~0 136000 replace force
...
execute if score #rg_charly_murder_2018_mod switch.data matches 1 at @s run clone from minecraft:overworld 136026 ~ 136000 136052 ~ 136053 to switch:game 136026 ~0 136000 replace force
