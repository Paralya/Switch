...
execute if score #rg_sheepwars_plateforme_mod switch.data matches 0 at @s run clone from minecraft:overworld 144000 ~ 144000 144026 ~ 144075 to switch:game 144000 ~0 144000 replace force
...
execute if score #rg_sheepwars_plateforme_mod switch.data matches 1 at @s run clone from minecraft:overworld 144026 ~ 144000 144053 ~ 144075 to switch:game 144026 ~0 144000 replace force
...
execute if score #rg_sheepwars_plateforme_mod switch.data matches 2 at @s run clone from minecraft:overworld 144053 ~ 144000 144079 ~ 144075 to switch:game 144053 ~0 144000 replace force
