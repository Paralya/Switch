...
execute if score #rg_gg_grass_3_mod switch.data matches 0 at @s run clone from minecraft:overworld 124124 ~ 124093 124144 ~ 124138 to switch:game 124124 ~16 124093 strict replace force
...
execute if score #rg_gg_grass_3_mod switch.data matches 1 at @s run clone from minecraft:overworld 124144 ~ 124093 124164 ~ 124138 to switch:game 124144 ~16 124093 strict replace force
