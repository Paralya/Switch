...
execute if score #rg_gg_end_1_mod switch.data matches 0 at @s run clone from minecraft:overworld 124083 ~ 124093 124103 ~ 124138 to switch:game 124083 ~16 124093 replace force
...
execute if score #rg_gg_end_1_mod switch.data matches 1 at @s run clone from minecraft:overworld 124103 ~ 124093 124123 ~ 124138 to switch:game 124103 ~16 124093 replace force
