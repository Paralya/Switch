...
execute if score #rg_layers_4_teams_mod switch.data matches 0 at @s run clone from minecraft:overworld 74000 ~ 74000 74018 ~ 74062 to switch:game 74000 ~0 74000 replace force
...
execute if score #rg_layers_4_teams_mod switch.data matches 1 at @s run clone from minecraft:overworld 74018 ~ 74000 74036 ~ 74062 to switch:game 74018 ~0 74000 replace force
