...
execute if score #rg_gg_chamber_mod switch.data matches 0 at @s run clone from minecraft:overworld 124042 ~ 124094 124062 ~ 124138 to switch:game 124042 ~16 124094 replace force
...
execute if score #rg_gg_chamber_mod switch.data matches 1 at @s run clone from minecraft:overworld 124062 ~ 124094 124081 ~ 124138 to switch:game 124062 ~16 124094 replace force
