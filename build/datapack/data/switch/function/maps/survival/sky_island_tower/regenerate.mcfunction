...
execute if score #rg_sky_island_tower switch.data matches 585.. in switch:game run kill @e[type=item,x=77048,y=-64,z=77047,distance=..1000]
execute if score #rg_sky_island_tower switch.data matches 585.. run data remove storage switch:maps to_regenerate.sky_island_tower

execute if score #rg_sky_island_tower switch.data matches 585.. in minecraft:overworld run forceload remove 77000 77000 77024 77094
execute if score #rg_sky_island_tower switch.data matches 585.. in switch:game run forceload remove 77000 77000 77024 77094

execute if score #rg_sky_island_tower switch.data matches 585.. in minecraft:overworld run forceload remove 77024 77000 77048 77094
execute if score #rg_sky_island_tower switch.data matches 585.. in switch:game run forceload remove 77024 77000 77048 77094

execute if score #rg_sky_island_tower switch.data matches 585.. in minecraft:overworld run forceload remove 77048 77000 77073 77094
execute if score #rg_sky_island_tower switch.data matches 585.. in switch:game run forceload remove 77048 77000 77073 77094

execute if score #rg_sky_island_tower switch.data matches 585.. in minecraft:overworld run forceload remove 77073 77000 77097 77094
execute if score #rg_sky_island_tower switch.data matches 585.. in switch:game run forceload remove 77073 77000 77097 77094

execute if score #rg_sky_island_tower switch.data matches 585.. run tellraw @a ["",{"nbt":"ParalyaWarning","storage":"switch:main","interpret":true},{"text":" Map '","color":"yellow"},{"text":"sky_island_tower","color":"gold"},{"text":"' regenerated in ","color":"yellow"},{"text":"29","color":"gold"},{"text":"s","color":"yellow"}]

execute if score #rg_sky_island_tower switch.data matches 585.. run data modify storage switch:main MessageToLog set value '{"text":"Map `sky_island_tower` just regenerated!"}'
execute if score #rg_sky_island_tower switch.data matches 585.. run function switch:engine/log_message/apply

execute if score #rg_sky_island_tower switch.data matches 585.. in switch:game run function switch:maps/regenerate_doors_macro {name:"sky_island_tower"}
