...
#
# @within	switch:maps/survival/sky_island_tower/scan_doors 1t [ scheduled ]
...
execute if score #scan_sky_island_tower switch.data matches 1 run scoreboard players set #start_y_sky_island_tower switch.data 101
...
execute if score #scan_sky_island_tower switch.data matches 1 run scoreboard players set #end_y_sky_island_tower switch.data 243
...
execute if score #scan_sky_island_tower switch.data matches 286 in minecraft:overworld run forceload remove 77000 77000 77024 77094
execute if score #scan_sky_island_tower switch.data matches 286 in switch:game run forceload remove 77000 77000 77024 77094

execute if score #scan_sky_island_tower switch.data matches 286 in minecraft:overworld run forceload remove 77024 77000 77048 77094
execute if score #scan_sky_island_tower switch.data matches 286 in switch:game run forceload remove 77024 77000 77048 77094

execute if score #scan_sky_island_tower switch.data matches 286 in minecraft:overworld run forceload remove 77048 77000 77073 77094
execute if score #scan_sky_island_tower switch.data matches 286 in switch:game run forceload remove 77048 77000 77073 77094

execute if score #scan_sky_island_tower switch.data matches 286 in minecraft:overworld run forceload remove 77073 77000 77097 77094
execute if score #scan_sky_island_tower switch.data matches 286 in switch:game run forceload remove 77073 77000 77097 77094

execute if score #scan_sky_island_tower switch.data matches 286 run tellraw @a ["",{"nbt":"ParalyaWarning","storage":"switch:main","interpret":true},{"text":" Doors of map '","color":"yellow"},{"text":"sky_island_tower","color":"gold"},{"text":"' just been scanned in ","color":"yellow"},{"text":"14","color":"gold"},{"text":"s","color":"yellow"}]
execute if score #scan_sky_island_tower switch.data matches 286 run data remove storage switch:maps to_scan.sky_island_tower
execute if score #scan_sky_island_tower switch.data matches 286 run scoreboard players reset #scan_sky_island_tower switch.data
