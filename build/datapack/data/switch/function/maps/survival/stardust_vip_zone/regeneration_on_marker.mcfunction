...
execute if score #rg_stardust_vip_zone_mod switch.data matches 0 at @s run clone from minecraft:overworld 107000 ~ 107000 107023 ~ 107085 to switch:game 107000 ~0 107000 replace force
...
execute if score #rg_stardust_vip_zone_mod switch.data matches 1 at @s run clone from minecraft:overworld 107023 ~ 107000 107045 ~ 107085 to switch:game 107023 ~0 107000 replace force
...
execute if score #rg_stardust_vip_zone_mod switch.data matches 2 at @s run clone from minecraft:overworld 107045 ~ 107000 107068 ~ 107085 to switch:game 107045 ~0 107000 replace force
...
execute if score #rg_stardust_vip_zone_mod switch.data matches 3 at @s run clone from minecraft:overworld 107068 ~ 107000 107090 ~ 107085 to switch:game 107068 ~0 107000 replace force
...
execute if score #rg_stardust_vip_zone_mod switch.data matches 4 at @s run clone from minecraft:overworld 107090 ~ 107000 107113 ~ 107085 to switch:game 107090 ~0 107000 replace force
