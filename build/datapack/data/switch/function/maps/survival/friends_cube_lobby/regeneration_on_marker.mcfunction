...
execute if score #rg_friends_cube_lobby_mod switch.data matches 0 at @s run clone from minecraft:overworld 17000 ~ 17000 17020 ~ 17080 to switch:game 17000 ~0 17000 strict replace force
...
execute if score #rg_friends_cube_lobby_mod switch.data matches 1 at @s run clone from minecraft:overworld 17020 ~ 17000 17040 ~ 17080 to switch:game 17020 ~0 17000 strict replace force
...
execute if score #rg_friends_cube_lobby_mod switch.data matches 2 at @s run clone from minecraft:overworld 17040 ~ 17000 17060 ~ 17080 to switch:game 17040 ~0 17000 strict replace force
...
execute if score #rg_friends_cube_lobby_mod switch.data matches 3 at @s run clone from minecraft:overworld 17060 ~ 17000 17080 ~ 17080 to switch:game 17060 ~0 17000 strict replace force
