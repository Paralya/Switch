...
execute if score #rg_fireblast_bubulle_mod switch.data matches 0 at @s run clone from minecraft:overworld 163000 ~ 163000 163025 ~ 163075 to switch:game 163000 ~0 163000 strict replace force
...
execute if score #rg_fireblast_bubulle_mod switch.data matches 1 at @s run clone from minecraft:overworld 163025 ~ 163000 163050 ~ 163075 to switch:game 163025 ~0 163000 strict replace force
...
execute if score #rg_fireblast_bubulle_mod switch.data matches 2 at @s run clone from minecraft:overworld 163050 ~ 163000 163075 ~ 163075 to switch:game 163050 ~0 163000 strict replace force
