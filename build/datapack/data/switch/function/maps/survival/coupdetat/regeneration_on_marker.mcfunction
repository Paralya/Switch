...
execute if score #rg_coupdetat_mod switch.data matches 0 at @s run clone from minecraft:overworld 18000 ~ 18000 18012 ~ 18022 to switch:game 18000 ~0 18000 strict replace force
...
execute if score #rg_coupdetat_mod switch.data matches 1 at @s run clone from minecraft:overworld 18012 ~ 18000 18023 ~ 18022 to switch:game 18012 ~0 18000 strict replace force
