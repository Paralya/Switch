...
execute if score #rg_leather_boots_mod switch.data matches 0 at @s run clone from minecraft:overworld 63000 ~ 63000 63020 ~ 63100 to switch:game 63000 ~0 63000 replace force
...
execute if score #rg_leather_boots_mod switch.data matches 1 at @s run clone from minecraft:overworld 63020 ~ 63000 63040 ~ 63100 to switch:game 63020 ~0 63000 replace force
...
execute if score #rg_leather_boots_mod switch.data matches 2 at @s run clone from minecraft:overworld 63040 ~ 63000 63060 ~ 63100 to switch:game 63040 ~0 63000 replace force
...
execute if score #rg_leather_boots_mod switch.data matches 3 at @s run clone from minecraft:overworld 63060 ~ 63000 63080 ~ 63100 to switch:game 63060 ~0 63000 replace force
...
execute if score #rg_leather_boots_mod switch.data matches 4 at @s run clone from minecraft:overworld 63080 ~ 63000 63100 ~ 63100 to switch:game 63080 ~0 63000 replace force
