...
#
# @within	switch:maps/survival/fireblast_pork/scan_doors 1t
...
execute if score #scan_fireblast_pork switch.data matches 1 run scoreboard players set #end_y_fireblast_pork switch.data 149
...
execute if score #scan_fireblast_pork switch.data matches 84 in minecraft:overworld run forceload remove 165000 165000 165025 165075
execute if score #scan_fireblast_pork switch.data matches 84 in switch:game run forceload remove 165000 165000 165025 165075

execute if score #scan_fireblast_pork switch.data matches 84 in minecraft:overworld run forceload remove 165025 165000 165050 165075
execute if score #scan_fireblast_pork switch.data matches 84 in switch:game run forceload remove 165025 165000 165050 165075

execute if score #scan_fireblast_pork switch.data matches 84 in minecraft:overworld run forceload remove 165050 165000 165075 165075
execute if score #scan_fireblast_pork switch.data matches 84 in switch:game run forceload remove 165050 165000 165075 165075

execute if score #scan_fireblast_pork switch.data matches 84 run tellraw @a ["",{"nbt":"ParalyaWarning","storage":"switch:main","interpret":true},{"text":" Doors of map '","color":"yellow"},{"text":"fireblast_pork","color":"gold"},{"text":"' just been scanned in ","color":"yellow"},{"text":"4","color":"gold"},{"text":"s","color":"yellow"}]
execute if score #scan_fireblast_pork switch.data matches 84 run data remove storage switch:maps to_scan.fireblast_pork
execute if score #scan_fireblast_pork switch.data matches 84 run scoreboard players reset #scan_fireblast_pork switch.data
