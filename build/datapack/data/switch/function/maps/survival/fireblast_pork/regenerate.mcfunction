...
execute if score #rg_fireblast_pork switch.data matches ..153 summon marker run function switch:maps/survival/fireblast_pork/regeneration_on_marker

execute if score #rg_fireblast_pork switch.data matches 154.. in switch:game run kill @e[type=item,x=165037,y=100,z=165037,distance=..1000]
execute if score #rg_fireblast_pork switch.data matches 154.. run data remove storage switch:maps to_regenerate.fireblast_pork
...
execute if score #rg_fireblast_pork switch.data matches 154.. in switch:game run function switch:maps/regenerate_doors_macro {name:"fireblast_pork"}
execute if score #rg_fireblast_pork switch.data matches 154.. run scoreboard players reset #rg_fireblast_pork switch.data
