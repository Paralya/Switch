...
execute if score #rg_warden_forest_mod switch.data matches 0 at @s run clone from minecraft:overworld 10000 ~ 10000 10019 ~ 10132 to switch:game 10000 ~0 10000 strict replace force
...
execute if score #rg_warden_forest_mod switch.data matches 1 at @s run clone from minecraft:overworld 10019 ~ 10000 10038 ~ 10132 to switch:game 10019 ~0 10000 strict replace force
...
execute if score #rg_warden_forest_mod switch.data matches 2 at @s run clone from minecraft:overworld 10038 ~ 10000 10057 ~ 10132 to switch:game 10038 ~0 10000 strict replace force
...
execute if score #rg_warden_forest_mod switch.data matches 3 at @s run clone from minecraft:overworld 10057 ~ 10000 10075 ~ 10132 to switch:game 10057 ~0 10000 strict replace force
...
execute if score #rg_warden_forest_mod switch.data matches 4 at @s run clone from minecraft:overworld 10075 ~ 10000 10094 ~ 10132 to switch:game 10075 ~0 10000 strict replace force
...
execute if score #rg_warden_forest_mod switch.data matches 5 at @s run clone from minecraft:overworld 10094 ~ 10000 10113 ~ 10132 to switch:game 10094 ~0 10000 strict replace force
...
execute if score #rg_warden_forest_mod switch.data matches 6 at @s run clone from minecraft:overworld 10113 ~ 10000 10132 ~ 10132 to switch:game 10113 ~0 10000 strict replace force
