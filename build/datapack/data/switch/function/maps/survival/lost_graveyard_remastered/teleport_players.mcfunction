...
#
# @within	switch:maps/survival/lost_graveyard_remastered/main [ as @e[type=marker,tag=switch.selected_map] & at @s ]
#

data modify entity @s Pos set value [127007.5d, 118.5d, 127046.5d]
