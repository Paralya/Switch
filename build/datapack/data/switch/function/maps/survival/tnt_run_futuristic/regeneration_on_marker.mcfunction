...
execute if score #rg_tnt_run_futuristic_mod switch.data matches 0 at @s run clone from minecraft:overworld 109000 ~ 109000 109030 ~ 109046 to switch:game 109000 ~0 109000 strict replace force
...
execute if score #rg_tnt_run_futuristic_mod switch.data matches 1 at @s run clone from minecraft:overworld 109030 ~ 109000 109059 ~ 109046 to switch:game 109030 ~0 109000 strict replace force
