...
execute if score #rg_ocean_waste_mod switch.data matches 0 at @s run clone from minecraft:overworld 64000 ~ 64000 64020 ~ 64100 to switch:game 64000 ~0 64000 replace force
...
execute if score #rg_ocean_waste_mod switch.data matches 1 at @s run clone from minecraft:overworld 64020 ~ 64000 64040 ~ 64100 to switch:game 64020 ~0 64000 replace force
...
execute if score #rg_ocean_waste_mod switch.data matches 2 at @s run clone from minecraft:overworld 64040 ~ 64000 64060 ~ 64100 to switch:game 64040 ~0 64000 replace force
...
execute if score #rg_ocean_waste_mod switch.data matches 3 at @s run clone from minecraft:overworld 64060 ~ 64000 64080 ~ 64100 to switch:game 64060 ~0 64000 replace force
...
execute if score #rg_ocean_waste_mod switch.data matches 4 at @s run clone from minecraft:overworld 64080 ~ 64000 64100 ~ 64100 to switch:game 64080 ~0 64000 replace force
