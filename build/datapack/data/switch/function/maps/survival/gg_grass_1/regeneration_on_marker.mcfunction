...
execute if score #rg_gg_grass_1_mod switch.data matches 0 at @s run clone from minecraft:overworld 124001 ~ 124047 124021 ~ 124092 to switch:game 124001 ~16 124047 replace force
...
execute if score #rg_gg_grass_1_mod switch.data matches 1 at @s run clone from minecraft:overworld 124021 ~ 124047 124041 ~ 124092 to switch:game 124021 ~16 124047 replace force
