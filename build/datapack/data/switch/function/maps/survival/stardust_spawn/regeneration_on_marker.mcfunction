...
execute if score #rg_stardust_spawn_mod switch.data matches 0 at @s run clone from minecraft:overworld 101000 ~ 101000 101020 ~ 101120 to switch:game 101000 ~0 101000 strict replace force
...
execute if score #rg_stardust_spawn_mod switch.data matches 1 at @s run clone from minecraft:overworld 101020 ~ 101000 101040 ~ 101120 to switch:game 101020 ~0 101000 strict replace force
...
execute if score #rg_stardust_spawn_mod switch.data matches 2 at @s run clone from minecraft:overworld 101040 ~ 101000 101060 ~ 101120 to switch:game 101040 ~0 101000 strict replace force
...
execute if score #rg_stardust_spawn_mod switch.data matches 3 at @s run clone from minecraft:overworld 101060 ~ 101000 101080 ~ 101120 to switch:game 101060 ~0 101000 strict replace force
...
execute if score #rg_stardust_spawn_mod switch.data matches 4 at @s run clone from minecraft:overworld 101080 ~ 101000 101100 ~ 101120 to switch:game 101080 ~0 101000 strict replace force
...
execute if score #rg_stardust_spawn_mod switch.data matches 5 at @s run clone from minecraft:overworld 101100 ~ 101000 101120 ~ 101120 to switch:game 101100 ~0 101000 strict replace force
