...
execute if score #rg_arti_box_mod switch.data matches 0 at @s run clone from minecraft:overworld 119000 ~ 119000 119024 ~ 119047 to switch:game 119000 ~0 119000 strict replace force
...
execute if score #rg_arti_box_mod switch.data matches 1 at @s run clone from minecraft:overworld 119024 ~ 119000 119047 ~ 119047 to switch:game 119024 ~0 119000 strict replace force
