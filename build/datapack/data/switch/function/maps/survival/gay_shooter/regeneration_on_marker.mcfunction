...
execute if score #rg_gay_shooter_mod switch.data matches 0 at @s run clone from minecraft:overworld 114000 ~ 114000 114023 ~ 114058 to switch:game 114000 ~0 114000 strict replace force
...
execute if score #rg_gay_shooter_mod switch.data matches 1 at @s run clone from minecraft:overworld 114023 ~ 114000 114047 ~ 114058 to switch:game 114023 ~0 114000 strict replace force
...
execute if score #rg_gay_shooter_mod switch.data matches 2 at @s run clone from minecraft:overworld 114047 ~ 114000 114070 ~ 114058 to switch:game 114047 ~0 114000 strict replace force
