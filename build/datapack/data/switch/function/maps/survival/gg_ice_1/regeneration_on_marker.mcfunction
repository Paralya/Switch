...
execute if score #rg_gg_ice_1_mod switch.data matches 0 at @s run clone from minecraft:overworld 124083 ~ 124047 124103 ~ 124092 to switch:game 124083 ~16 124047 replace force
...
execute if score #rg_gg_ice_1_mod switch.data matches 1 at @s run clone from minecraft:overworld 124103 ~ 124047 124123 ~ 124092 to switch:game 124103 ~16 124047 replace force
