...
execute if score #rg_jn_sakura_pvpbox_mod switch.data matches 0 at @s run clone from minecraft:overworld 135000 ~ 135000 135020 ~ 135100 to switch:game 135000 ~0 135000 strict replace force
...
execute if score #rg_jn_sakura_pvpbox_mod switch.data matches 1 at @s run clone from minecraft:overworld 135020 ~ 135000 135040 ~ 135100 to switch:game 135020 ~0 135000 strict replace force
...
execute if score #rg_jn_sakura_pvpbox_mod switch.data matches 2 at @s run clone from minecraft:overworld 135040 ~ 135000 135060 ~ 135100 to switch:game 135040 ~0 135000 strict replace force
...
execute if score #rg_jn_sakura_pvpbox_mod switch.data matches 3 at @s run clone from minecraft:overworld 135060 ~ 135000 135080 ~ 135100 to switch:game 135060 ~0 135000 strict replace force
...
execute if score #rg_jn_sakura_pvpbox_mod switch.data matches 4 at @s run clone from minecraft:overworld 135080 ~ 135000 135100 ~ 135100 to switch:game 135080 ~0 135000 strict replace force
