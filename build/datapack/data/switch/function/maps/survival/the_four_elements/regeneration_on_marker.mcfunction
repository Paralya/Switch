...
execute if score #rg_the_four_elements_mod switch.data matches 0 at @s run clone from minecraft:overworld 115000 ~ 115000 115020 ~ 115101 to switch:game 115000 ~0 115000 replace force
...
execute if score #rg_the_four_elements_mod switch.data matches 1 at @s run clone from minecraft:overworld 115020 ~ 115000 115040 ~ 115101 to switch:game 115020 ~0 115000 replace force
...
execute if score #rg_the_four_elements_mod switch.data matches 2 at @s run clone from minecraft:overworld 115040 ~ 115000 115061 ~ 115101 to switch:game 115040 ~0 115000 replace force
...
execute if score #rg_the_four_elements_mod switch.data matches 3 at @s run clone from minecraft:overworld 115061 ~ 115000 115081 ~ 115101 to switch:game 115061 ~0 115000 replace force
...
execute if score #rg_the_four_elements_mod switch.data matches 4 at @s run clone from minecraft:overworld 115081 ~ 115000 115101 ~ 115101 to switch:game 115081 ~0 115000 replace force
