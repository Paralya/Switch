...
#
# @within	switch:maps/survival/the_four_elements/main [ as @e[type=marker,tag=switch.selected_map] & at @s ]
#

data modify entity @s Pos set value [115090.5d, 125.5d, 115008.5d]
