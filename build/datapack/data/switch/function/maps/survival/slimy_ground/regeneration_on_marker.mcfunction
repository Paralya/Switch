...
execute if score #rg_slimy_ground_mod switch.data matches 0 at @s run clone from minecraft:overworld 60000 ~ 60000 60020 ~ 60100 to switch:game 60000 ~0 60000 strict replace force
...
execute if score #rg_slimy_ground_mod switch.data matches 1 at @s run clone from minecraft:overworld 60020 ~ 60000 60040 ~ 60100 to switch:game 60020 ~0 60000 strict replace force
...
execute if score #rg_slimy_ground_mod switch.data matches 2 at @s run clone from minecraft:overworld 60040 ~ 60000 60060 ~ 60100 to switch:game 60040 ~0 60000 strict replace force
...
execute if score #rg_slimy_ground_mod switch.data matches 3 at @s run clone from minecraft:overworld 60060 ~ 60000 60080 ~ 60100 to switch:game 60060 ~0 60000 strict replace force
...
execute if score #rg_slimy_ground_mod switch.data matches 4 at @s run clone from minecraft:overworld 60080 ~ 60000 60100 ~ 60100 to switch:game 60080 ~0 60000 strict replace force
