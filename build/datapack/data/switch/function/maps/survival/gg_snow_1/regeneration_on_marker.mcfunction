...
execute if score #rg_gg_snow_1_mod switch.data matches 0 at @s run clone from minecraft:overworld 124042 ~ 124001 124062 ~ 124046 to switch:game 124042 ~16 124001 strict replace force
...
execute if score #rg_gg_snow_1_mod switch.data matches 1 at @s run clone from minecraft:overworld 124062 ~ 124001 124082 ~ 124046 to switch:game 124062 ~16 124001 strict replace force
