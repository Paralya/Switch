...
execute if score #rg_sheepwars_ilots_mod switch.data matches 0 at @s run clone from minecraft:overworld 145000 ~ 145000 145018 ~ 145122 to switch:game 145000 ~0 145000 strict replace force
...
execute if score #rg_sheepwars_ilots_mod switch.data matches 1 at @s run clone from minecraft:overworld 145018 ~ 145000 145037 ~ 145122 to switch:game 145018 ~0 145000 strict replace force
...
execute if score #rg_sheepwars_ilots_mod switch.data matches 2 at @s run clone from minecraft:overworld 145037 ~ 145000 145055 ~ 145122 to switch:game 145037 ~0 145000 strict replace force
...
execute if score #rg_sheepwars_ilots_mod switch.data matches 3 at @s run clone from minecraft:overworld 145055 ~ 145000 145074 ~ 145122 to switch:game 145055 ~0 145000 strict replace force
...
execute if score #rg_sheepwars_ilots_mod switch.data matches 4 at @s run clone from minecraft:overworld 145074 ~ 145000 145092 ~ 145122 to switch:game 145074 ~0 145000 strict replace force
