...
execute if score #rg_octogone_nether_ice_mod switch.data matches 0 at @s run clone from minecraft:overworld 160000 ~ 160000 160020 ~ 160080 to switch:game 160000 ~0 160000 replace force
...
execute if score #rg_octogone_nether_ice_mod switch.data matches 1 at @s run clone from minecraft:overworld 160020 ~ 160000 160040 ~ 160080 to switch:game 160020 ~0 160000 replace force
...
execute if score #rg_octogone_nether_ice_mod switch.data matches 2 at @s run clone from minecraft:overworld 160040 ~ 160000 160060 ~ 160080 to switch:game 160040 ~0 160000 replace force
...
execute if score #rg_octogone_nether_ice_mod switch.data matches 3 at @s run clone from minecraft:overworld 160060 ~ 160000 160080 ~ 160080 to switch:game 160060 ~0 160000 replace force
