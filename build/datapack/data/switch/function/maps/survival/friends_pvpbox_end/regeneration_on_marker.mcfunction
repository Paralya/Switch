...
execute if score #rg_friends_pvpbox_end_mod switch.data matches 0 at @s run clone from minecraft:overworld 13000 ~ 13000 13023 ~ 13090 to switch:game 13000 ~0 13000 replace force
...
execute if score #rg_friends_pvpbox_end_mod switch.data matches 1 at @s run clone from minecraft:overworld 13023 ~ 13000 13046 ~ 13090 to switch:game 13023 ~0 13000 replace force
...
execute if score #rg_friends_pvpbox_end_mod switch.data matches 2 at @s run clone from minecraft:overworld 13046 ~ 13000 13068 ~ 13090 to switch:game 13046 ~0 13000 replace force
...
execute if score #rg_friends_pvpbox_end_mod switch.data matches 3 at @s run clone from minecraft:overworld 13068 ~ 13000 13091 ~ 13090 to switch:game 13068 ~0 13000 replace force
