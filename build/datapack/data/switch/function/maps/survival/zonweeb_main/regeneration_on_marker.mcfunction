...
execute if score #rg_zonweeb_main_mod switch.data matches 0 at @s run clone from minecraft:overworld 32000 ~ 32000 32020 ~ 32100 to switch:game 32000 ~0 32000 strict replace force
...
execute if score #rg_zonweeb_main_mod switch.data matches 1 at @s run clone from minecraft:overworld 32020 ~ 32000 32040 ~ 32100 to switch:game 32020 ~0 32000 strict replace force
...
execute if score #rg_zonweeb_main_mod switch.data matches 2 at @s run clone from minecraft:overworld 32040 ~ 32000 32060 ~ 32100 to switch:game 32040 ~0 32000 strict replace force
...
execute if score #rg_zonweeb_main_mod switch.data matches 3 at @s run clone from minecraft:overworld 32060 ~ 32000 32080 ~ 32100 to switch:game 32060 ~0 32000 strict replace force
...
execute if score #rg_zonweeb_main_mod switch.data matches 4 at @s run clone from minecraft:overworld 32080 ~ 32000 32100 ~ 32100 to switch:game 32080 ~0 32000 strict replace force
