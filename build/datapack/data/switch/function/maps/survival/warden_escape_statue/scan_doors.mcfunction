...
#
# @within	switch:maps/survival/warden_escape_statue/scan_doors 1t [ scheduled ]
...
execute if score #scan_warden_escape_statue switch.data matches 1 run scoreboard players set #start_y_warden_escape_statue switch.data 101
...
execute if score #scan_warden_escape_statue switch.data matches 1 run scoreboard players set #end_y_warden_escape_statue switch.data 222
...
execute if score #scan_warden_escape_statue switch.data matches 407 in minecraft:overworld run forceload remove 69000 69000 69025 69106
execute if score #scan_warden_escape_statue switch.data matches 407 in switch:game run forceload remove 69000 69000 69025 69106

execute if score #scan_warden_escape_statue switch.data matches 407 in minecraft:overworld run forceload remove 69025 69000 69049 69106
execute if score #scan_warden_escape_statue switch.data matches 407 in switch:game run forceload remove 69025 69000 69049 69106

execute if score #scan_warden_escape_statue switch.data matches 407 in minecraft:overworld run forceload remove 69049 69000 69074 69106
execute if score #scan_warden_escape_statue switch.data matches 407 in switch:game run forceload remove 69049 69000 69074 69106

execute if score #scan_warden_escape_statue switch.data matches 407 in minecraft:overworld run forceload remove 69074 69000 69099 69106
execute if score #scan_warden_escape_statue switch.data matches 407 in switch:game run forceload remove 69074 69000 69099 69106

execute if score #scan_warden_escape_statue switch.data matches 407 in minecraft:overworld run forceload remove 69099 69000 69123 69106
execute if score #scan_warden_escape_statue switch.data matches 407 in switch:game run forceload remove 69099 69000 69123 69106

execute if score #scan_warden_escape_statue switch.data matches 407 in minecraft:overworld run forceload remove 69123 69000 69148 69106
execute if score #scan_warden_escape_statue switch.data matches 407 in switch:game run forceload remove 69123 69000 69148 69106

execute if score #scan_warden_escape_statue switch.data matches 407 run tellraw @a ["",{"nbt":"ParalyaWarning","storage":"switch:main","interpret":true},{"text":" Doors of map '","color":"yellow"},{"text":"warden_escape_statue","color":"gold"},{"text":"' just been scanned in ","color":"yellow"},{"text":"20","color":"gold"},{"text":"s","color":"yellow"}]
execute if score #scan_warden_escape_statue switch.data matches 407 run data remove storage switch:maps to_scan.warden_escape_statue
execute if score #scan_warden_escape_statue switch.data matches 407 run scoreboard players reset #scan_warden_escape_statue switch.data
