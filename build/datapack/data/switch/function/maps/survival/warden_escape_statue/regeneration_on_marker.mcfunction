...
execute if score #rg_warden_escape_statue_mod switch.data matches 0 at @s run clone from minecraft:overworld 69000 ~ 69000 69025 ~ 69106 to switch:game 69000 ~0 69000 strict replace force
...
execute if score #rg_warden_escape_statue_mod switch.data matches 1 at @s run clone from minecraft:overworld 69025 ~ 69000 69049 ~ 69106 to switch:game 69025 ~0 69000 strict replace force
...
execute if score #rg_warden_escape_statue_mod switch.data matches 2 at @s run clone from minecraft:overworld 69049 ~ 69000 69074 ~ 69106 to switch:game 69049 ~0 69000 strict replace force
...
execute if score #rg_warden_escape_statue_mod switch.data matches 3 at @s run clone from minecraft:overworld 69074 ~ 69000 69099 ~ 69106 to switch:game 69074 ~0 69000 strict replace force
...
execute if score #rg_warden_escape_statue_mod switch.data matches 4 at @s run clone from minecraft:overworld 69099 ~ 69000 69123 ~ 69106 to switch:game 69099 ~0 69000 strict replace force
...
execute if score #rg_warden_escape_statue_mod switch.data matches 5 at @s run clone from minecraft:overworld 69123 ~ 69000 69148 ~ 69106 to switch:game 69123 ~0 69000 strict replace force
