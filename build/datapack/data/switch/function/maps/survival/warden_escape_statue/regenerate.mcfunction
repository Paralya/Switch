...
execute if score #rg_warden_escape_statue switch.data matches 745.. run tellraw @a ["",{"nbt":"ParalyaWarning","storage":"switch:main","interpret":true},{"text":" Map '","color":"yellow"},{"text":"warden_escape_statue","color":"gold"},{"text":"' regenerated in ","color":"yellow"},{"text":"37","color":"gold"},{"text":"s","color":"yellow"}]

execute if score #rg_warden_escape_statue switch.data matches 745.. run data modify storage switch:main MessageToLog set value '{"text":"Map `warden_escape_statue` just regenerated!"}'
