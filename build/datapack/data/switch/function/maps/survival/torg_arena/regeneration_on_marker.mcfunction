...
execute if score #rg_torg_arena_mod switch.data matches 0 at @s run clone from minecraft:overworld 65000 ~ 65000 65020 ~ 65100 to switch:game 65000 ~0 65000 strict replace force
...
execute if score #rg_torg_arena_mod switch.data matches 1 at @s run clone from minecraft:overworld 65020 ~ 65000 65040 ~ 65100 to switch:game 65020 ~0 65000 strict replace force
...
execute if score #rg_torg_arena_mod switch.data matches 2 at @s run clone from minecraft:overworld 65040 ~ 65000 65060 ~ 65100 to switch:game 65040 ~0 65000 strict replace force
...
execute if score #rg_torg_arena_mod switch.data matches 3 at @s run clone from minecraft:overworld 65060 ~ 65000 65080 ~ 65100 to switch:game 65060 ~0 65000 strict replace force
...
execute if score #rg_torg_arena_mod switch.data matches 4 at @s run clone from minecraft:overworld 65080 ~ 65000 65100 ~ 65100 to switch:game 65080 ~0 65000 strict replace force
