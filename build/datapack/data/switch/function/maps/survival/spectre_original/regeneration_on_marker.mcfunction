...
execute if score #rg_spectre_original_mod switch.data matches 0 at @s run clone from minecraft:overworld 2500 ~ 2500 2522 ~ 2595 to switch:game 2500 ~0 2500 replace force
...
execute if score #rg_spectre_original_mod switch.data matches 1 at @s run clone from minecraft:overworld 2522 ~ 2500 2543 ~ 2595 to switch:game 2522 ~0 2500 replace force
...
execute if score #rg_spectre_original_mod switch.data matches 2 at @s run clone from minecraft:overworld 2543 ~ 2500 2564 ~ 2595 to switch:game 2543 ~0 2500 replace force
...
execute if score #rg_spectre_original_mod switch.data matches 3 at @s run clone from minecraft:overworld 2564 ~ 2500 2586 ~ 2595 to switch:game 2564 ~0 2500 replace force
