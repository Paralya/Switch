...
execute if score #rg_area_51_mod switch.data matches 0 at @s run clone from minecraft:overworld 2000 ~ 2000 2018 ~ 2126 to switch:game 2000 ~0 2000 replace force
...
execute if score #rg_area_51_mod switch.data matches 1 at @s run clone from minecraft:overworld 2018 ~ 2000 2036 ~ 2126 to switch:game 2018 ~0 2000 replace force
...
execute if score #rg_area_51_mod switch.data matches 2 at @s run clone from minecraft:overworld 2036 ~ 2000 2054 ~ 2126 to switch:game 2036 ~0 2000 replace force
...
execute if score #rg_area_51_mod switch.data matches 3 at @s run clone from minecraft:overworld 2054 ~ 2000 2072 ~ 2126 to switch:game 2054 ~0 2000 replace force
...
execute if score #rg_area_51_mod switch.data matches 4 at @s run clone from minecraft:overworld 2072 ~ 2000 2090 ~ 2126 to switch:game 2072 ~0 2000 replace force
...
execute if score #rg_area_51_mod switch.data matches 5 at @s run clone from minecraft:overworld 2090 ~ 2000 2108 ~ 2126 to switch:game 2090 ~0 2000 replace force
