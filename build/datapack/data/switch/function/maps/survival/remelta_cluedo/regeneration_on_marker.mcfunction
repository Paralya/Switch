...
execute if score #rg_remelta_cluedo_mod switch.data matches 0 at @s run clone from minecraft:overworld 118000 ~ 118000 118030 ~ 118066 to switch:game 118000 ~0 118000 strict replace force
...
execute if score #rg_remelta_cluedo_mod switch.data matches 1 at @s run clone from minecraft:overworld 118030 ~ 118000 118059 ~ 118066 to switch:game 118030 ~0 118000 strict replace force
...
execute if score #rg_remelta_cluedo_mod switch.data matches 2 at @s run clone from minecraft:overworld 118059 ~ 118000 118089 ~ 118066 to switch:game 118059 ~0 118000 strict replace force
