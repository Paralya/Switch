...
#> switch:maps/survival/remelta_cluedo/scan_doors_on_marker
#
# @within	switch:maps/survival/remelta_cluedo/scan_doors
#			switch:maps/survival/remelta_cluedo/scan_doors_on_marker
#

execute store result entity @s Pos[0] double 1 run scoreboard players get #curr_x_remelta_cluedo switch.data
execute store result entity @s Pos[1] double 1 run scoreboard players get #curr_y_remelta_cluedo switch.data
execute store result entity @s Pos[2] double 1 run scoreboard players get #curr_z_remelta_cluedo switch.data
scoreboard players add #curr_x_remelta_cluedo switch.data 1
execute if score #curr_x_remelta_cluedo switch.data > #end_x_remelta_cluedo switch.data run scoreboard players add #curr_y_remelta_cluedo switch.data 1
