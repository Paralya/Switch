...
execute if score #rg_la_juste_recette_mod switch.data matches 0 at @s run clone from minecraft:overworld 57000 ~ 57000 57021 ~ 57124 to switch:game 57000 ~0 57000 replace force
...
execute if score #rg_la_juste_recette_mod switch.data matches 1 at @s run clone from minecraft:overworld 57021 ~ 57000 57041 ~ 57124 to switch:game 57021 ~0 57000 replace force
...
execute if score #rg_la_juste_recette_mod switch.data matches 2 at @s run clone from minecraft:overworld 57041 ~ 57000 57062 ~ 57124 to switch:game 57041 ~0 57000 replace force
...
execute if score #rg_la_juste_recette_mod switch.data matches 3 at @s run clone from minecraft:overworld 57062 ~ 57000 57083 ~ 57124 to switch:game 57062 ~0 57000 replace force
...
execute if score #rg_la_juste_recette_mod switch.data matches 4 at @s run clone from minecraft:overworld 57083 ~ 57000 57103 ~ 57124 to switch:game 57083 ~0 57000 replace force
...
execute if score #rg_la_juste_recette_mod switch.data matches 5 at @s run clone from minecraft:overworld 57103 ~ 57000 57124 ~ 57124 to switch:game 57103 ~0 57000 replace force
