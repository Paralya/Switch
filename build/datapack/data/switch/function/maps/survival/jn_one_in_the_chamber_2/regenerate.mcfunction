...
execute if score #rg_jn_one_in_the_chamber_2 switch.data matches 1 run scoreboard players set #rg_jn_one_in_the_chamber_2_y switch.data 0
...
execute if score #rg_jn_one_in_the_chamber_2 switch.data matches 349.. in switch:game run kill @e[type=item,x=138070,y=0,z=138050,distance=..1000]
