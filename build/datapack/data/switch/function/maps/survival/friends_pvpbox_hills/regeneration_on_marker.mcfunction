...
execute if score #rg_friends_pvpbox_hills_mod switch.data matches 0 at @s run clone from minecraft:overworld 12000 ~ 12000 12022 ~ 12090 to switch:game 12000 ~0 12000 replace force
...
execute if score #rg_friends_pvpbox_hills_mod switch.data matches 1 at @s run clone from minecraft:overworld 12022 ~ 12000 12045 ~ 12090 to switch:game 12022 ~0 12000 replace force
...
execute if score #rg_friends_pvpbox_hills_mod switch.data matches 2 at @s run clone from minecraft:overworld 12045 ~ 12000 12068 ~ 12090 to switch:game 12045 ~0 12000 replace force
...
execute if score #rg_friends_pvpbox_hills_mod switch.data matches 3 at @s run clone from minecraft:overworld 12068 ~ 12000 12090 ~ 12090 to switch:game 12068 ~0 12000 replace force
