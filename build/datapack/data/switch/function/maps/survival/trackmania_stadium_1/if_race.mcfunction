...
#> switch:maps/survival/trackmania_stadium_1/if_race
#
# @executed	in switch:game
#
# @within	switch:maps/survival/trackmania_stadium_1/main [ in switch:game ]
#
...
summon marker 25102 101 25031 {Tags:["switch.effect_block","switch.kart_racer.reset_block"]}
summon marker 24972 102 25043 {Tags:["switch.effect_block","switch.kart_racer.cruise_control_block"]}
summon marker 24968 102 25042 {Tags:["switch.effect_block","switch.kart_racer.cruise_control_block"]}
summon marker 25066 115 25027 {Tags:["switch.effect_block","switch.kart_racer.reactor_boost_block"]}
summon marker 25071 115 25027 {Tags:["switch.effect_block","switch.kart_racer.reactor_boost_block"]}
summon marker 25071 115 25031 {Tags:["switch.effect_block","switch.kart_racer.reactor_boost_block"]}
summon marker 25066 115 25031 {Tags:["switch.effect_block","switch.kart_racer.reactor_boost_block"]}
summon marker 25047 115 25011 {Tags:["switch.effect_block","switch.kart_racer.no_grip_block"]}
summon marker 25043 115 25011 {Tags:["switch.effect_block","switch.kart_racer.no_grip_block"]}
