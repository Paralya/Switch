...
execute if score #rg_cluedo_camping_mod switch.data matches 0 at @s run clone from minecraft:overworld 54000 ~ 54000 54022 ~ 54094 to switch:game 54000 ~0 54000 replace force
...
execute if score #rg_cluedo_camping_mod switch.data matches 1 at @s run clone from minecraft:overworld 54022 ~ 54000 54045 ~ 54094 to switch:game 54022 ~0 54000 replace force
...
execute if score #rg_cluedo_camping_mod switch.data matches 2 at @s run clone from minecraft:overworld 54045 ~ 54000 54067 ~ 54094 to switch:game 54045 ~0 54000 replace force
...
execute if score #rg_cluedo_camping_mod switch.data matches 3 at @s run clone from minecraft:overworld 54067 ~ 54000 54090 ~ 54094 to switch:game 54067 ~0 54000 replace force
...
execute if score #rg_cluedo_camping_mod switch.data matches 4 at @s run clone from minecraft:overworld 54090 ~ 54000 54112 ~ 54094 to switch:game 54090 ~0 54000 replace force
