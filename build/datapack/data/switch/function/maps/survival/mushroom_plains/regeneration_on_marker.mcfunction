...
execute if score #rg_mushroom_plains_mod switch.data matches 0 at @s run clone from minecraft:overworld 4000 ~ 4000 4020 ~ 4122 to switch:game 4000 ~0 4000 replace force
...
execute if score #rg_mushroom_plains_mod switch.data matches 1 at @s run clone from minecraft:overworld 4020 ~ 4000 4041 ~ 4122 to switch:game 4020 ~0 4000 replace force
...
execute if score #rg_mushroom_plains_mod switch.data matches 2 at @s run clone from minecraft:overworld 4041 ~ 4000 4061 ~ 4122 to switch:game 4041 ~0 4000 replace force
...
execute if score #rg_mushroom_plains_mod switch.data matches 3 at @s run clone from minecraft:overworld 4061 ~ 4000 4081 ~ 4122 to switch:game 4061 ~0 4000 replace force
...
execute if score #rg_mushroom_plains_mod switch.data matches 4 at @s run clone from minecraft:overworld 4081 ~ 4000 4102 ~ 4122 to switch:game 4081 ~0 4000 replace force
...
execute if score #rg_mushroom_plains_mod switch.data matches 5 at @s run clone from minecraft:overworld 4102 ~ 4000 4122 ~ 4122 to switch:game 4102 ~0 4000 replace force
