...
execute if score #rg_gg_snow_2_mod switch.data matches 0 at @s run clone from minecraft:overworld 124042 ~ 124047 124062 ~ 124092 to switch:game 124042 ~16 124047 replace force
...
execute if score #rg_gg_snow_2_mod switch.data matches 1 at @s run clone from minecraft:overworld 124062 ~ 124047 124082 ~ 124092 to switch:game 124062 ~16 124047 replace force
