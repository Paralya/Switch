...
execute if score #rg_gg_desert_1_mod switch.data matches 0 at @s run clone from minecraft:overworld 124124 ~ 124047 124144 ~ 124092 to switch:game 124124 ~16 124047 strict replace force
...
execute if score #rg_gg_desert_1_mod switch.data matches 1 at @s run clone from minecraft:overworld 124144 ~ 124047 124164 ~ 124092 to switch:game 124144 ~16 124047 strict replace force
