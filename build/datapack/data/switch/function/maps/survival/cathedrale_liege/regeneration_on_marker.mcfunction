...
execute if score #rg_cathedrale_liege_mod switch.data matches 0 at @s run clone from minecraft:overworld 26000 ~ 26000 26028 ~ 26084 to switch:game 26000 ~0 26000 strict replace force
...
execute if score #rg_cathedrale_liege_mod switch.data matches 1 at @s run clone from minecraft:overworld 26028 ~ 26000 26055 ~ 26084 to switch:game 26028 ~0 26000 strict replace force
...
execute if score #rg_cathedrale_liege_mod switch.data matches 2 at @s run clone from minecraft:overworld 26055 ~ 26000 26083 ~ 26084 to switch:game 26055 ~0 26000 strict replace force
...
execute if score #rg_cathedrale_liege_mod switch.data matches 3 at @s run clone from minecraft:overworld 26083 ~ 26000 26110 ~ 26084 to switch:game 26083 ~0 26000 strict replace force
...
execute if score #rg_cathedrale_liege_mod switch.data matches 4 at @s run clone from minecraft:overworld 26110 ~ 26000 26138 ~ 26084 to switch:game 26110 ~0 26000 strict replace force
