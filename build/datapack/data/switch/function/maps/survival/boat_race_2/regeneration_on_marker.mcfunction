...
execute if score #rg_boat_race_2_mod switch.data matches 0 at @s run clone from minecraft:overworld 51000 ~ 51000 51020 ~ 51123 to switch:game 51000 ~0 51000 strict replace force
...
execute if score #rg_boat_race_2_mod switch.data matches 1 at @s run clone from minecraft:overworld 51020 ~ 51000 51040 ~ 51123 to switch:game 51020 ~0 51000 strict replace force
...
execute if score #rg_boat_race_2_mod switch.data matches 2 at @s run clone from minecraft:overworld 51040 ~ 51000 51059 ~ 51123 to switch:game 51040 ~0 51000 strict replace force
...
execute if score #rg_boat_race_2_mod switch.data matches 3 at @s run clone from minecraft:overworld 51059 ~ 51000 51079 ~ 51123 to switch:game 51059 ~0 51000 strict replace force
...
execute if score #rg_boat_race_2_mod switch.data matches 4 at @s run clone from minecraft:overworld 51079 ~ 51000 51099 ~ 51123 to switch:game 51079 ~0 51000 strict replace force
