...
execute if score #rg_lightium_spawn_mod switch.data matches 0 at @s run clone from minecraft:overworld 97000 ~ 97000 97018 ~ 97129 to switch:game 97000 ~0 97000 replace force
...
execute if score #rg_lightium_spawn_mod switch.data matches 1 at @s run clone from minecraft:overworld 97018 ~ 97000 97037 ~ 97129 to switch:game 97018 ~0 97000 replace force
...
execute if score #rg_lightium_spawn_mod switch.data matches 2 at @s run clone from minecraft:overworld 97037 ~ 97000 97055 ~ 97129 to switch:game 97037 ~0 97000 replace force
...
execute if score #rg_lightium_spawn_mod switch.data matches 3 at @s run clone from minecraft:overworld 97055 ~ 97000 97074 ~ 97129 to switch:game 97055 ~0 97000 replace force
...
execute if score #rg_lightium_spawn_mod switch.data matches 4 at @s run clone from minecraft:overworld 97074 ~ 97000 97092 ~ 97129 to switch:game 97074 ~0 97000 replace force
...
execute if score #rg_lightium_spawn_mod switch.data matches 5 at @s run clone from minecraft:overworld 97092 ~ 97000 97111 ~ 97129 to switch:game 97092 ~0 97000 replace force
...
execute if score #rg_lightium_spawn_mod switch.data matches 6 at @s run clone from minecraft:overworld 97111 ~ 97000 97129 ~ 97129 to switch:game 97111 ~0 97000 replace force
