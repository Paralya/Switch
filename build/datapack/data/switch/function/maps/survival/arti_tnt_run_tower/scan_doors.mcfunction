...
execute if score #scan_arti_tnt_run_tower switch.data matches 1 run scoreboard players set #start_y_arti_tnt_run_tower switch.data 1
...
execute if score #scan_arti_tnt_run_tower switch.data matches 1 run scoreboard players set #end_y_arti_tnt_run_tower switch.data 72
