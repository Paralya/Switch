...
#
# @within	switch:maps/survival/arti_tnt_run_tower/regenerate 1t [ scheduled ]
...
execute if score #rg_arti_tnt_run_tower switch.data matches ..166 summon marker run function switch:maps/survival/arti_tnt_run_tower/regeneration_on_marker

execute if score #rg_arti_tnt_run_tower switch.data matches 167.. in switch:game run kill @e[type=item,x=152010,y=100,z=152010,distance=..1000]
execute if score #rg_arti_tnt_run_tower switch.data matches 167.. run data remove storage switch:maps to_regenerate.arti_tnt_run_tower

execute if score #rg_arti_tnt_run_tower switch.data matches 167.. in minecraft:overworld run forceload remove 152000 152000 152010 152020
execute if score #rg_arti_tnt_run_tower switch.data matches 167.. in switch:game run forceload remove 152000 152000 152010 152020
execute if score #rg_arti_tnt_run_tower switch.data matches 167.. in minecraft:overworld run forceload remove 152010 152000 152020 152020
