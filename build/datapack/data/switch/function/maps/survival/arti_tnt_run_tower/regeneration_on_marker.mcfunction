...
execute if score #rg_arti_tnt_run_tower_mod switch.data matches 0 at @s run clone from minecraft:overworld 152000 ~ 152000 152010 ~ 152020 to switch:game 152000 ~0 152000 strict replace force
...
execute if score #rg_arti_tnt_run_tower_mod switch.data matches 1 at @s run clone from minecraft:overworld 152010 ~ 152000 152020 ~ 152020 to switch:game 152010 ~0 152000 strict replace force
