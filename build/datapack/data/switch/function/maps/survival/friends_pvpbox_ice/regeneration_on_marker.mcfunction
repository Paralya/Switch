...
execute if score #rg_friends_pvpbox_ice_mod switch.data matches 0 at @s run clone from minecraft:overworld 11000 ~ 11000 11022 ~ 11065 to switch:game 11000 ~0 11000 strict replace force
...
execute if score #rg_friends_pvpbox_ice_mod switch.data matches 1 at @s run clone from minecraft:overworld 11022 ~ 11000 11043 ~ 11065 to switch:game 11022 ~0 11000 strict replace force
...
execute if score #rg_friends_pvpbox_ice_mod switch.data matches 2 at @s run clone from minecraft:overworld 11043 ~ 11000 11065 ~ 11065 to switch:game 11043 ~0 11000 strict replace force
