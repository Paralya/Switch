...
execute if score #rg_luxio_fish_fight_mod switch.data matches 0 at @s run clone from minecraft:overworld 151000 ~ 151000 151028 ~ 151055 to switch:game 151000 ~0 151000 replace force
...
execute if score #rg_luxio_fish_fight_mod switch.data matches 1 at @s run clone from minecraft:overworld 151028 ~ 151000 151056 ~ 151055 to switch:game 151028 ~0 151000 replace force
