...
execute if score #rg_nether_storm_mod switch.data matches 0 at @s run clone from minecraft:overworld 122000 ~ 122000 122028 ~ 122074 to switch:game 122000 ~0 122000 replace force
...
execute if score #rg_nether_storm_mod switch.data matches 1 at @s run clone from minecraft:overworld 122028 ~ 122000 122056 ~ 122074 to switch:game 122028 ~0 122000 replace force
...
execute if score #rg_nether_storm_mod switch.data matches 2 at @s run clone from minecraft:overworld 122056 ~ 122000 122083 ~ 122074 to switch:game 122056 ~0 122000 replace force
...
execute if score #rg_nether_storm_mod switch.data matches 3 at @s run clone from minecraft:overworld 122083 ~ 122000 122111 ~ 122074 to switch:game 122083 ~0 122000 replace force
