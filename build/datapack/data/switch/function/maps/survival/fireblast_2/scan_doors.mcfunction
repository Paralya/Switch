...
execute if score #scan_fireblast_2 switch.data matches 1 run scoreboard players set #start_y_fireblast_2 switch.data 101
...
execute if score #scan_fireblast_2 switch.data matches 1 run scoreboard players set #end_y_fireblast_2 switch.data 149
