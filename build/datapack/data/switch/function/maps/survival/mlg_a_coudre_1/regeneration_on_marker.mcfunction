...
execute if score #rg_mlg_a_coudre_1_mod switch.data matches 0 at @s run clone from minecraft:overworld 31000 ~ 31000 31019 ~ 31090 to switch:game 31000 ~0 31000 strict replace force
...
execute if score #rg_mlg_a_coudre_1_mod switch.data matches 1 at @s run clone from minecraft:overworld 31019 ~ 31000 31038 ~ 31090 to switch:game 31019 ~0 31000 strict replace force
...
execute if score #rg_mlg_a_coudre_1_mod switch.data matches 2 at @s run clone from minecraft:overworld 31038 ~ 31000 31056 ~ 31090 to switch:game 31038 ~0 31000 strict replace force
...
execute if score #rg_mlg_a_coudre_1_mod switch.data matches 3 at @s run clone from minecraft:overworld 31056 ~ 31000 31075 ~ 31090 to switch:game 31056 ~0 31000 strict replace force
