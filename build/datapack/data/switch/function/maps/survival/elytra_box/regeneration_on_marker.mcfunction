...
execute if score #rg_elytra_box_mod switch.data matches 0 at @s run clone from minecraft:overworld 6000 ~ 6000 6012 ~ 6159 to switch:game 6000 ~0 6000 replace force
...
execute if score #rg_elytra_box_mod switch.data matches 1 at @s run clone from minecraft:overworld 6012 ~ 6000 6025 ~ 6159 to switch:game 6012 ~0 6000 replace force
...
execute if score #rg_elytra_box_mod switch.data matches 2 at @s run clone from minecraft:overworld 6025 ~ 6000 6037 ~ 6159 to switch:game 6025 ~0 6000 replace force
...
execute if score #rg_elytra_box_mod switch.data matches 3 at @s run clone from minecraft:overworld 6037 ~ 6000 6050 ~ 6159 to switch:game 6037 ~0 6000 replace force
...
execute if score #rg_elytra_box_mod switch.data matches 4 at @s run clone from minecraft:overworld 6050 ~ 6000 6062 ~ 6159 to switch:game 6050 ~0 6000 replace force
