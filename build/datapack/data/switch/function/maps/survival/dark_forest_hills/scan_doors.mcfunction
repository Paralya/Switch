...
execute if score #scan_dark_forest_hills switch.data matches 1 run scoreboard players set #start_y_dark_forest_hills switch.data 1
...
execute if score #scan_dark_forest_hills switch.data matches 1 run scoreboard players set #end_y_dark_forest_hills switch.data 68
...
execute if score #scan_dark_forest_hills switch.data matches 455 in minecraft:overworld run forceload remove 39000 39000 39013 39221
execute if score #scan_dark_forest_hills switch.data matches 455 in switch:game run forceload remove 39000 39000 39013 39221

execute if score #scan_dark_forest_hills switch.data matches 455 in minecraft:overworld run forceload remove 39013 39000 39026 39221
execute if score #scan_dark_forest_hills switch.data matches 455 in switch:game run forceload remove 39013 39000 39026 39221

execute if score #scan_dark_forest_hills switch.data matches 455 in minecraft:overworld run forceload remove 39026 39000 39039 39221
execute if score #scan_dark_forest_hills switch.data matches 455 in switch:game run forceload remove 39026 39000 39039 39221

execute if score #scan_dark_forest_hills switch.data matches 455 in minecraft:overworld run forceload remove 39039 39000 39052 39221
execute if score #scan_dark_forest_hills switch.data matches 455 in switch:game run forceload remove 39039 39000 39052 39221

execute if score #scan_dark_forest_hills switch.data matches 455 in minecraft:overworld run forceload remove 39052 39000 39065 39221
execute if score #scan_dark_forest_hills switch.data matches 455 in switch:game run forceload remove 39052 39000 39065 39221

execute if score #scan_dark_forest_hills switch.data matches 455 in minecraft:overworld run forceload remove 39065 39000 39078 39221
execute if score #scan_dark_forest_hills switch.data matches 455 in switch:game run forceload remove 39065 39000 39078 39221

execute if score #scan_dark_forest_hills switch.data matches 455 in minecraft:overworld run forceload remove 39078 39000 39091 39221
execute if score #scan_dark_forest_hills switch.data matches 455 in switch:game run forceload remove 39078 39000 39091 39221

execute if score #scan_dark_forest_hills switch.data matches 455 in minecraft:overworld run forceload remove 39091 39000 39104 39221
execute if score #scan_dark_forest_hills switch.data matches 455 in switch:game run forceload remove 39091 39000 39104 39221

execute if score #scan_dark_forest_hills switch.data matches 455 in minecraft:overworld run forceload remove 39104 39000 39117 39221
execute if score #scan_dark_forest_hills switch.data matches 455 in switch:game run forceload remove 39104 39000 39117 39221

execute if score #scan_dark_forest_hills switch.data matches 455 in minecraft:overworld run forceload remove 39117 39000 39130 39221
execute if score #scan_dark_forest_hills switch.data matches 455 in switch:game run forceload remove 39117 39000 39130 39221

execute if score #scan_dark_forest_hills switch.data matches 455 in minecraft:overworld run forceload remove 39130 39000 39143 39221
execute if score #scan_dark_forest_hills switch.data matches 455 in switch:game run forceload remove 39130 39000 39143 39221

execute if score #scan_dark_forest_hills switch.data matches 455 run tellraw @a ["",{"nbt":"ParalyaWarning","storage":"switch:main","interpret":true},{"text":" Doors of map '","color":"yellow"},{"text":"dark_forest_hills","color":"gold"},{"text":"' just been scanned in ","color":"yellow"},{"text":"22","color":"gold"},{"text":"s","color":"yellow"}]
execute if score #scan_dark_forest_hills switch.data matches 455 run data remove storage switch:maps to_scan.dark_forest_hills
execute if score #scan_dark_forest_hills switch.data matches 455 run scoreboard players reset #scan_dark_forest_hills switch.data
