...
execute if score #scan_fireblast_cookie switch.data matches 1 run scoreboard players set #end_y_fireblast_cookie switch.data 149
...
execute if score #scan_fireblast_cookie switch.data matches 84 in minecraft:overworld run forceload remove 164000 164000 164025 164075
execute if score #scan_fireblast_cookie switch.data matches 84 in switch:game run forceload remove 164000 164000 164025 164075

execute if score #scan_fireblast_cookie switch.data matches 84 in minecraft:overworld run forceload remove 164025 164000 164050 164075
execute if score #scan_fireblast_cookie switch.data matches 84 in switch:game run forceload remove 164025 164000 164050 164075

execute if score #scan_fireblast_cookie switch.data matches 84 in minecraft:overworld run forceload remove 164050 164000 164075 164075
execute if score #scan_fireblast_cookie switch.data matches 84 in switch:game run forceload remove 164050 164000 164075 164075

execute if score #scan_fireblast_cookie switch.data matches 84 run tellraw @a ["",{"nbt":"ParalyaWarning","storage":"switch:main","interpret":true},{"text":" Doors of map '","color":"yellow"},{"text":"fireblast_cookie","color":"gold"},{"text":"' just been scanned in ","color":"yellow"},{"text":"4","color":"gold"},{"text":"s","color":"yellow"}]
execute if score #scan_fireblast_cookie switch.data matches 84 run data remove storage switch:maps to_scan.fireblast_cookie
execute if score #scan_fireblast_cookie switch.data matches 84 run scoreboard players reset #scan_fireblast_cookie switch.data
