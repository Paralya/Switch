...
execute if score #rg_spleef_1_mod switch.data matches 0 at @s run clone from minecraft:overworld 27960 ~ 27960 27980 ~ 28040 to switch:game 27960 ~24 27960 replace force
...
execute if score #rg_spleef_1_mod switch.data matches 1 at @s run clone from minecraft:overworld 27980 ~ 27960 28000 ~ 28040 to switch:game 27980 ~24 27960 replace force
...
execute if score #rg_spleef_1_mod switch.data matches 2 at @s run clone from minecraft:overworld 28000 ~ 27960 28020 ~ 28040 to switch:game 28000 ~24 27960 replace force
...
execute if score #rg_spleef_1_mod switch.data matches 3 at @s run clone from minecraft:overworld 28020 ~ 27960 28040 ~ 28040 to switch:game 28020 ~24 27960 replace force
