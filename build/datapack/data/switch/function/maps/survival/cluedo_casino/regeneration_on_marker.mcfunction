...
execute if score #rg_cluedo_casino_mod switch.data matches 0 at @s run clone from minecraft:overworld 159000 ~ 159000 159025 ~ 159069 to switch:game 159000 ~0 159000 replace force
...
execute if score #rg_cluedo_casino_mod switch.data matches 1 at @s run clone from minecraft:overworld 159025 ~ 159000 159050 ~ 159069 to switch:game 159025 ~0 159000 replace force
...
execute if score #rg_cluedo_casino_mod switch.data matches 2 at @s run clone from minecraft:overworld 159050 ~ 159000 159075 ~ 159069 to switch:game 159050 ~0 159000 replace force
