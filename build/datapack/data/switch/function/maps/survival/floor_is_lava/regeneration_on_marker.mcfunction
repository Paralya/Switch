...
execute if score #rg_floor_is_lava_mod switch.data matches 0 at @s run clone from minecraft:overworld 62000 ~ 62000 62020 ~ 62100 to switch:game 62000 ~0 62000 replace force
...
execute if score #rg_floor_is_lava_mod switch.data matches 1 at @s run clone from minecraft:overworld 62020 ~ 62000 62040 ~ 62100 to switch:game 62020 ~0 62000 replace force
...
execute if score #rg_floor_is_lava_mod switch.data matches 2 at @s run clone from minecraft:overworld 62040 ~ 62000 62060 ~ 62100 to switch:game 62040 ~0 62000 replace force
...
execute if score #rg_floor_is_lava_mod switch.data matches 3 at @s run clone from minecraft:overworld 62060 ~ 62000 62080 ~ 62100 to switch:game 62060 ~0 62000 replace force
...
execute if score #rg_floor_is_lava_mod switch.data matches 4 at @s run clone from minecraft:overworld 62080 ~ 62000 62100 ~ 62100 to switch:game 62080 ~0 62000 replace force
