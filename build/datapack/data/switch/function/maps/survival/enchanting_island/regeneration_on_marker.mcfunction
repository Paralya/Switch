...
execute if score #rg_enchanting_island_mod switch.data matches 0 at @s run clone from minecraft:overworld 7000 ~ 7000 7020 ~ 7060 to switch:game 7000 ~0 7000 replace force
...
execute if score #rg_enchanting_island_mod switch.data matches 1 at @s run clone from minecraft:overworld 7020 ~ 7000 7040 ~ 7060 to switch:game 7020 ~0 7000 replace force
...
execute if score #rg_enchanting_island_mod switch.data matches 2 at @s run clone from minecraft:overworld 7040 ~ 7000 7060 ~ 7060 to switch:game 7040 ~0 7000 replace force
