...
execute if score #rg_ancienne_egypte_2013_mod switch.data matches 0 at @s run clone from minecraft:overworld 128000 ~ 128000 128019 ~ 128113 to switch:game 128000 ~0 128000 replace force
...
execute if score #rg_ancienne_egypte_2013_mod switch.data matches 1 at @s run clone from minecraft:overworld 128019 ~ 128000 128038 ~ 128113 to switch:game 128019 ~0 128000 replace force
...
execute if score #rg_ancienne_egypte_2013_mod switch.data matches 2 at @s run clone from minecraft:overworld 128038 ~ 128000 128057 ~ 128113 to switch:game 128038 ~0 128000 replace force
...
execute if score #rg_ancienne_egypte_2013_mod switch.data matches 3 at @s run clone from minecraft:overworld 128057 ~ 128000 128076 ~ 128113 to switch:game 128057 ~0 128000 replace force
...
execute if score #rg_ancienne_egypte_2013_mod switch.data matches 4 at @s run clone from minecraft:overworld 128076 ~ 128000 128095 ~ 128113 to switch:game 128076 ~0 128000 replace force
