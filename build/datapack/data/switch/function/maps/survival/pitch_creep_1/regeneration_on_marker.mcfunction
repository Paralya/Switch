...
execute if score #rg_pitch_creep_1_mod switch.data matches 0 at @s run clone from minecraft:overworld 3500 ~ 3500 3520 ~ 3540 to switch:game 3500 ~0 3500 strict replace force
...
execute if score #rg_pitch_creep_1_mod switch.data matches 1 at @s run clone from minecraft:overworld 3520 ~ 3500 3540 ~ 3540 to switch:game 3520 ~0 3500 strict replace force
