...
execute if score #rg_paralya_uhc_lobbies_mod switch.data matches 0 at @s run clone from minecraft:overworld 98000 ~ 98000 98022 ~ 98090 to switch:game 98000 ~0 98000 replace force
...
execute if score #rg_paralya_uhc_lobbies_mod switch.data matches 1 at @s run clone from minecraft:overworld 98022 ~ 98000 98045 ~ 98090 to switch:game 98022 ~0 98000 replace force
...
execute if score #rg_paralya_uhc_lobbies_mod switch.data matches 2 at @s run clone from minecraft:overworld 98045 ~ 98000 98068 ~ 98090 to switch:game 98045 ~0 98000 replace force
...
execute if score #rg_paralya_uhc_lobbies_mod switch.data matches 3 at @s run clone from minecraft:overworld 98068 ~ 98000 98090 ~ 98090 to switch:game 98068 ~0 98000 replace force
