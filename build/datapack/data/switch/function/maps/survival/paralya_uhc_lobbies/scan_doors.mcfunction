...
execute if score #scan_paralya_uhc_lobbies switch.data matches 1 run scoreboard players set #start_y_paralya_uhc_lobbies switch.data 1
...
execute if score #scan_paralya_uhc_lobbies switch.data matches 1 run scoreboard players set #end_y_paralya_uhc_lobbies switch.data 92
