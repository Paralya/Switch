...
#
# @within	switch:maps/survival/paralya_uhc_lobbies/scan_doors 1t
...
execute if score #scan_paralya_uhc_lobbies switch.data matches 1 run scoreboard players set #start_y_paralya_uhc_lobbies switch.data 11
...
execute if score #scan_paralya_uhc_lobbies switch.data matches 319 in minecraft:overworld run forceload remove 98000 98000 98022 98090
execute if score #scan_paralya_uhc_lobbies switch.data matches 319 in switch:game run forceload remove 98000 98000 98022 98090

execute if score #scan_paralya_uhc_lobbies switch.data matches 319 in minecraft:overworld run forceload remove 98022 98000 98045 98090
execute if score #scan_paralya_uhc_lobbies switch.data matches 319 in switch:game run forceload remove 98022 98000 98045 98090

execute if score #scan_paralya_uhc_lobbies switch.data matches 319 in minecraft:overworld run forceload remove 98045 98000 98068 98090
execute if score #scan_paralya_uhc_lobbies switch.data matches 319 in switch:game run forceload remove 98045 98000 98068 98090

execute if score #scan_paralya_uhc_lobbies switch.data matches 319 in minecraft:overworld run forceload remove 98068 98000 98090 98090
execute if score #scan_paralya_uhc_lobbies switch.data matches 319 in switch:game run forceload remove 98068 98000 98090 98090

execute if score #scan_paralya_uhc_lobbies switch.data matches 319 run tellraw @a ["",{"nbt":"ParalyaWarning","storage":"switch:main","interpret":true},{"text":" Doors of map '","color":"yellow"},{"text":"paralya_uhc_lobbies","color":"gold"},{"text":"' just been scanned in ","color":"yellow"},{"text":"15","color":"gold"},{"text":"s","color":"yellow"}]
execute if score #scan_paralya_uhc_lobbies switch.data matches 319 run data remove storage switch:maps to_scan.paralya_uhc_lobbies
execute if score #scan_paralya_uhc_lobbies switch.data matches 319 run scoreboard players reset #scan_paralya_uhc_lobbies switch.data
