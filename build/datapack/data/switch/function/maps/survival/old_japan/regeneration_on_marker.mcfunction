...
execute if score #rg_old_japan_mod switch.data matches 0 at @s run clone from minecraft:overworld 47000 ~ 47000 47020 ~ 47100 to switch:game 47000 ~0 47000 strict replace force
...
execute if score #rg_old_japan_mod switch.data matches 1 at @s run clone from minecraft:overworld 47020 ~ 47000 47040 ~ 47100 to switch:game 47020 ~0 47000 strict replace force
...
execute if score #rg_old_japan_mod switch.data matches 2 at @s run clone from minecraft:overworld 47040 ~ 47000 47060 ~ 47100 to switch:game 47040 ~0 47000 strict replace force
...
execute if score #rg_old_japan_mod switch.data matches 3 at @s run clone from minecraft:overworld 47060 ~ 47000 47080 ~ 47100 to switch:game 47060 ~0 47000 strict replace force
...
execute if score #rg_old_japan_mod switch.data matches 4 at @s run clone from minecraft:overworld 47080 ~ 47000 47100 ~ 47100 to switch:game 47080 ~0 47000 strict replace force
