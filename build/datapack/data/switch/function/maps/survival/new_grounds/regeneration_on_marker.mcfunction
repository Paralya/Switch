...
execute if score #rg_new_grounds_mod switch.data matches 0 at @s run clone from minecraft:overworld 48000 ~ 48000 48023 ~ 48093 to switch:game 48000 ~0 48000 strict replace force
...
execute if score #rg_new_grounds_mod switch.data matches 1 at @s run clone from minecraft:overworld 48023 ~ 48000 48046 ~ 48093 to switch:game 48023 ~0 48000 strict replace force
...
execute if score #rg_new_grounds_mod switch.data matches 2 at @s run clone from minecraft:overworld 48046 ~ 48000 48070 ~ 48093 to switch:game 48046 ~0 48000 strict replace force
...
execute if score #rg_new_grounds_mod switch.data matches 3 at @s run clone from minecraft:overworld 48070 ~ 48000 48093 ~ 48093 to switch:game 48070 ~0 48000 strict replace force
