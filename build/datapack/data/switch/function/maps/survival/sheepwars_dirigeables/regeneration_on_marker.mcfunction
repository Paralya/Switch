...
execute if score #rg_sheepwars_dirigeables_mod switch.data matches 0 at @s run clone from minecraft:overworld 100000 ~ 100000 100021 ~ 100103 to switch:game 100000 ~0 100000 replace force
...
execute if score #rg_sheepwars_dirigeables_mod switch.data matches 1 at @s run clone from minecraft:overworld 100021 ~ 100000 100043 ~ 100103 to switch:game 100021 ~0 100000 replace force
...
execute if score #rg_sheepwars_dirigeables_mod switch.data matches 2 at @s run clone from minecraft:overworld 100043 ~ 100000 100064 ~ 100103 to switch:game 100043 ~0 100000 replace force
...
execute if score #rg_sheepwars_dirigeables_mod switch.data matches 3 at @s run clone from minecraft:overworld 100064 ~ 100000 100086 ~ 100103 to switch:game 100064 ~0 100000 replace force
...
execute if score #rg_sheepwars_dirigeables_mod switch.data matches 4 at @s run clone from minecraft:overworld 100086 ~ 100000 100107 ~ 100103 to switch:game 100086 ~0 100000 replace force
