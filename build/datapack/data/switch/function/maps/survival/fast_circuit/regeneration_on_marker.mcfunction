...
execute if score #rg_fast_circuit_mod switch.data matches 0 at @s run clone from minecraft:overworld 20153 ~ 19522 20168 ~ 19650 to switch:game 20153 ~0 19522 strict replace force
...
execute if score #rg_fast_circuit_mod switch.data matches 1 at @s run clone from minecraft:overworld 20168 ~ 19522 20184 ~ 19650 to switch:game 20168 ~0 19522 strict replace force
...
execute if score #rg_fast_circuit_mod switch.data matches 2 at @s run clone from minecraft:overworld 20184 ~ 19522 20199 ~ 19650 to switch:game 20184 ~0 19522 strict replace force
...
execute if score #rg_fast_circuit_mod switch.data matches 3 at @s run clone from minecraft:overworld 20199 ~ 19522 20215 ~ 19650 to switch:game 20199 ~0 19522 strict replace force
...
execute if score #rg_fast_circuit_mod switch.data matches 4 at @s run clone from minecraft:overworld 20215 ~ 19522 20230 ~ 19650 to switch:game 20215 ~0 19522 strict replace force
