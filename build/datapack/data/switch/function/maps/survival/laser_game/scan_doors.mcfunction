...
execute if score #scan_laser_game switch.data matches 1 in minecraft:overworld run forceload add 499 499 525 551
execute if score #scan_laser_game switch.data matches 1 in switch:game run forceload add 499 499 525 551

execute if score #scan_laser_game switch.data matches 1 in minecraft:overworld run forceload add 525 499 551 551
execute if score #scan_laser_game switch.data matches 1 in switch:game run forceload add 525 499 551 551
...
execute if score #scan_laser_game switch.data matches 1 run scoreboard players set #start_x_laser_game switch.data 500
execute if score #scan_laser_game switch.data matches 1 run scoreboard players set #start_y_laser_game switch.data 1
execute if score #scan_laser_game switch.data matches 1 run scoreboard players set #start_z_laser_game switch.data 500
execute if score #scan_laser_game switch.data matches 1 run scoreboard players set #end_x_laser_game switch.data 550
execute if score #scan_laser_game switch.data matches 1 run scoreboard players set #end_y_laser_game switch.data 42
execute if score #scan_laser_game switch.data matches 1 run scoreboard players set #end_z_laser_game switch.data 550
...
execute if score #scan_laser_game switch.data matches 52 in minecraft:overworld run forceload remove 499 499 525 551
execute if score #scan_laser_game switch.data matches 52 in switch:game run forceload remove 499 499 525 551

execute if score #scan_laser_game switch.data matches 52 in minecraft:overworld run forceload remove 525 499 551 551
execute if score #scan_laser_game switch.data matches 52 in switch:game run forceload remove 525 499 551 551
