...
execute if score #rg_laser_game_mod switch.data matches 0 at @s run clone from minecraft:overworld 500 ~ 500 526 ~ 552 to switch:game 500 ~0 500 strict replace force
...
execute if score #rg_laser_game_mod switch.data matches 1 at @s run clone from minecraft:overworld 526 ~ 500 552 ~ 552 to switch:game 526 ~0 500 strict replace force
