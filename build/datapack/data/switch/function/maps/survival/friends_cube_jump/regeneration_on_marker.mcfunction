...
execute if score #rg_friends_cube_jump_mod switch.data matches 0 at @s run clone from minecraft:overworld 9000 ~ 9000 9018 ~ 9032 to switch:game 9000 ~0 9000 replace force
...
execute if score #rg_friends_cube_jump_mod switch.data matches 1 at @s run clone from minecraft:overworld 9018 ~ 9000 9035 ~ 9032 to switch:game 9018 ~0 9000 replace force
