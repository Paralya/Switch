...
execute if score #rg_shoot_da_sheep_mod switch.data matches 0 at @s run clone from minecraft:overworld 123000 ~ 123000 123020 ~ 123040 to switch:game 123000 ~0 123000 strict replace force
...
execute if score #rg_shoot_da_sheep_mod switch.data matches 1 at @s run clone from minecraft:overworld 123020 ~ 123000 123040 ~ 123040 to switch:game 123020 ~0 123000 strict replace force
