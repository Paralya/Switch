...
execute if score #rg_void_desert_mod switch.data matches 0 at @s run clone from minecraft:overworld 68000 ~ 68000 68020 ~ 68100 to switch:game 68000 ~0 68000 strict replace force
...
execute if score #rg_void_desert_mod switch.data matches 1 at @s run clone from minecraft:overworld 68020 ~ 68000 68040 ~ 68100 to switch:game 68020 ~0 68000 strict replace force
...
execute if score #rg_void_desert_mod switch.data matches 2 at @s run clone from minecraft:overworld 68040 ~ 68000 68060 ~ 68100 to switch:game 68040 ~0 68000 strict replace force
...
execute if score #rg_void_desert_mod switch.data matches 3 at @s run clone from minecraft:overworld 68060 ~ 68000 68080 ~ 68100 to switch:game 68060 ~0 68000 strict replace force
...
execute if score #rg_void_desert_mod switch.data matches 4 at @s run clone from minecraft:overworld 68080 ~ 68000 68100 ~ 68100 to switch:game 68080 ~0 68000 strict replace force
