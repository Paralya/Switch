...
execute if score #rg_bombardement_mod switch.data matches 0 at @s run clone from minecraft:overworld 121000 ~ 121000 121023 ~ 121087 to switch:game 121000 ~0 121000 replace force
...
execute if score #rg_bombardement_mod switch.data matches 1 at @s run clone from minecraft:overworld 121023 ~ 121000 121046 ~ 121087 to switch:game 121023 ~0 121000 replace force
...
execute if score #rg_bombardement_mod switch.data matches 2 at @s run clone from minecraft:overworld 121046 ~ 121000 121069 ~ 121087 to switch:game 121046 ~0 121000 replace force
...
execute if score #rg_bombardement_mod switch.data matches 3 at @s run clone from minecraft:overworld 121069 ~ 121000 121092 ~ 121087 to switch:game 121069 ~0 121000 replace force
...
execute if score #rg_bombardement_mod switch.data matches 4 at @s run clone from minecraft:overworld 121092 ~ 121000 121115 ~ 121087 to switch:game 121092 ~0 121000 replace force
