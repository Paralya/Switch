...
execute if score #rg_floating_island_mod switch.data matches 0 at @s run clone from minecraft:overworld 94000 ~ 94000 94025 ~ 94076 to switch:game 94000 ~0 94000 replace force
...
execute if score #rg_floating_island_mod switch.data matches 1 at @s run clone from minecraft:overworld 94025 ~ 94000 94051 ~ 94076 to switch:game 94025 ~0 94000 replace force
...
execute if score #rg_floating_island_mod switch.data matches 2 at @s run clone from minecraft:overworld 94051 ~ 94000 94076 ~ 94076 to switch:game 94051 ~0 94000 replace force
