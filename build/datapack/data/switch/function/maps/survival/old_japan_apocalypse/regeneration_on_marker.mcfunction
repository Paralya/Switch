...
execute if score #rg_old_japan_apocalypse_mod switch.data matches 0 at @s run clone from minecraft:overworld 129000 ~ 129000 129020 ~ 129102 to switch:game 129000 ~0 129000 strict replace force
...
execute if score #rg_old_japan_apocalypse_mod switch.data matches 1 at @s run clone from minecraft:overworld 129020 ~ 129000 129041 ~ 129102 to switch:game 129020 ~0 129000 strict replace force
...
execute if score #rg_old_japan_apocalypse_mod switch.data matches 2 at @s run clone from minecraft:overworld 129041 ~ 129000 129061 ~ 129102 to switch:game 129041 ~0 129000 strict replace force
...
execute if score #rg_old_japan_apocalypse_mod switch.data matches 3 at @s run clone from minecraft:overworld 129061 ~ 129000 129082 ~ 129102 to switch:game 129061 ~0 129000 strict replace force
...
execute if score #rg_old_japan_apocalypse_mod switch.data matches 4 at @s run clone from minecraft:overworld 129082 ~ 129000 129102 ~ 129102 to switch:game 129082 ~0 129000 strict replace force
