...
execute if score #rg_pitchout_1_mod switch.data matches 0 at @s run clone from minecraft:overworld 1000 ~ 1000 1020 ~ 1100 to switch:game 1000 ~0 1000 replace force
...
execute if score #rg_pitchout_1_mod switch.data matches 1 at @s run clone from minecraft:overworld 1020 ~ 1000 1040 ~ 1100 to switch:game 1020 ~0 1000 replace force
...
execute if score #rg_pitchout_1_mod switch.data matches 2 at @s run clone from minecraft:overworld 1040 ~ 1000 1060 ~ 1100 to switch:game 1040 ~0 1000 replace force
...
execute if score #rg_pitchout_1_mod switch.data matches 3 at @s run clone from minecraft:overworld 1060 ~ 1000 1080 ~ 1100 to switch:game 1060 ~0 1000 replace force
...
execute if score #rg_pitchout_1_mod switch.data matches 4 at @s run clone from minecraft:overworld 1080 ~ 1000 1100 ~ 1100 to switch:game 1080 ~0 1000 replace force
