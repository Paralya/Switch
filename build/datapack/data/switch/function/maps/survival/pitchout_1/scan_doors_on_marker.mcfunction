...
#> switch:maps/survival/pitchout_1/scan_doors_on_marker
#
# @within	switch:maps/survival/pitchout_1/scan_doors
#			switch:maps/survival/pitchout_1/scan_doors_on_marker
#

execute store result entity @s Pos[0] double 1 run scoreboard players get #curr_x_pitchout_1 switch.data
execute store result entity @s Pos[1] double 1 run scoreboard players get #curr_y_pitchout_1 switch.data
execute store result entity @s Pos[2] double 1 run scoreboard players get #curr_z_pitchout_1 switch.data
scoreboard players add #curr_x_pitchout_1 switch.data 1
execute if score #curr_x_pitchout_1 switch.data > #end_x_pitchout_1 switch.data run scoreboard players add #curr_y_pitchout_1 switch.data 1
