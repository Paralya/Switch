...
execute if score #rg_ctf_forest_castles_mod switch.data matches 0 at @s run clone from minecraft:overworld 150000 ~ 150000 150013 ~ 150216 to switch:game 150000 ~0 150000 strict replace force
...
execute if score #rg_ctf_forest_castles_mod switch.data matches 1 at @s run clone from minecraft:overworld 150013 ~ 150000 150025 ~ 150216 to switch:game 150013 ~0 150000 strict replace force
...
execute if score #rg_ctf_forest_castles_mod switch.data matches 2 at @s run clone from minecraft:overworld 150025 ~ 150000 150038 ~ 150216 to switch:game 150025 ~0 150000 strict replace force
...
execute if score #rg_ctf_forest_castles_mod switch.data matches 3 at @s run clone from minecraft:overworld 150038 ~ 150000 150050 ~ 150216 to switch:game 150038 ~0 150000 strict replace force
...
execute if score #rg_ctf_forest_castles_mod switch.data matches 4 at @s run clone from minecraft:overworld 150050 ~ 150000 150063 ~ 150216 to switch:game 150050 ~0 150000 strict replace force
...
execute if score #rg_ctf_forest_castles_mod switch.data matches 5 at @s run clone from minecraft:overworld 150063 ~ 150000 150076 ~ 150216 to switch:game 150063 ~0 150000 strict replace force
...
execute if score #rg_ctf_forest_castles_mod switch.data matches 6 at @s run clone from minecraft:overworld 150076 ~ 150000 150088 ~ 150216 to switch:game 150076 ~0 150000 strict replace force
...
execute if score #rg_ctf_forest_castles_mod switch.data matches 7 at @s run clone from minecraft:overworld 150088 ~ 150000 150101 ~ 150216 to switch:game 150088 ~0 150000 strict replace force
