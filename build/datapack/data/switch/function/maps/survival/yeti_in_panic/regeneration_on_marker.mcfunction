...
execute if score #rg_yeti_in_panic_mod switch.data matches 0 at @s run clone from minecraft:overworld 158000 ~ 158000 158026 ~ 158070 to switch:game 158000 ~0 158000 replace force
...
execute if score #rg_yeti_in_panic_mod switch.data matches 1 at @s run clone from minecraft:overworld 158026 ~ 158000 158051 ~ 158070 to switch:game 158026 ~0 158000 replace force
...
execute if score #rg_yeti_in_panic_mod switch.data matches 2 at @s run clone from minecraft:overworld 158051 ~ 158000 158077 ~ 158070 to switch:game 158051 ~0 158000 replace force
