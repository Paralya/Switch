...
execute if score #rg_layers_2_teams_mod switch.data matches 0 at @s run clone from minecraft:overworld 27000 ~ 27000 27018 ~ 27062 to switch:game 27000 ~0 27000 strict replace force
...
execute if score #rg_layers_2_teams_mod switch.data matches 1 at @s run clone from minecraft:overworld 27018 ~ 27000 27036 ~ 27062 to switch:game 27018 ~0 27000 strict replace force
