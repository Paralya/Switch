...
execute if score #rg_layers_2_teams switch.data matches 127.. run tellraw @a ["",{"nbt":"ParalyaWarning","storage":"switch:main","interpret":true},{"text":" Map '","color":"yellow"},{"text":"layers_2_teams","color":"gold"},{"text":"' regenerated in ","color":"yellow"},{"text":"6","color":"gold"},{"text":"s","color":"yellow"}]

execute if score #rg_layers_2_teams switch.data matches 127.. run data modify storage switch:main MessageToLog set value '{"text":"Map `layers_2_teams` just regenerated!"}'
