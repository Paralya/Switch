...
execute if score #rg_ctf_flowers_mod switch.data matches 0 at @s run clone from minecraft:overworld 148000 ~ 148000 148025 ~ 148105 to switch:game 148000 ~0 148000 strict replace force
...
execute if score #rg_ctf_flowers_mod switch.data matches 1 at @s run clone from minecraft:overworld 148025 ~ 148000 148050 ~ 148105 to switch:game 148025 ~0 148000 strict replace force
...
execute if score #rg_ctf_flowers_mod switch.data matches 2 at @s run clone from minecraft:overworld 148050 ~ 148000 148076 ~ 148105 to switch:game 148050 ~0 148000 strict replace force
...
execute if score #rg_ctf_flowers_mod switch.data matches 3 at @s run clone from minecraft:overworld 148076 ~ 148000 148101 ~ 148105 to switch:game 148076 ~0 148000 strict replace force
...
execute if score #rg_ctf_flowers_mod switch.data matches 4 at @s run clone from minecraft:overworld 148101 ~ 148000 148126 ~ 148105 to switch:game 148101 ~0 148000 strict replace force
...
execute if score #rg_ctf_flowers_mod switch.data matches 5 at @s run clone from minecraft:overworld 148126 ~ 148000 148152 ~ 148105 to switch:game 148126 ~0 148000 strict replace force
...
execute if score #rg_ctf_flowers_mod switch.data matches 6 at @s run clone from minecraft:overworld 148152 ~ 148000 148177 ~ 148105 to switch:game 148152 ~0 148000 strict replace force
...
execute if score #rg_ctf_flowers_mod switch.data matches 7 at @s run clone from minecraft:overworld 148177 ~ 148000 148202 ~ 148105 to switch:game 148177 ~0 148000 strict replace force
