...
execute if score #rg_vilarles_castillo switch.data matches 1728.. run tellraw @a ["",{"nbt":"ParalyaWarning","storage":"switch:main","interpret":true},{"text":" Map '","color":"yellow"},{"text":"vilarles_castillo","color":"gold"},{"text":"' regenerated in ","color":"yellow"},{"text":"1","color":"gold"},{"text":"m","color":"yellow"},{"text":"26","color":"gold"},{"text":"s","color":"yellow"}]

execute if score #rg_vilarles_castillo switch.data matches 1728.. run data modify storage switch:main MessageToLog set value '{"text":"Map `vilarles_castillo` just regenerated!"}'
