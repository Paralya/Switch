...
execute if score #rg_memory_mine_mod switch.data matches 0 at @s run clone from minecraft:overworld 153000 ~ 153000 153014 ~ 153036 to switch:game 153000 ~0 153000 strict replace force
...
execute if score #rg_memory_mine_mod switch.data matches 1 at @s run clone from minecraft:overworld 153014 ~ 153000 153029 ~ 153036 to switch:game 153014 ~0 153000 strict replace force
