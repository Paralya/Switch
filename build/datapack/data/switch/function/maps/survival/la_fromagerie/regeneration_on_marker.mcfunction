...
execute if score #rg_la_fromagerie_mod switch.data matches 0 at @s run clone from minecraft:overworld 59000 ~ 59000 59020 ~ 59099 to switch:game 59000 ~0 59000 replace force
...
execute if score #rg_la_fromagerie_mod switch.data matches 1 at @s run clone from minecraft:overworld 59020 ~ 59000 59040 ~ 59099 to switch:game 59020 ~0 59000 replace force
...
execute if score #rg_la_fromagerie_mod switch.data matches 2 at @s run clone from minecraft:overworld 59040 ~ 59000 59059 ~ 59099 to switch:game 59040 ~0 59000 replace force
...
execute if score #rg_la_fromagerie_mod switch.data matches 3 at @s run clone from minecraft:overworld 59059 ~ 59000 59079 ~ 59099 to switch:game 59059 ~0 59000 replace force
...
execute if score #rg_la_fromagerie_mod switch.data matches 4 at @s run clone from minecraft:overworld 59079 ~ 59000 59099 ~ 59099 to switch:game 59079 ~0 59000 replace force
