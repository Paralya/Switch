...
execute if score #rg_survival_boat_mod switch.data matches 0 at @s run clone from minecraft:overworld 79000 ~ 79000 79021 ~ 79102 to switch:game 79000 ~0 79000 replace force
...
execute if score #rg_survival_boat_mod switch.data matches 1 at @s run clone from minecraft:overworld 79021 ~ 79000 79042 ~ 79102 to switch:game 79021 ~0 79000 replace force
...
execute if score #rg_survival_boat_mod switch.data matches 2 at @s run clone from minecraft:overworld 79042 ~ 79000 79063 ~ 79102 to switch:game 79042 ~0 79000 replace force
...
execute if score #rg_survival_boat_mod switch.data matches 3 at @s run clone from minecraft:overworld 79063 ~ 79000 79084 ~ 79102 to switch:game 79063 ~0 79000 replace force
...
execute if score #rg_survival_boat_mod switch.data matches 4 at @s run clone from minecraft:overworld 79084 ~ 79000 79105 ~ 79102 to switch:game 79084 ~0 79000 replace force
...
execute if score #rg_survival_boat_mod switch.data matches 5 at @s run clone from minecraft:overworld 79105 ~ 79000 79126 ~ 79102 to switch:game 79105 ~0 79000 replace force
