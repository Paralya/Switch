...
execute if score #rg_stardust_prison_mod switch.data matches 0 at @s run clone from minecraft:overworld 106000 ~ 106000 106015 ~ 106178 to switch:game 106000 ~0 106000 replace force
...
execute if score #rg_stardust_prison_mod switch.data matches 1 at @s run clone from minecraft:overworld 106015 ~ 106000 106029 ~ 106178 to switch:game 106015 ~0 106000 replace force
...
execute if score #rg_stardust_prison_mod switch.data matches 2 at @s run clone from minecraft:overworld 106029 ~ 106000 106044 ~ 106178 to switch:game 106029 ~0 106000 replace force
...
execute if score #rg_stardust_prison_mod switch.data matches 3 at @s run clone from minecraft:overworld 106044 ~ 106000 106059 ~ 106178 to switch:game 106044 ~0 106000 replace force
...
execute if score #rg_stardust_prison_mod switch.data matches 4 at @s run clone from minecraft:overworld 106059 ~ 106000 106073 ~ 106178 to switch:game 106059 ~0 106000 replace force
...
execute if score #rg_stardust_prison_mod switch.data matches 5 at @s run clone from minecraft:overworld 106073 ~ 106000 106088 ~ 106178 to switch:game 106073 ~0 106000 replace force
...
execute if score #rg_stardust_prison_mod switch.data matches 6 at @s run clone from minecraft:overworld 106088 ~ 106000 106103 ~ 106178 to switch:game 106088 ~0 106000 replace force
...
execute if score #rg_stardust_prison_mod switch.data matches 7 at @s run clone from minecraft:overworld 106103 ~ 106000 106117 ~ 106178 to switch:game 106103 ~0 106000 replace force
...
execute if score #rg_stardust_prison_mod switch.data matches 8 at @s run clone from minecraft:overworld 106117 ~ 106000 106132 ~ 106178 to switch:game 106117 ~0 106000 replace force
