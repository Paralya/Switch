...
#
# @within	switch:maps/survival/stardust_prison/regenerate 1t
...
execute if score #rg_stardust_prison switch.data matches 523.. in switch:game run kill @e[type=item,x=106066,y=0,z=106089,distance=..1000]
