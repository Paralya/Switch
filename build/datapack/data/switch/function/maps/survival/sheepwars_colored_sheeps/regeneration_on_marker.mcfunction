...
execute if score #rg_sheepwars_colored_sheeps_mod switch.data matches 0 at @s run clone from minecraft:overworld 154000 ~ 154000 154021 ~ 154106 to switch:game 154000 ~0 154000 strict replace force
...
execute if score #rg_sheepwars_colored_sheeps_mod switch.data matches 1 at @s run clone from minecraft:overworld 154021 ~ 154000 154043 ~ 154106 to switch:game 154021 ~0 154000 strict replace force
...
execute if score #rg_sheepwars_colored_sheeps_mod switch.data matches 2 at @s run clone from minecraft:overworld 154043 ~ 154000 154064 ~ 154106 to switch:game 154043 ~0 154000 strict replace force
...
execute if score #rg_sheepwars_colored_sheeps_mod switch.data matches 3 at @s run clone from minecraft:overworld 154064 ~ 154000 154086 ~ 154106 to switch:game 154064 ~0 154000 strict replace force
...
execute if score #rg_sheepwars_colored_sheeps_mod switch.data matches 4 at @s run clone from minecraft:overworld 154086 ~ 154000 154107 ~ 154106 to switch:game 154086 ~0 154000 strict replace force
