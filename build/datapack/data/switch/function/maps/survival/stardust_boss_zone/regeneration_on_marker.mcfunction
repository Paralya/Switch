...
execute if score #rg_stardust_boss_zone_mod switch.data matches 0 at @s run clone from minecraft:overworld 103000 ~ 103000 103016 ~ 103165 to switch:game 103000 ~0 103000 replace force
...
execute if score #rg_stardust_boss_zone_mod switch.data matches 1 at @s run clone from minecraft:overworld 103016 ~ 103000 103033 ~ 103165 to switch:game 103016 ~0 103000 replace force
...
execute if score #rg_stardust_boss_zone_mod switch.data matches 2 at @s run clone from minecraft:overworld 103033 ~ 103000 103050 ~ 103165 to switch:game 103033 ~0 103000 replace force
...
execute if score #rg_stardust_boss_zone_mod switch.data matches 3 at @s run clone from minecraft:overworld 103050 ~ 103000 103066 ~ 103165 to switch:game 103050 ~0 103000 replace force
...
execute if score #rg_stardust_boss_zone_mod switch.data matches 4 at @s run clone from minecraft:overworld 103066 ~ 103000 103082 ~ 103165 to switch:game 103066 ~0 103000 replace force
...
execute if score #rg_stardust_boss_zone_mod switch.data matches 5 at @s run clone from minecraft:overworld 103082 ~ 103000 103099 ~ 103165 to switch:game 103082 ~0 103000 replace force
...
execute if score #rg_stardust_boss_zone_mod switch.data matches 6 at @s run clone from minecraft:overworld 103099 ~ 103000 103116 ~ 103165 to switch:game 103099 ~0 103000 replace force
...
execute if score #rg_stardust_boss_zone_mod switch.data matches 7 at @s run clone from minecraft:overworld 103116 ~ 103000 103132 ~ 103165 to switch:game 103116 ~0 103000 replace force
