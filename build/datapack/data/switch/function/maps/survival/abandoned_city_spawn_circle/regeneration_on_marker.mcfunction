...
execute if score #rg_abandoned_city_spawn_circle_mod switch.data matches 0 at @s run clone from minecraft:overworld 43000 ~ 43000 43020 ~ 43082 to switch:game 43000 ~0 43000 replace force
...
execute if score #rg_abandoned_city_spawn_circle_mod switch.data matches 1 at @s run clone from minecraft:overworld 43020 ~ 43000 43041 ~ 43082 to switch:game 43020 ~0 43000 replace force
...
execute if score #rg_abandoned_city_spawn_circle_mod switch.data matches 2 at @s run clone from minecraft:overworld 43041 ~ 43000 43062 ~ 43082 to switch:game 43041 ~0 43000 replace force
...
execute if score #rg_abandoned_city_spawn_circle_mod switch.data matches 3 at @s run clone from minecraft:overworld 43062 ~ 43000 43082 ~ 43082 to switch:game 43062 ~0 43000 replace force
