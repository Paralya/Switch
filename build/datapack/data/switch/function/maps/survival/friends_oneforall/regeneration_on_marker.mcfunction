...
execute if score #rg_friends_oneforall_mod switch.data matches 0 at @s run clone from minecraft:overworld 8000 ~ 8000 8024 ~ 8048 to switch:game 8000 ~0 8000 strict replace force
...
execute if score #rg_friends_oneforall_mod switch.data matches 1 at @s run clone from minecraft:overworld 8024 ~ 8000 8048 ~ 8048 to switch:game 8024 ~0 8000 strict replace force
