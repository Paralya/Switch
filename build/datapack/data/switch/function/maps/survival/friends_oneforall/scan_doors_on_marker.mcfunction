...
#> switch:maps/survival/friends_oneforall/scan_doors_on_marker
#
# @within	switch:maps/survival/friends_oneforall/scan_doors
#			switch:maps/survival/friends_oneforall/scan_doors_on_marker
#

execute store result entity @s Pos[0] double 1 run scoreboard players get #curr_x_friends_oneforall switch.data
execute store result entity @s Pos[1] double 1 run scoreboard players get #curr_y_friends_oneforall switch.data
execute store result entity @s Pos[2] double 1 run scoreboard players get #curr_z_friends_oneforall switch.data
scoreboard players add #curr_x_friends_oneforall switch.data 1
execute if score #curr_x_friends_oneforall switch.data > #end_x_friends_oneforall switch.data run scoreboard players add #curr_y_friends_oneforall switch.data 1
