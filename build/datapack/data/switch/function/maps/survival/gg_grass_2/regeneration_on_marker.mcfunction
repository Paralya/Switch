...
execute if score #rg_gg_grass_2_mod switch.data matches 0 at @s run clone from minecraft:overworld 124001 ~ 124001 124021 ~ 124046 to switch:game 124001 ~16 124001 strict replace force
...
execute if score #rg_gg_grass_2_mod switch.data matches 1 at @s run clone from minecraft:overworld 124021 ~ 124001 124041 ~ 124046 to switch:game 124021 ~16 124001 strict replace force
