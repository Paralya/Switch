...
execute if data storage switch:main {map:"end_factory"} run function switch:maps/survival/end_factory/regenerate
...
execute if data storage switch:main {map:"winnie_city"} run function switch:maps/survival/winnie_city/regenerate
...
execute if data storage switch:main {map:"pitch_creep_nether"} run function switch:maps/survival/pitch_creep_nether/regenerate
