...
execute if data storage switch:main {map:"switch_space"} run function switch:maps/survival/switch_space/regenerate
...
execute if data storage switch:main {map:"area_51"} run function switch:maps/survival/area_51/regenerate
...
execute if data storage switch:main {map:"pitch_creep_1"} run function switch:maps/survival/pitch_creep_1/regenerate
execute if data storage switch:main {map:"mushroom_plains"} run function switch:maps/survival/mushroom_plains/regenerate
execute if data storage switch:main {map:"boat_race_1"} run function switch:maps/survival/boat_race_1/regenerate
execute if data storage switch:main {map:"elytra_box"} run function switch:maps/survival/elytra_box/regenerate
...
execute if data storage switch:main {map:"friends_cube_jump"} run function switch:maps/survival/friends_cube_jump/regenerate
...
execute if data storage switch:main {map:"coupdetat"} run function switch:maps/survival/coupdetat/regenerate
execute if data storage switch:main {map:"flamingosaurus_mariokart"} run function switch:maps/survival/flamingosaurus_mariokart/regenerate
execute if data storage switch:main {map:"mario_circuit"} run function switch:maps/survival/mario_circuit/regenerate
execute if data storage switch:main {map:"fast_circuit"} run function switch:maps/survival/fast_circuit/regenerate
execute if data storage switch:main {map:"plains_routine"} run function switch:maps/survival/plains_routine/regenerate
execute if data storage switch:main {map:"city_race"} run function switch:maps/survival/city_race/regenerate
execute if data storage switch:main {map:"sakura_land"} run function switch:maps/survival/sakura_land/regenerate
execute if data storage switch:main {map:"hills_land"} run function switch:maps/survival/hills_land/regenerate
execute if data storage switch:main {map:"airship_fortress"} run function switch:maps/survival/airship_fortress/regenerate
execute if data storage switch:main {map:"dk_mountain"} run function switch:maps/survival/dk_mountain/regenerate
execute if data storage switch:main {map:"clock_circuit"} run function switch:maps/survival/clock_circuit/regenerate
...
execute if data storage switch:main {map:"rainbow_road"} run function switch:maps/survival/rainbow_road/regenerate
execute if data storage switch:main {map:"trackmania_stadium_1"} run function switch:maps/survival/trackmania_stadium_1/regenerate
...
execute if data storage switch:main {map:"adraik_big_ball"} run function switch:maps/survival/adraik_big_ball/regenerate
...
execute if data storage switch:main {map:"abandoned_city_spawn_circle"} run function switch:maps/survival/abandoned_city_spawn_circle/regenerate
execute if data storage switch:main {map:"abandoned_city"} run function switch:maps/survival/abandoned_city/regenerate
execute if data storage switch:main {map:"old_japan"} run function switch:maps/survival/old_japan/regenerate
...
execute if data storage switch:main {map:"boat_race_2"} run function switch:maps/survival/boat_race_2/regenerate
...
execute if data storage switch:main {map:"cluedo_camping"} run function switch:maps/survival/cluedo_camping/regenerate
execute if data storage switch:main {map:"sudoku_craft"} run function switch:maps/survival/sudoku_craft/regenerate
execute if data storage switch:main {map:"la_juste_recette"} run function switch:maps/survival/la_juste_recette/regenerate
execute if data storage switch:main {map:"scartmania"} run function switch:maps/survival/scartmania/regenerate
execute if data storage switch:main {map:"la_fromagerie"} run function switch:maps/survival/la_fromagerie/regenerate
execute if data storage switch:main {map:"slimy_ground"} run function switch:maps/survival/slimy_ground/regenerate
execute if data storage switch:main {map:"eternal_void"} run function switch:maps/survival/eternal_void/regenerate
...
execute if data storage switch:main {map:"trials_run"} run function switch:maps/survival/trials_run/regenerate
execute if data storage switch:main {map:"void_desert"} run function switch:maps/survival/void_desert/regenerate
...
execute if data storage switch:main {map:"floating_island"} run function switch:maps/survival/floating_island/regenerate
...
execute if data storage switch:main {map:"paralya_lobby"} run function switch:maps/survival/paralya_lobby/regenerate
execute if data storage switch:main {map:"sheepwars_dirigeables"} run function switch:maps/survival/sheepwars_dirigeables/regenerate
...
execute if data storage switch:main {map:"tnt_run_futuristic"} run function switch:maps/survival/tnt_run_futuristic/regenerate
execute if data storage switch:main {map:"block_party"} run function switch:maps/survival/block_party/regenerate
execute if data storage switch:main {map:"nuketown_no_barrier"} run function switch:maps/survival/nuketown_no_barrier/regenerate
execute if data storage switch:main {map:"snowball_painter"} run function switch:maps/survival/snowball_painter/regenerate
execute if data storage switch:main {map:"gay_shooter"} run function switch:maps/survival/gay_shooter/regenerate
execute if data storage switch:main {map:"the_four_elements"} run function switch:maps/survival/the_four_elements/regenerate
execute if data storage switch:main {map:"remelta_cluedo"} run function switch:maps/survival/remelta_cluedo/regenerate
execute if data storage switch:main {map:"arti_box"} run function switch:maps/survival/arti_box/regenerate
execute if data storage switch:main {map:"bombardement"} run function switch:maps/survival/bombardement/regenerate
...
execute if data storage switch:main {map:"sheepwars_plateforme"} run function switch:maps/survival/sheepwars_plateforme/regenerate
execute if data storage switch:main {map:"sheepwars_ilots"} run function switch:maps/survival/sheepwars_ilots/regenerate
execute if data storage switch:main {map:"ctf_plains_castles"} run function switch:maps/survival/ctf_plains_castles/regenerate
execute if data storage switch:main {map:"ctf_mountains_castles"} run function switch:maps/survival/ctf_mountains_castles/regenerate
execute if data storage switch:main {map:"ctf_flowers"} run function switch:maps/survival/ctf_flowers/regenerate
execute if data storage switch:main {map:"ctf_nether"} run function switch:maps/survival/ctf_nether/regenerate
...
execute if data storage switch:main {map:"arti_ancient_city"} run function switch:maps/survival/arti_ancient_city/regenerate
execute if data storage switch:main {map:"yeti_in_panic"} run function switch:maps/survival/yeti_in_panic/regenerate
execute if data storage switch:main {map:"cluedo_casino"} run function switch:maps/survival/cluedo_casino/regenerate
