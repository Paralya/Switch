...
#> sheepwars:sheeps/distorsion/summon
#
...
# Summon the sheep
summon sheep ~ ~1 ~ {Tags:["sheepwars.distorsion","sheepwars.sheep","sheepwars.in_air","sheepwars.new"],Color:10,DeathLootTable:"sheepwars:i/distorsion"}
