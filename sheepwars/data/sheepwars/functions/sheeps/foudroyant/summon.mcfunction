...
#> sheepwars:sheeps/foudroyant/summon
#
...
# Summon the sheep
summon sheep ~ ~1 ~ {Tags:["sheepwars.foudroyant","sheepwars.sheep","sheepwars.in_air","sheepwars.new"],Color:4,DeathLootTable:"sheepwars:i/foudroyant"}
