...
# Summon the sheep
summon sheep ~ ~1 ~ {Tags:["sheepwars.sheep","sheepwars.explode","sheepwars.fragmentation","sheepwars.in_air","sheepwars.new"],Color:8,DeathLootTable:"sheepwars:i/foudroyant"}
