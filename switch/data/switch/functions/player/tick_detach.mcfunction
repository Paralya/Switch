...
execute unless score #inventory switch.data matches 10 run item replace entity @s inventory.4 with pink_concrete{switch:{jump_pink:1b},display:{Name:'{"text":"Pink Jump","color":"light_purple","italic":false}',Lore:['{"text":"par OfChara","color":"gray","italic":false}']}}
execute unless score #inventory switch.data matches 10 run item replace entity @s inventory.5 with bricks{switch:{jump_bricks:1b},display:{Name:'{"text":"Bricks Jump","color":"#BC4A3C","italic":false}',Lore:['{"text":"par Thitanas","color":"gray","italic":false}']}}
execute unless score #inventory switch.data matches 10 run item replace entity @s inventory.10 with lime_concrete{switch:{jump_green:1b},display:{Name:'{"text":"Green Jump","color":"green","italic":false}',Lore:['{"text":"par Stoupy51","color":"gray","italic":false}']}}
execute unless score #inventory switch.data matches 10 run item replace entity @s inventory.11 with white_concrete{switch:{jump_white:1b},display:{Name:'{"text":"White Jump","color":"white","italic":false}',Lore:['{"text":"par Stoupy51","color":"gray","italic":false}']}}
execute unless score #inventory switch.data matches 10 run item replace entity @s inventory.12 with blue_concrete{switch:{jump_blue:1b},display:{Name:'{"text":"Blue Jump","color":"blue","italic":false}',Lore:['{"text":"par Stoupy51","color":"gray","italic":false}']}}
execute unless score #inventory switch.data matches 10 run item replace entity @s inventory.13 with yellow_concrete{switch:{jump_yellow:1b},display:{Name:'{"text":"Yellow Jump","color":"yellow","italic":false}',Lore:['{"text":"par ArtiGrrr","color":"gray","italic":false}']}}
execute unless score #inventory switch.data matches 10 run item replace entity @s inventory.14 with red_concrete{switch:{jump_red:1b},display:{Name:'{"text":"Red Jump","color":"red","italic":false}',Lore:['{"text":"par Stoupy51","color":"gray","italic":false}']}}
execute unless score #inventory switch.data matches 10 run item replace entity @s inventory.15 with brown_concrete{switch:{jump_brown:1b},display:{Name:'{"text":"Brown Jump","color":"#8B4513","italic":false}',Lore:['{"text":"par OfChara","color":"gray","italic":false}']}}
execute unless score #inventory switch.data matches 10 run item replace entity @s inventory.16 with purple_concrete{switch:{jump_purple:1b},display:{Name:'{"text":"Purple Jump","color":"light_purple","italic":false}',Lore:['{"text":"par AirDox","color":"gray","italic":false}']}}
execute unless score #inventory switch.data matches 10 run item replace entity @s inventory.22 with black_concrete{switch:{jump_black:1b},display:{Name:'{"text":"Black Jump","color":"black","italic":false}',Lore:['{"text":"par Stoupy51","color":"gray","italic":false}']}}
