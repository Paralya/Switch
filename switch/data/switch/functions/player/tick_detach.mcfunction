...
execute if score #inventory switch.data matches 8 run scoreboard players set #inventory switch.data -1
...
execute if score #inventory switch.data matches -1 run clear @s #switch:jumps{switch:{}}

# If lost at least one item, setup inventory
execute unless score #inventory switch.data matches 8 run item replace entity @s inventory.3 with dripstone_block{switch:{jump_dripstone:1b},display:{Name:'{"text":"Dripstone Jump","color":"gold","italic":false}'}}
execute unless score #inventory switch.data matches 8 run item replace entity @s inventory.5 with bricks{switch:{jump_bricks:1b},display:{Name:'{"text":"Bricks Jump","color":"#BC4A3C","italic":false}'}}
execute unless score #inventory switch.data matches 8 run item replace entity @s inventory.10 with lime_concrete{switch:{jump_green:1b},display:{Name:'{"text":"Green Jump","color":"green","italic":false}'}}
execute unless score #inventory switch.data matches 8 run item replace entity @s inventory.11 with white_concrete{switch:{jump_white:1b},display:{Name:'{"text":"White Jump","color":"white","italic":false}'}}
execute unless score #inventory switch.data matches 8 run item replace entity @s inventory.12 with blue_concrete{switch:{jump_blue:1b},display:{Name:'{"text":"Blue Jump","color":"blue","italic":false}'}}
execute unless score #inventory switch.data matches 8 run item replace entity @s inventory.13 with yellow_concrete{switch:{jump_yellow:1b},display:{Name:'{"text":"Yellow Jump","color":"yellow","italic":false}'}}
execute unless score #inventory switch.data matches 8 run item replace entity @s inventory.14 with red_concrete{switch:{jump_red:1b},display:{Name:'{"text":"Red Jump","color":"red","italic":false}'}}
execute unless score #inventory switch.data matches 8 run item replace entity @s inventory.15 with brown_concrete{switch:{jump_brown:1b},display:{Name:'{"text":"Brown Jump","color":"#8B4513","italic":false}'}}
execute unless score #inventory switch.data matches 8 run item replace entity @s inventory.16 with purple_concrete{switch:{jump_purple:1b},display:{Name:'{"text":"Purple Jump","color":"light_purple","italic":false}'}}
