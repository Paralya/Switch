...
execute unless score #inventory switch.data matches 13 run item replace entity @s inventory.22 with suspicious_gravel{switch:{jump:1b,jump_graviglitch:1b},display:{Name:'{"text":"GraviGlitch Jump","color":"#676767","italic":false}',Lore:['{"text":"by OfChara / AirDox","color":"gray","italic":false}']}}
