...
execute if score #tick switch.data matches 1 run tellraw @s "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n"
execute if score #tick switch.data matches 1 run tellraw @s [{"text":"Please choose a language by cliking it:","color":"aqua"}]
execute if score #tick switch.data matches 1 run tellraw @s [{"text":"\n[Français]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger switch.trigger.lang set 10"},"hoverEvent":{"action":"show_text","value":{"text":"[Cliquez pour choisir Français]","color":"yellow"}}}]
