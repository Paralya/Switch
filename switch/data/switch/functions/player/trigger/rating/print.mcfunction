...
$tellraw @s [{"text":"[","color":"aqua"},{"nbt":"minigames[{index:$(index)}].Name","storage":"switch:main","interpret":false,"color":"aqua"},{"text":"] ","color":"aqua"},{"text":"Notez ce mode : ","color":"white"},\
