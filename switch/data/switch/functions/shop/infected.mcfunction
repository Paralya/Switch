...
execute if score @s switch.infected.zombie_strength matches 0 run tellraw @s [{"text":"Force","color":"aqua"},{"text":" | ","bold":true,"color":"dark_gray"},{"text":"✮✮✮✮ ","color":"gray"},{"text":"[+]","color":"green","clickEvent":{"action":"run_command","value":"/trigger switch.trigger.shop set 213"},"hoverEvent":{"action":"show_text","contents":[{"text":"2.5 -> 2.7 dégâts par coup\n","color":"green"},{"text":"Acheter pour 50 Saphirs","color":"yellow"}]}}]
execute if score @s switch.infected.zombie_strength matches 1 run tellraw @s [{"text":"Force","color":"aqua"},{"text":" | ","bold":true,"color":"dark_gray"},{"text":"✮","color":"yellow"},{"text":"✮✮✮ ","color":"gray"},{"text":"[+]","color":"green","clickEvent":{"action":"run_command","value":"/trigger switch.trigger.shop set 213"},"hoverEvent":{"action":"show_text","contents":[{"text":"2.7 -> 3.0 dégâts par coup\n","color":"green"},{"text":"Acheter pour 100 Saphirs","color":"yellow"}]}}]
execute if score @s switch.infected.zombie_strength matches 2 run tellraw @s [{"text":"Force","color":"aqua"},{"text":" | ","bold":true,"color":"dark_gray"},{"text":"✮✮","color":"yellow"},{"text":"✮✮ ","color":"gray"},{"text":"[+]","color":"green","clickEvent":{"action":"run_command","value":"/trigger switch.trigger.shop set 213"},"hoverEvent":{"action":"show_text","contents":[{"text":"3.0 -> 3.2 dégâts par coup\n","color":"green"},{"text":"Acheter pour 200 Saphirs","color":"yellow"}]}}]
execute if score @s switch.infected.zombie_strength matches 3 run tellraw @s [{"text":"Force","color":"aqua"},{"text":" | ","bold":true,"color":"dark_gray"},{"text":"✮✮✮","color":"yellow"},{"text":"✮ ","color":"gray"},{"text":"[+]","color":"green","clickEvent":{"action":"run_command","value":"/trigger switch.trigger.shop set 213"},"hoverEvent":{"action":"show_text","contents":[{"text":"3.2 -> 3.5 dégâts par coup\n","color":"green"},{"text":"Acheter pour 400 Saphirs","color":"yellow"}]}}]
