...
execute if score @s switch.infected.zombie_strength matches 0 run tellraw @s [{"text":"Force","color":"aqua"},{"text":" | ","bold":true,"color":"dark_gray"},{"text":"✮✮✮✮ ","color":"gray"},{"text":"[+]","color":"green","clickEvent":{"action":"run_command","value":"/trigger switch.trigger.shop set 213"},"hoverEvent":{"action":"show_text","contents":[{"text":"1.5 -> 2.0 dégâts par coup\n","color":"green"},{"text":"Acheter pour 50$","color":"yellow"}]}}]
execute if score @s switch.infected.zombie_strength matches 1 run tellraw @s [{"text":"Force","color":"aqua"},{"text":" | ","bold":true,"color":"dark_gray"},{"text":"✮","color":"yellow"},{"text":"✮✮✮ ","color":"gray"},{"text":"[+]","color":"green","clickEvent":{"action":"run_command","value":"/trigger switch.trigger.shop set 213"},"hoverEvent":{"action":"show_text","contents":[{"text":"2.0 -> 2.5 dégâts par coup\n","color":"green"},{"text":"Acheter pour 100$","color":"yellow"}]}}]
execute if score @s switch.infected.zombie_strength matches 2 run tellraw @s [{"text":"Force","color":"aqua"},{"text":" | ","bold":true,"color":"dark_gray"},{"text":"✮✮","color":"yellow"},{"text":"✮✮ ","color":"gray"},{"text":"[+]","color":"green","clickEvent":{"action":"run_command","value":"/trigger switch.trigger.shop set 213"},"hoverEvent":{"action":"show_text","contents":[{"text":"2.5 -> 3.0 dégâts par coup\n","color":"green"},{"text":"Acheter pour 200$","color":"yellow"}]}}]
execute if score @s switch.infected.zombie_strength matches 3 run tellraw @s [{"text":"Force","color":"aqua"},{"text":" | ","bold":true,"color":"dark_gray"},{"text":"✮✮✮","color":"yellow"},{"text":"✮ ","color":"gray"},{"text":"[+]","color":"green","clickEvent":{"action":"run_command","value":"/trigger switch.trigger.shop set 213"},"hoverEvent":{"action":"show_text","contents":[{"text":"3.0 -> 3.5 dégâts par coup\n","color":"green"},{"text":"Acheter pour 400$","color":"yellow"}]}}]
