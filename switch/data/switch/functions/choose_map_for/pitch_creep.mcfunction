...
execute if score #mc switch.data matches 0 run data modify storage switch:main pitch_creep_maps append value "friends_pvpbox_ice"
execute if score #mc switch.data matches 0 run data modify storage switch:main pitch_creep_maps append value "friends_pvpbox_hills"
execute if score #mc switch.data matches 0 run data modify storage switch:main pitch_creep_maps append value "friends_pvpbox_end"
execute if score #mc switch.data matches 0 run data modify storage switch:main pitch_creep_maps append value "friends_cube_lobby"
execute if score #mc switch.data matches 0 run data modify storage switch:main pitch_creep_maps append value "zonweeb_main"
