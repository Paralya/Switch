...
execute if score #mc switch.data matches 0 run data modify storage switch:main traitors_game_maps append value "snow_travel"
execute if score #mc switch.data matches 0 run data modify storage switch:main traitors_game_maps append value "operation_pigclaw"
...
execute if score #mc switch.data matches 0 run data modify storage switch:main traitors_game_maps append value "taroatlas_soviet_prison"
execute if score #mc switch.data matches 0 run data modify storage switch:main traitors_game_maps append value "vilarles_castillo"
...
execute if score #mc switch.data matches 0 run data modify storage switch:main traitors_game_maps append value "highland_mansion"
