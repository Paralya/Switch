...
data modify storage switch:main minigames append value {min_players:6	,max_players:-1		,id:"infected"				,Name:"Infected"			,Lore:'["",{"text":"[Infected]\\n","color":"yellow"},				{"text":"Inspiré de celui d\'ImagineYourCraft, un infecté est choisi en début de partie\\n"},{"text":"et doit infecter tous les humains qui doivent se défendre des infectés !\\n"},	{"text":"\\n[Estimation : 1-8 mins]","color":"gold"},	{"text":"\\n[Proposé par la Terre entière / Développé par Stoupy51]","color":"aqua"}]'}
