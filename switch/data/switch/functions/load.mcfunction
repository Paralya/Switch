...
data modify storage switch:main minigames append value {min_players:10	,max_players:-1		,id:"beat_the_kings"		,Name:"Beat The Kings"		,Lore:'["",{"text":"[Beat The Kings]\\n","color":"yellow"},			{"text":"Faites tout pour abattre les horribles rois\\n"},																																{"text":"\\n[Estimation : 3-5 mins]","color":"gold"},	{"text":"\\n[Proposé/Développé par Luxio]","color":"aqua"}]'}
...
data modify storage switch:main minigames append value {min_players:4	,max_players:-1		,id:"murder_mystery"		,Name:"Murder Mystery"		,Lore:'["",{"text":"[Murder Mystery]\\n","color":"yellow"},			{"text":"Un meutrier, un détective, et une bande de floppeurs\\n"},{"text":"se trouvent dans une map mystérieuse !\\n"},																{"text":"\\n[Estimation : 1-5 mins]","color":"gold"},	{"text":"\\n[Proposé par GoldVision / Développé par Stoupy51]","color":"aqua"}]'}
