...
data modify storage switch:main minigames append value {index:8	,min_players:1	,max_players:-1		,id:"boat_race"				,Name:"Boat Race PAS DISPO"			,Lore:'[{"text":"Lore du Slot 9"}]'}
