...
data modify storage switch:main minigames append value {index:17,min_players:1	,max_players:-1		,id:"castagne"				,Name:"Castagne"			,Lore:'["",{"text":"[Castagne]\\n","color":"yellow"},{"text":"Vous êtes là pour castagner les gens et rester\\n"},{"text":"le dernier en vie afin de gagner la partie"},{"text":"\\n\\n[Estimation : 2-4 mins]","color":"gold"},{"text":"\\n[Proposé par JustNoob / Développé par Stoupy51]","color":"aqua"}]'}
data modify storage switch:main minigames append value {index:18,min_players:1	,max_players:-1		,id:"layers_2_teams"		,Name:"Layers 2 Teams"		,Lore:'["",{"text":"[Layers 2 Teams]\\n","color":"yellow"},{"text":"Soyez le plus rapide à vous équiper afin de\\n"},{"text":"transpercer le mur d\'obsidienne pour exterminer l\'ennemi !"},{"text":"\\n\\n[Estimation : 5-15 mins]","color":"gold"},{"text":"\\n[Proposé/Développé par Stoupy51]","color":"aqua"}]'}
data modify storage switch:main minigames append value {index:19,min_players:1	,max_players:-1		,id:"layers_4_teams"		,Name:"Layers 4 Teams"		,Lore:'["",{"text":"[Layers 4 Teams]\\n","color":"yellow"},{"text":"Affrontez 3 autres équipes à une course\\n"},{"text":"d\'équipements anéantir vos ennemis !"},{"text":"\\n\\n[Estimation : 5-15 mins]","color":"gold"},{"text":"\\n[Proposé/Développé par Stoupy51]","color":"aqua"}]'}
data modify storage switch:main minigames append value {index:20,min_players:1	,max_players:-1		,id:"thunder_spear"			,Name:"Thunder Spear"		,Lore:'["",{"text":"[Thunder Spear]\\n","color":"yellow"},{"text":"Éliminez le maximum de joueurs à l\'aide de votre équipement\\n"},{"text":"tridimensionnel et vos lances foudroyantes !"},{"text":"\\n\\n[Estimation : 4m00s]","color":"gold"},{"text":"\\n[Proposé/Développé par Stoupy51]","color":"aqua"}]'}
data modify storage switch:main minigames append value {index:21,min_players:1	,max_players:-1		,id:"tnt_run"				,Name:"TNT Run"				,Lore:'["",{"text":"[TNT Run]\\n","color":"yellow"},{"text":"Soyez le dernier en vie en restant le plus\\n"},{"text":"longtemps en mouvement pour ne pas tomber"},{"text":"\\n\\n[Estimation : 1-4 mins]","color":"gold"},{"text":"\\n[Proposé/Développé par Stoupy51]","color":"aqua"}]'}

data modify storage switch:main minigames append value {index:22,min_players:1	,max_players:-1		,id:"replicate_the_build"			,Name:"Replicate the build !"			,Lore:'["",{"text":"[Replicate the build]\\n","color":"yellow"},{"text":"Refaites le build donné le plus rapidement possible ! et sans vous tromper"},{"text":"\\n\\n[Estimation : 5-6 mins]","color":"gold"},{"text":"\\n[Proposé/Développé par AirDox_]","color":"aqua"}]'}
#data modify storage switch:main minigames append value {index:21,min_players:1	,max_players:-1		,id:"murder_uhc"			,Name:"Murder UHC"			,Lore:'["",{"text":"[Murder UHC]\\n","color":"yellow"},{"text":"---LORE 1---\\n"},{"text":"---LORE 2---"},{"text":"\\n\\n[Estimation : 4-10 mins]","color":"gold"},{"text":"\\n[Proposé/Développé par XXXXXX]","color":"aqua"}]'}

# data modify storage switch:main minigames append value {index:22,min_players:1	,max_players:-1		,id:"a_template"			,Name:"TEMPLATE"			,Lore:'["",{"text":"[TEMPLATE]\\n","color":"yellow"},{"text":"TEMPLATE\\n"},{"text":"TEMPLATE"},{"text":"\\n\\n[Estimation : 1-2 mins]","color":"gold"},{"text":"\\n[Proposé/Développé par XXXXXX]","color":"aqua"}]'}
