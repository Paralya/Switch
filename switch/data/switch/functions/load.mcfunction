...
# data modify storage switch:main minigames append value {min_players:1	,max_players:-1		,id:"murder_uhc"			,Name:"Murder UHC"			,Lore:'["",{"text":"[Murder UHC]\\n","color":"yellow"},{"text":"---LORE 1---\\n"},{"text":"---LORE 2---\\n"},{"text":"\\n[Estimation : 4-10 mins]","color":"gold"},{"text":"\\n[Proposé/Développé par XXXXXX]","color":"aqua"}]'}
# data modify storage switch:main minigames append value {min_players:1	,max_players:-1		,id:"a_template"			,Name:"TEMPLATE"			,Lore:'["",{"text":"[TEMPLATE]\\n","color":"yellow"},{"text":"TEMPLATE\\n"},{"text":"TEMPLATE\\n"},{"text":"\\n[Estimation : 1-2 mins]","color":"gold"},{"text":"\\n[Proposé/Développé par XXXXXX]","color":"aqua"}]'}
