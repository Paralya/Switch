...
data modify storage switch:main minigames append value {min_players:1	,max_players:-1		,id:"rush_the_point"		,Name:"Rush The Point"		,Lore:'["",{"text":"[Rush The Point]\\n","color":"yellow"},			{"text":"Deux équipes doivent s\'affronter pour capturer\\n"},{"text":"plusieurs points au centre du vide grâce à des\\n"},{"text":"classes spécifiques différentes\\n"},				{"text":"\\n[Estimation : 7-10 mins]","color":"gold"},	{"text":"\\n[Inspiration : PluginLess]","color":"green"},					{"text":"\\n[Proposé/Développé par Stoupy51]","color":"aqua"}]'}
data modify storage switch:main minigames append value {min_players:1	,max_players:-1		,id:"rush_the_flag"			,Name:"Rush The Flag"		,Lore:'["",{"text":"[Rush The Flag]\\n","color":"yellow"},			{"text":"Deux équipes doivent s\'affronter pour capturer\\n"},{"text":"le drapeau ennemi grâce à des classes spécifiques\\n"},{"text":"sur une map vide\\n"},							{"text":"\\n[Estimation : 5-10 mins]","color":"gold"},	{"text":"\\n[Inspiration : PluginLess]","color":"green"},					{"text":"\\n[Proposé/Développé par Stoupy51]","color":"aqua"}]'}
...
data modify storage switch:main minigames append value {min_players:1	,max_players:-1		,id:"protect_the_king"		,Name:"Protect The King"	,Lore:'["",{"text":"[Protect The King]\\n","color":"yellow"},		{"text":"Deux équipes doivent s\'affronter pour tuer le roi\\n"},{"text":"ennemi afin de gagner la partie !\\n"},																		{"text":"\\n[Estimation : 1-4 mins]","color":"gold"},	{"text":"\\n[Inspiration : Charlemagne]","color":"green"},					{"text":"\\n[Proposé/Développé par Stoupy51]","color":"aqua"}]'}
...
data modify storage switch:main minigames append value {min_players:8	,max_players:-1		,id:"infected"				,Name:"Infected"			,Lore:'["",{"text":"[Infected]\\n","color":"yellow"},				{"text":"Un infecté est choisi en début de partie et doit infecter\\n"},{"text":"tous les humains qui doivent attendre les renforts !\\n"},												{"text":"\\n[Estimation : 1-10 mins]","color":"gold"},	{"text":"\\n[Repris de : ImagineYourCraft (2013)]","color":"green"},		{"text":"\\n[Proposé par la Terre entière / Développé par Stoupy51]","color":"aqua"}]'}
data modify storage switch:main minigames append value {min_players:1	,max_players:-1		,id:"glassrunner"			,Name:"GlassRunner"			,Lore:'["",{"text":"[GlassRunner]\\n","color":"yellow"},			{"text":"Affrontez l\'équipe adverse dans le ciel dans un CaptureThePoint\\n"},{"text":"assaisonné de multiples particularités\\n"},													{"text":"\\n[Estimation : 8-10 mins]","color":"gold"},	{"text":"\\n[Inspiration : Épicube]","color":"green"},						{"text":"\\n[Proposé/Développé par AirDox]","color":"aqua"}]'}
data modify storage switch:main minigames append value {min_players:10	,max_players:-1		,id:"capture_the_flag"		,Name:"Capture The Flag"	,Lore:'["",{"text":"[Capture The Flag]\\n","color":"yellow"},		{"text":"Deux équipes doivent s\'affronter pour capturer\\n"},{"text":"le drapeau ennemi grâce à des\\n"},{"text":"classes spécifiques différentes\\n"},								{"text":"\\n[Estimation : 10-15 mins]","color":"gold"},	{"text":"\\n[Inspiration : Aspiration]","color":"green"},					{"text":"\\n[Proposé par Oraclette / Développé par Stoupy51]","color":"aqua"}]'}
data modify storage switch:main minigames append value {min_players:1	,max_players:-1		,id:"memory_mine"			,Name:"Memory Mine"			,Lore:'["",{"text":"[Memory Mine]\\n","color":"yellow"},			{"text":"Posez des mines qui disparaissent et clignotent aléatoirement pour indiquer leur position\\n"},{"text":"Soyez le dernier survivant en mémorisant leur position\\n"},			{"text":"\\n[Estimation : 1-2 mins]","color":"gold"},	{"text":"\\n[Repris de : Pico Party]","color":"green"},						{"text":"\\n[Proposé/Développé par Stoupy51]","color":"aqua"}]'}
data modify storage switch:main minigames append value {min_players:1	,max_players:-1		,id:"fish_fight"			,Name:"Fish Fight"			,Lore:'["",{"text":"[Fish Fight]\\n","color":"yellow"},				{"text":"Éjectez vos adversaires grâce à votre poisson\\n"},{"text":"et votre habilité afin de remporter la victoire !\\n"},															{"text":"\\n[Estimation : 2-4 mins]","color":"gold"},	{"text":"\\n[Inspiration : Findus]","color":"green"},						{"text":"\\n[Proposé/Développé par Luxio]","color":"aqua"}]'}
data modify storage switch:main minigames append value {min_players:1	,max_players:-1		,id:"one_shot"			    ,Name:"One Shot"			,Lore:'["",{"text":"[One Shot]\\n","color":"yellow"},				{"text":"Éliminez vos adversaires grâce à votre arc\\n"},{"text":"et votre habilité afin de remporter la victoire !\\n"},															{"text":"\\n[Estimation : 2-4 mins]","color":"gold"},	{"text":"\\n[Inspiration : OneShot]","color":"green"},						{"text":"\\n[Proposé/Développé par Luxio]","color":"aqua"}]'}
