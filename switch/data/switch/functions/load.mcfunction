...
data modify storage switch:main minigames append value {index:23,min_players:2	,max_players:-1		,id:"replicate_the_build"	,Name:"Replicate The Build BUGUÉ"	,Lore:'["",{"text":"[Replicate The Build]\\n","color":"yellow"},{"text":"Refaites le build donné le plus rapidement possible, et sans vous tromper !"},{"text":"\\n\\n[Estimation : 1-6 mins]","color":"gold"},{"text":"\\n[Proposé/Développé par AirDox_]","color":"aqua"}]'}
data modify storage switch:main minigames append value {index:24,min_players:2	,max_players:-1		,id:"moutron"				,Name:"Moutron"				,Lore:'["",{"text":"[Moutron]\\n","color":"yellow"},{"text":"Avancez sans cesse à dos d\'un mouton spécial qui\\n"},{"text":"créer une trainée mortelle derrière lui !"},{"text":"\\n\\n[Estimation : 1-3 mins]","color":"gold"},{"text":"\\n[Proposé/Développé par Stoupy51]","color":"aqua"}]'}
data modify storage switch:main minigames append value {index:25,min_players:2	,max_players:45		,id:"snowball_painter"		,Name:"Snowball Painter"	,Lore:'["",{"text":"[Snowball Painter]\\n","color":"yellow"},{"text":"Peignez le maximum de bloc sur ce tableau blanc\\n"},{"text":"dans un temps imparti pour gagner !"},{"text":"\\n\\n[Estimation : 45s]","color":"gold"},{"text":"\\n[Proposé/Développé par Stoupy51]","color":"aqua"}]'}
data modify storage switch:main minigames append value {index:26,min_players:2	,max_players:-1		,id:"gay_shooter"			,Name:"Gay Shooter"			,Lore:'["",{"text":"[Gay Shooter]\\n","color":"yellow"},{"text":"Un tier des joueurs possède un arc et doit empêcher\\n"},{"text":"les autres joueurs de monter la tour arc-en-ciel !"},{"text":"\\n\\n[Estimation : 1-5 mins]","color":"gold"},{"text":"\\n[Proposé par GoldVision / Développé par Stoupy51]","color":"aqua"}]'}
data modify storage switch:main minigames append value {index:27,min_players:1	,max_players:-1		,id:"build_battle"			,Name:"Build Battle"		,Lore:'["",{"text":"[Build Battle]\\n","color":"yellow"},{"text":"Concurrencez les autres joueurs avec votre construction\\n"},{"text":"sur un thème choisi démocratiquement au début !"},{"text":"\\n\\n[Estimation : 5-7 mins]","color":"gold"},{"text":"\\n[Proposé/Développé par Stoupy51]","color":"aqua"}]'}
data modify storage switch:main minigames append value {index:27,min_players:1	,max_players:-1		,id:"beat_the_kings"		,Name:"Beat The Kings"		,Lore:'["",{"text":"[Beat The Kings]\\n","color":"yellow"},{"text":"Faites tout pour tuer\\n"},{"text":"les horribles roi"},{"text":"\\n\\n[Estimation : 3-5 mins]","color":"gold"},{"text":"\\n[Proposé/Développé par Luxio]","color":"aqua"}]'}
