...
data modify storage switch:main minigames append value {index:22,min_players:2	,max_players:-1		,id:"replicate_the_build"			,Name:"Replicate the build !"			,Lore:'["",{"text":"[Replicate the build]\\n","color":"yellow"},{"text":"Refaites le build donné le plus rapidement possible ! et sans vous tromper"},{"text":"\\n\\n[Estimation : 5-6 mins]","color":"gold"},{"text":"\\n[Proposé/Développé par AirDox_]","color":"aqua"}]'}
