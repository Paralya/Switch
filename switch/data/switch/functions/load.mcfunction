...
data modify storage switch:main minigames append value {index:8	,min_players:1	,max_players:-1		,id:"spectres_game"			,Name:"Spectres Game"		,Lore:'["",{"text":"[Spectres Game]\\n","color":"yellow"},{"text":"Visibles contre Spectres,\\n"},{"text":"quel camp va-t-il gagner ?"},{"text":"\\n\\n[Estimation : 4-10 mins]","color":"gold"},{"text":"\\n[Proposé par Luxio / Développé par Stoupy51]","color":"aqua"}]'}
...
data modify storage switch:main minigames append value {index:14,min_players:1	,max_players:-1		,id:"mlg_a_coudre"			,Name:"MLG à Coudre"		,Lore:'["",{"text":"[MLG à Coudre]\\n","color":"yellow"},{"text":"Affrontez les autres joueurs dans un saut,\\n"},{"text":"iconique de Minecraft mais pas comme les autres !"},{"text":"\\n\\n[Estimation : 1-6 mins]","color":"gold"},{"text":"\\n[Proposé/Développé par Stoupy51]","color":"aqua"}]'}
data modify storage switch:main minigames append value {index:15,min_players:1	,max_players:-1		,id:"protect_the_king"		,Name:"Protect The King"	,Lore:'["",{"text":"[Protect The King]\\n","color":"yellow"},{"text":"Deux teams doivent s\'affronter pour tuer le roi\\n"},{"text":"ennemi afin de gagner la partie"},{"text":"\\n\\n[Estimation : 2-4 mins]","color":"gold"},{"text":"\\n[Proposé/Développé par Stoupy51]","color":"aqua"}]'}
data modify storage switch:main minigames append value {index:16,min_players:1	,max_players:-1		,id:"castagne"				,Name:"Castagne"			,Lore:'["",{"text":"[Castagne]\\n","color":"yellow"},{"text":"Vous êtes là pour castagner les gens et rester\\n"},{"text":"le dernier en vie afin de gagner la partie"},{"text":"\\n\\n[Estimation : 2-4 mins]","color":"gold"},{"text":"\\n[Proposé par JustNoob / Développé par Stoupy51]","color":"aqua"}]'}
data modify storage switch:main minigames append value {index:17,min_players:1	,max_players:-1		,id:"layers_2_teams"		,Name:"Layers 2 Teams"		,Lore:'["",{"text":"[Layers 2 Teams]\\n","color":"yellow"},{"text":"Soyez le plus rapide à vous équiper afin de\\n"},{"text":"transpercer le mur d\'obsidienne pour exterminer l\'ennemi !"},{"text":"\\n\\n[Estimation : 7-15 mins]","color":"gold"},{"text":"\\n[Proposé/Développé par Stoupy51]","color":"aqua"}]'}
data modify storage switch:main minigames append value {index:18,min_players:1	,max_players:-1		,id:"layers_4_teams"		,Name:"Layers 4 Teams"		,Lore:'["",{"text":"[Layers 4 Teams]\\n","color":"yellow"},{"text":"Affrontez 3 autres équipes à une course\\n"},{"text":"d\'équipements anéantir vos ennemis !"},{"text":"\\n\\n[Estimation : 7-15 mins]","color":"gold"},{"text":"\\n[Proposé/Développé par Stoupy51]","color":"aqua"}]'}
data modify storage switch:main minigames append value {index:29,min_players:1	,max_players:-1		,id:"thunder_spear"			,Name:"Thunder Spear"		,Lore:'["",{"text":"[Thunder Spear]\\n","color":"yellow"},{"text":"Éliminez le maximum de joueurs à l\'aide de votre équipement\\n"},{"text":"tridimensionnel et vos lances foudroyantes !"},{"text":"\\n\\n[Estimation : 4m00s]","color":"gold"},{"text":"\\n[Proposé/Développé par Stoupy51]","color":"aqua"}]'}
data modify storage switch:main minigames append value {index:20,min_players:1	,max_players:-1		,id:"tnt_run"				,Name:"TNT Run"				,Lore:'["",{"text":"[TNT Run]\\n","color":"yellow"},{"text":"Soyez le dernier en vie en restant le plus\\n"},{"text":"longtemps en mouvement pour ne pas tomber"},{"text":"\\n\\n[Estimation : 1-4 mins]","color":"gold"},{"text":"\\n[Proposé/Développé par Stoupy51]","color":"aqua"}]'}
data modify storage switch:main minigames append value {index:21,min_players:1	,max_players:-1		,id:"sheepwars"				,Name:"SheepWars"			,Lore:'["",{"text":"[SheepWars]\\n","color":"yellow"},{"text":"Envoyez sur l\'équipe ennemie vos moutons les plus puissants\\n"},{"text":"afin de les exterminer jusqu\'au dernier pour gagner !"},{"text":"\\n\\n[Estimation : 2-6 mins]","color":"gold"},{"text":"\\n[Proposé/Développé par Stoupy51]","color":"aqua"}]'}

data modify storage switch:main minigames append value {index:22,min_players:1	,max_players:-1		,id:"block_party"			,Name:"Block Party PAS DISPO"			,Lore:'["",{"text":"[Block Party]\\n","color":"yellow"},{"text":"Dès que la musique s\'arrête, dirigez-vous\\n"},{"text":"sur la couleur indiquée pour ne pas tomber !"},{"text":"\\n\\n[Estimation : 1-4 mins]","color":"gold"},{"text":"\\n[Proposé/Développé par Stoupy51]","color":"aqua"}]'}
data modify storage switch:main minigames append value {index:23,min_players:1	,max_players:-1		,id:"replicate_the_build"	,Name:"Replicate The Build PAS DISPO"	,Lore:'["",{"text":"[Replicate The Build]\\n","color":"yellow"},{"text":"Refaites le build donné le plus rapidement possible, et sans vous tromper !"},{"text":"\\n\\n[Estimation : 1-6 mins]","color":"gold"},{"text":"\\n[Proposé/Développé par AirDox_]","color":"aqua"}]'}
