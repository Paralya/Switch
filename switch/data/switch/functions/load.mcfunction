...
data modify storage switch:main minigames append value {index:1,min_players:2,id:"laser_game",Name:"Laser Game",Lore:'["",{"text":"[Laser Game]\\n","color":"yellow"},{"text":"Affrontez l\'équipe adverse grâce à vos fusils-laser\\n"},{"text":"et faites le plus d\'élimination possible !"}]'}
...
data modify storage switch:main minigames append value {index:6,min_players:1,id:"none_7",Name:"None 7",Lore:'[{"text":"Lore du None 7"}]'}
data modify storage switch:main minigames append value {index:7,min_players:1,id:"none_8",Name:"None 8",Lore:'[{"text":"Lore du None 8"}]'}
data modify storage switch:main minigames append value {index:8,min_players:1,id:"none_9",Name:"None 9",Lore:'[{"text":"Lore du None 9"}]'}
