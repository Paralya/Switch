...
execute if score #custom switch.data matches 0 store result score #custom switch.data if data entity @s Item.tag.simplenergy.raw_simplunium run loot insert 0 0 0 loot simplenergy:i/simplunium_ingot
execute if score #custom switch.data matches 0 store result score #custom switch.data if data entity @s Item.tag.crazy_adventure.raw_uranium run loot insert 0 0 0 loot crazy_adventure:i/uranium_ingot
execute if score #custom switch.data matches 0 store result score #custom switch.data if data entity @s Item.tag.crazy_adventure.raw_californium run loot insert 0 0 0 loot crazy_adventure:i/californium_ingot
