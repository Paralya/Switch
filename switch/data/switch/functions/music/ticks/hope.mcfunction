...
data modify storage switch:temp input set value {tick:0,name:"hope"}
...
execute if score #temp switch.data >= #hope switch.music.progress run function switch:music/music_over
