...
data modify storage switch:temp input set value {tick:0,name:"never_gonna_give_you_up"}
...
execute if score #temp switch.data >= #never_gonna_give_you_up switch.music.progress run scoreboard players set @s switch.music.current -1
execute if score #temp switch.data >= #never_gonna_give_you_up switch.music.progress run scoreboard players set @s switch.music.progress 0
