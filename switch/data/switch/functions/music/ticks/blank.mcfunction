...
data modify storage switch:temp input set value {tick:0,name:"blank"}
...
execute if score #temp switch.data >= #blank switch.music.progress run function switch:music/music_over
