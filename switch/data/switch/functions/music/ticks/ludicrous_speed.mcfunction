...
execute if score #temp switch.data >= #ludicrous_speed switch.music.progress run scoreboard players set @s switch.music.current -1
execute if score #temp switch.data >= #ludicrous_speed switch.music.progress run scoreboard players set @s switch.music.progress 0
