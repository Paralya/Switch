...
# English
execute if entity @s[tag=switch.blue_flag] run tellraw @a[scores={switch.lang=1},tag=!detached] ["",{"text":"[RushTheFlag] ","color":"yellow"},{"selector":"@p[tag=switch.has_blue_flag]"},{"text":"just secured the flag","color":"aqua"},{"text":"blue","color":"blue"}]
execute if entity @s[tag=switch.red_flag] run tellraw @a[scores={switch.lang=1},tag=!detached] ["",{"text":"[RushTheFlag] ","color":"yellow"},{"selector":"@p[tag=switch.has_red_flag]"},{"text":"just secured the flag","color":"aqua"},{"text":"red","color":"red"}]
