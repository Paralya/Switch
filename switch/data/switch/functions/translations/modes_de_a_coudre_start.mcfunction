...
# English
tellraw @a[scores={switch.lang=1},tag=!detached] ["\n",{"nbt": "Paralya", "storage": "switch:main", "interpret":true},{"text": "Sewing Thimble game launched, score as many points as possible by jumping into water dots surrounded by blocks!"}]
