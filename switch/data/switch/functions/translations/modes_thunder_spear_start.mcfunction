...
# English
tellraw @a[scores={switch.lang=1},tag=!detached] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Thunder Spear game starts in 10 seconds, you have to kill as many players as possible with your lightning spears, you can dodge other players' attacks using your three-dimensional equipment in your second hand!"}]
