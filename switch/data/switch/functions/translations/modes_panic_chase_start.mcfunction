...
# English
tellraw @a[scores={switch.lang=1},tag=!detached] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":"Panic Chase game launched, hunters free in 30 seconds! The mouse must escape from the hunters until the time runs out, while the hunters must chase them away!"}]
tellraw @a[scores={switch.lang=1},tag=!detached] [{"text":"Attention, the mouse can't hit the hunters!","color":"yellow"}]
