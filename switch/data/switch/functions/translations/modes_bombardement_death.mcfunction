...
# English
execute if entity @s[gamemode=!spectator] run tellraw @a[scores={switch.lang=1},tag=!detached] [{"selector":"@s", "color": "red"},{"text":" died, survived"},{"score":{"name": "#bombing_seconds", "objective": "switch.data"}},{"text":" seconds!"}]
