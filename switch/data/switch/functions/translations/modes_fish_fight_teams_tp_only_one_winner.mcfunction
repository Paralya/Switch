...
# English
tellraw @a[scores={switch.lang=1},tag=!detached] ["",{"text":"----------------------------------","color":"#CCDBF9"},{"text":"\n"},{"text":"Only One Winner","bold":true,"color":"#9FD5EE"},{"text":" \u2022 ","bold":true,"color":"gray"},{"text":"Only ","color":"white"},{"text":"one","bold":true,"underlined":true,"color":"white"},{"text":" team alive, you've got a win! But now you have to fight to be the last one ","color":"white"},{"text":"Winner","italic":true,"color":"red"},{"text":"...","color":"white"},{"text":"\n"},{"text":"----------------------------------","color":"#CCDBF9"}]
