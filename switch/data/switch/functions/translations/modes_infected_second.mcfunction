...
execute if score #infected_seconds switch.data matches 0 run tellraw @a[scores={switch.lang=1},tag=!detached] [{"text":"The game is starting!","color":"yellow"}]
...
execute if score #infected_seconds switch.data matches 7 run tellraw @a[scores={switch.lang=1},tag=!detached] [{"text":"Select infected in 3 seconds","color":"dark_purple"}]
...
execute if score #infected_seconds switch.data matches 10 run tellraw @a[scores={switch.lang=1},tag=!detached] [{"selector":"@p[scores={switch.temp.infection=1}]","color":"green"},{"text":"has been chosen as the first infected!","color":"dark_purple"},{"text":"},{"text":"Humans, reinforcements arrive in less than 10 minutes!","color":"light_purple"}]
