...
# English
execute if score #color switch.data matches 0 run tellraw @a[scores={switch.lang=1,switch.alive=11}] [{"selector":"@s"},{"text": "fired on bonus base!", "color": "green"}]
execute if score #color switch.data matches 1 run tellraw @a[scores={switch.lang=1,switch.alive=10}] [{"selector":"@s"},{"text": "a tiré sur la base de bonus!", "color": "green"}]
execute if score #random switch.data matches 0 run tellraw @a[scores={switch.lang=1},tag=!detached,tag=switch.message] [{"selector":"@s"},{"text": "shot on bonus base and gets 5-shot resistant Shield [+20 points]", "color": "green"}]
execute if score #random switch.data matches 1 run tellraw @a[scores={switch.lang=1},tag=!detached,tag=switch.message] [{"selector":"@s"},{"text":" fired on bonus base and got a Machine Gun for 15 seconds [+20 points]", "color": "green"}]
execute if score #random switch.data matches 2 run tellraw @a[scores={switch.lang=1},tag=!detached,tag=switch.message] [{"selector":"@s"},{"text":" fired on bonus base and gave a Darkness Effect to the enemy team [+20 points]", "color": "green"}]
execute if score #random switch.data matches 3 run tellraw @a[scores={switch.lang=1},tag=!detached,tag=switch.message] [{"selector":"@s"},{"text":" fired on bonus base and gave a Glowing Effect to the enemy team [+20 points]", "color": "green"}]
...
execute if score #random switch.data matches 5 run tellraw @a[scores={switch.lang=1},tag=!detached,tag=switch.message] [{"selector":"@s"},{"text":" shot on bonus base and gives Speed Effect to your team for 15 seconds [+20 points]", "color": "green"}]
