...
# English
tellraw @a[scores={switch.lang=1},tag=!detached] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":"Glass Runner game starts in 5 seconds, your objective is to capture the various points on the map to score points! Your inventory serves as a store using your xp levels!"}]
