...
# English
tellraw @a[scores={switch.lang=1},tag=!detached] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Coin Chaser game starts in 10 seconds, collect the most gold in the allotted time with your wings and three-dimensional equipment!"}]
