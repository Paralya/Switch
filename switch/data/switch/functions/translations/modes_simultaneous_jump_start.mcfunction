...
# English
tellraw @a[scores={switch.lang=1},tag=!detached] ["\n",{"nbt": "Paralya", "storage": "switch:main", "interpret":true},{"text": "Simultaneous Jump game starts in 5 seconds! Like Sewing Thimble, you have to score the most points by jumping into water spots surrounded by blocks, but all at the same time as everyone else and with PvP enabled!"}]
