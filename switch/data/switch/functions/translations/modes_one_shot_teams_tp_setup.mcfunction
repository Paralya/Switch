...
# English
tellraw @a[scores={switch.lang=1},tag=!detached] ["",{"text":"Fish Fight","bold":true,"color":"#8DF0CE"},{"text":" \u2022","bold":true,"color":"gray"},{"text":"(1 of 2 games)","bold":true, "italic":true,"color":"gray"},{"text":"The game will be played in 2 teams!","bold":true},{"text":"\n"}]
