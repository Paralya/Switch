...
# English
tellraw @a[scores={switch.lang=1},tag=!detached] ["\n",{"nbt": "Paralya", "storage": "switch:main", "interpret":true},{"text": "Starting the Pitchout game, your goal is to expel the other players with your equipment and be the last one alive at the end!"}]
