...
execute as @a[scores={switch.trigger.game_vote=1..}] at @s run playsound ui.button.click ambient @s
...
execute store result score #vote_game_6 switch.data if entity @a[scores={switch.trigger.game_vote=-6}]
