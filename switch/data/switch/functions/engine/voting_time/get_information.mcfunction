...
function switch:engine/voting_time/get_index_information

scoreboard players add #index switch.data 1
execute if score #index switch.data matches ..5 run function switch:engine/voting_time/get_information
