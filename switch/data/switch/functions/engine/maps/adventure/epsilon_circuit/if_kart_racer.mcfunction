...
summon marker 17912 101 17999 {Tags:["switch.checkpoint","switch.can_hard_reset"],data:{cp:1, dx:4, dy:5, dz:1}}
summon marker 18036 92 17985 {Tags:["switch.checkpoint","switch.can_hard_reset"],data:{cp:2, dx:4, dy:5, dz:1}}
summon marker 17975 108 18042 {Tags:["switch.checkpoint","switch.can_hard_reset"],data:{cp:3, dx:4, dy:5, dz:1}}
