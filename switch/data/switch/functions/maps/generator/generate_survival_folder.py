...
with open("add_door_to_storage.mcfunction", "w") as f:
	f.write("""
...
with open("scan_doors_of_every_maps.mcfunction", "w") as f:
	f.write("""
## This file is generated by the 'generate_survival_folder.py' script
## Do not edit this file but the script instead
...
with open("loop_scan_doors_of_every_maps.mcfunction", "w") as f:
	f.write(f"""
## This file is generated by the 'generate_survival_folder.py' script
## Do not edit this file but the script instead
...
# Create the file and write the first lines
with open("resume_regeneration.mcfunction", "w") as resume_regeneration_file:
