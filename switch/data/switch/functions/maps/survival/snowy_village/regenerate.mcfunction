...
execute if score #rg_snowy_village switch.data matches 1137.. run data modify storage switch:main MessageToLog set value '{"text": "La map `snowy_village` a fini sa regeneration !"}'
