...
execute if score #rg_new_grounds switch.data matches 681.. run data modify storage switch:main MessageToLog set value '{"text": "La map `new_grounds` a fini sa regeneration !"}'
