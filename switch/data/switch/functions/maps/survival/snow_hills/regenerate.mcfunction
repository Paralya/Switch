...
execute if score #rg_snow_hills switch.data matches 916.. run kill @e[type=item,x=50025,y=0,z=50010,distance=..1000]
execute if score #rg_snow_hills switch.data matches 916.. run forceload remove 49906 49918 49922 50103
execute if score #rg_snow_hills switch.data matches 916.. run forceload remove 49922 49918 49938 50103
execute if score #rg_snow_hills switch.data matches 916.. run forceload remove 49938 49918 49954 50103
execute if score #rg_snow_hills switch.data matches 916.. run forceload remove 49954 49918 49970 50103
execute if score #rg_snow_hills switch.data matches 916.. run forceload remove 49970 49918 49986 50103
execute if score #rg_snow_hills switch.data matches 916.. run forceload remove 49986 49918 50002 50103
execute if score #rg_snow_hills switch.data matches 916.. run forceload remove 50002 49918 50018 50103
execute if score #rg_snow_hills switch.data matches 916.. run forceload remove 50018 49918 50033 50103
execute if score #rg_snow_hills switch.data matches 916.. run forceload remove 50033 49918 50049 50103
execute if score #rg_snow_hills switch.data matches 916.. run forceload remove 50049 49918 50065 50103
execute if score #rg_snow_hills switch.data matches 916.. run forceload remove 50065 49918 50081 50103
execute if score #rg_snow_hills switch.data matches 916.. run forceload remove 50081 49918 50097 50103
execute if score #rg_snow_hills switch.data matches 916.. run forceload remove 50097 49918 50113 50103
...
execute if score #rg_snow_hills switch.data matches 916.. run data modify storage switch:main MessageToLog set value '{"text": "La map `snow_hills` a fini sa regeneration !"}'
