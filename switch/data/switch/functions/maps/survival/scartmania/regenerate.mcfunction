...
execute if score #rg_scartmania switch.data matches 1013.. run kill @e[type=item,x=58080,y=0,z=58094,distance=..1000]
execute if score #rg_scartmania switch.data matches 1013.. run forceload remove 58000 58000 58015 58188
execute if score #rg_scartmania switch.data matches 1013.. run forceload remove 58015 58000 58029 58188
execute if score #rg_scartmania switch.data matches 1013.. run forceload remove 58029 58000 58044 58188
execute if score #rg_scartmania switch.data matches 1013.. run forceload remove 58044 58000 58058 58188
execute if score #rg_scartmania switch.data matches 1013.. run forceload remove 58058 58000 58073 58188
execute if score #rg_scartmania switch.data matches 1013.. run forceload remove 58073 58000 58087 58188
execute if score #rg_scartmania switch.data matches 1013.. run forceload remove 58087 58000 58102 58188
execute if score #rg_scartmania switch.data matches 1013.. run forceload remove 58102 58000 58116 58188
execute if score #rg_scartmania switch.data matches 1013.. run forceload remove 58116 58000 58131 58188
execute if score #rg_scartmania switch.data matches 1013.. run forceload remove 58131 58000 58145 58188
execute if score #rg_scartmania switch.data matches 1013.. run forceload remove 58145 58000 58160 58188
execute if score #rg_scartmania switch.data matches 1013.. run tellraw @a ["",{"nbt":"ParalyaWarning","storage":"switch:main","interpret":true},{"text":" La map '","color":"yellow"},{"text":"scartmania","color":"gold"},{"text":"' vient de finir de se régénérer en ","color":"yellow"},{"text":"0","color":"gold"},{"text":"m","color":"yellow"},{"text":"50","color":"gold"},{"text":"s","color":"yellow"}]
execute if score #rg_scartmania switch.data matches 1013.. run data modify storage switch:main MessageToLog set value '{"text": "La map `scartmania` a fini sa régénération !"}'
