...
execute if score #rg_spruce_dojo switch.data matches 109.. run kill @e[type=item,x=84041,y=0,z=84034,distance=..1000]
execute if score #rg_spruce_dojo switch.data matches 109.. run forceload remove 84000 84000 84028 84069
