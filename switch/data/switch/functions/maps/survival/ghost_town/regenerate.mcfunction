...
execute if score #rg_ghost_town switch.data matches 235.. run data modify storage switch:main MessageToLog set value '{"text": "La map `ghost_town` a fini sa regeneration !"}'
