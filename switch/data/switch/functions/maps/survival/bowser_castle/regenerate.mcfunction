...
execute if score #rg_bowser_castle switch.data matches 1559.. run kill @e[type=item,x=22001,y=0,z=22010,distance=..1000]
execute if score #rg_bowser_castle switch.data matches 1559.. run forceload remove 21888 21888 21900 22133
execute if score #rg_bowser_castle switch.data matches 1559.. run forceload remove 21900 21888 21912 22133
execute if score #rg_bowser_castle switch.data matches 1559.. run forceload remove 21912 21888 21924 22133
execute if score #rg_bowser_castle switch.data matches 1559.. run forceload remove 21924 21888 21936 22133
execute if score #rg_bowser_castle switch.data matches 1559.. run forceload remove 21936 21888 21947 22133
execute if score #rg_bowser_castle switch.data matches 1559.. run forceload remove 21947 21888 21959 22133
execute if score #rg_bowser_castle switch.data matches 1559.. run forceload remove 21959 21888 21971 22133
execute if score #rg_bowser_castle switch.data matches 1559.. run forceload remove 21971 21888 21983 22133
execute if score #rg_bowser_castle switch.data matches 1559.. run forceload remove 21983 21888 21995 22133
execute if score #rg_bowser_castle switch.data matches 1559.. run forceload remove 21995 21888 22007 22133
execute if score #rg_bowser_castle switch.data matches 1559.. run forceload remove 22007 21888 22019 22133
execute if score #rg_bowser_castle switch.data matches 1559.. run forceload remove 22019 21888 22031 22133
execute if score #rg_bowser_castle switch.data matches 1559.. run forceload remove 22031 21888 22043 22133
execute if score #rg_bowser_castle switch.data matches 1559.. run forceload remove 22043 21888 22055 22133
execute if score #rg_bowser_castle switch.data matches 1559.. run forceload remove 22055 21888 22066 22133
execute if score #rg_bowser_castle switch.data matches 1559.. run forceload remove 22066 21888 22078 22133
execute if score #rg_bowser_castle switch.data matches 1559.. run forceload remove 22078 21888 22090 22133
