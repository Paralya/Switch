...
execute if score #rg_orange_rings switch.data matches 476.. run kill @e[type=item,x=65049,y=0,z=65051,distance=..1000]
execute if score #rg_orange_rings switch.data matches 476.. run forceload remove 65000 65000 65020 65103
execute if score #rg_orange_rings switch.data matches 476.. run forceload remove 65020 65000 65040 65103
execute if score #rg_orange_rings switch.data matches 476.. run forceload remove 65040 65000 65059 65103
...
execute if score #rg_orange_rings switch.data matches 476.. run data modify storage switch:main MessageToLog set value '{"text": "La map `orange_rings` a fini sa regeneration !"}'
