...
execute if score #rg_friends_pvpbox_end switch.data matches 137.. run data modify storage switch:main MessageToLog set value '{"text": "La map `friends_pvpbox_end` a fini sa régénération !"}'
