...
execute if score #rg_sakura_house switch.data matches 666.. run kill @e[type=item,x=86060,y=0,z=86067,distance=..1000]
execute if score #rg_sakura_house switch.data matches 666.. run forceload remove 86000 86000 86017 86135
execute if score #rg_sakura_house switch.data matches 666.. run forceload remove 86017 86000 86035 86135
execute if score #rg_sakura_house switch.data matches 666.. run forceload remove 86035 86000 86052 86135
execute if score #rg_sakura_house switch.data matches 666.. run forceload remove 86052 86000 86069 86135
execute if score #rg_sakura_house switch.data matches 666.. run forceload remove 86069 86000 86086 86135
...
execute if score #rg_sakura_house switch.data matches 666.. run data modify storage switch:main MessageToLog set value '{"text": "La map `sakura_house` a fini sa regeneration !"}'
