...
execute if score #rg_snk_tower switch.data matches 268.. run kill @e[type=item,x=61042,y=0,z=61024,distance=..1000]
execute if score #rg_snk_tower switch.data matches 268.. run forceload remove 61000 61000 61028 61049
