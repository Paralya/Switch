...
execute if score #rg_zonweeb_highschool switch.data matches 581.. run data modify storage switch:main MessageToLog set value '{"text": "La map `zonweeb_highschool` a fini sa régénération !"}'
