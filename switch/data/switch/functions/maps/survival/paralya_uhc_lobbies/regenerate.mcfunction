...
execute if score #rg_paralya_uhc_lobbies switch.data matches 377.. run data modify storage switch:main MessageToLog set value '{"text": "La map `paralya_uhc_lobbies` a fini sa regeneration !"}'
