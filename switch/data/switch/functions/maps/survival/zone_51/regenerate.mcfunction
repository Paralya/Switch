...
execute if score #rg_zone_51 switch.data matches 1 run scoreboard players set #rg_zone_51_y switch.data 0
execute if score #rg_zone_51 switch.data matches 1 run scoreboard players set #rg_zone_51_mod switch.data 0
execute if score #rg_zone_51 switch.data matches ..426 summon marker run function switch:maps/survival/zone_51/regeneration_on_marker

execute if score #rg_zone_51 switch.data matches 427.. run kill @e[type=item,x=2001,y=0,z=2000,distance=..1000]
execute if score #rg_zone_51 switch.data matches 427.. run forceload remove 1947 1937 1965 2063
execute if score #rg_zone_51 switch.data matches 427.. run forceload remove 1965 1937 1983 2063
execute if score #rg_zone_51 switch.data matches 427.. run forceload remove 1983 1937 2001 2063
execute if score #rg_zone_51 switch.data matches 427.. run forceload remove 2001 1937 2019 2063
