...
execute if score #rg_colliseum switch.data matches 385.. run data modify storage switch:main MessageToLog set value '{"text": "La map `colliseum` a fini sa régénération !"}'
