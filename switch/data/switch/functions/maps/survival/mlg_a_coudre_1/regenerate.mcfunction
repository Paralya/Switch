...
execute if score #rg_mlg_a_coudre_1 switch.data matches 20 run particle cloud 30993 101 31000 6 0 6 0 501 force
...
execute if score #rg_mlg_a_coudre_1 switch.data matches 20 run particle cloud 31005 101 31000 6 0 6 0 501 force
...
execute if score #rg_mlg_a_coudre_1 switch.data matches 21 run particle cloud 30993 102 31000 6 0 6 0 501 force
...
execute if score #rg_mlg_a_coudre_1 switch.data matches 21 run particle cloud 31005 102 31000 6 0 6 0 501 force
...
execute if score #rg_mlg_a_coudre_1 switch.data matches 22 run particle cloud 30993 103 31000 6 0 6 0 501 force
...
execute if score #rg_mlg_a_coudre_1 switch.data matches 22 run particle cloud 31005 103 31000 6 0 6 0 501 force
...
execute if score #rg_mlg_a_coudre_1 switch.data matches 23 run particle cloud 30993 104 31000 6 0 6 0 501 force
...
execute if score #rg_mlg_a_coudre_1 switch.data matches 23 run particle cloud 31005 104 31000 6 0 6 0 501 force
...
execute if score #rg_mlg_a_coudre_1 switch.data matches 24.. run kill @e[type=item,x=30999,y=100,z=31000,distance=..1000]
