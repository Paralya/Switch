...
execute if score #rg_mlg_a_coudre_1 switch.data matches 24.. run tellraw @a ["",{"nbt":"ParalyaWarning","storage":"switch:main","interpret":true},{"text":" La map 'mlg_a_coudre_1' vient de finir de se régénérer en ","color":"yellow"},{"text":"00","color":"gold"},{"text":"m","color":"yellow"},{"text":"01","color":"gold"},{"text":"s","color":"yellow"}]
