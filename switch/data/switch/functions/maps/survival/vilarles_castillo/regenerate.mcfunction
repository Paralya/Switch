...
execute if score #rg_vilarles_castillo switch.data matches 2513.. run data modify storage switch:main MessageToLog set value '{"text": "La map `vilarles_castillo` a fini sa regeneration !"}'
