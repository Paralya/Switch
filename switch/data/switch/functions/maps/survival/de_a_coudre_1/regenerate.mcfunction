...
execute if score #rg_de_a_coudre_1 switch.data matches 57.. run data modify storage switch:main MessageToLog set value '{"text": "La map `de_a_coudre_1` a fini sa regeneration !"}'
