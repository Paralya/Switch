...
execute if score #rg_find_the_shulker switch.data matches 225.. run data modify storage switch:main MessageToLog set value '{"text": "La map `find_the_shulker` a fini sa regeneration !"}'
