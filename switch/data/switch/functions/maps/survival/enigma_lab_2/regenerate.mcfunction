...
execute if score #rg_enigma_lab_2 switch.data matches 91.. run data modify storage switch:main MessageToLog set value '{"text": "La map `enigma_lab_2` a fini sa régénération !"}'
