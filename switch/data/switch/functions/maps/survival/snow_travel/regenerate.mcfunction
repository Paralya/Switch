...
execute if score #rg_snow_travel switch.data matches 1306.. run data modify storage switch:main MessageToLog set value '{"text": "La map `snow_travel` a fini sa regeneration !"}'
