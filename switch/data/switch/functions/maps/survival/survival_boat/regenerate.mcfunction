...
execute if score #rg_survival_boat switch.data matches 601.. run kill @e[type=item,x=79063,y=0,z=79051,distance=..1000]
execute if score #rg_survival_boat switch.data matches 601.. run forceload remove 79000 79000 79021 79102
execute if score #rg_survival_boat switch.data matches 601.. run forceload remove 79021 79000 79042 79102
execute if score #rg_survival_boat switch.data matches 601.. run forceload remove 79042 79000 79063 79102
execute if score #rg_survival_boat switch.data matches 601.. run forceload remove 79063 79000 79084 79102
...
execute if score #rg_survival_boat switch.data matches 601.. run data modify storage switch:main MessageToLog set value '{"text": "La map `survival_boat` a fini sa regeneration !"}'
