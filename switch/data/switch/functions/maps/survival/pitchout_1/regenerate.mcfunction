...
execute if score #rg_pitchout_1 switch.data matches 226.. run kill @e[type=item,x=1000,y=0,z=1100,distance=..1000]
execute if score #rg_pitchout_1 switch.data matches 226.. run forceload remove 950 1050 970 1150
execute if score #rg_pitchout_1 switch.data matches 226.. run forceload remove 970 1050 990 1150
execute if score #rg_pitchout_1 switch.data matches 226.. run forceload remove 990 1050 1010 1150
...
execute if score #rg_pitchout_1 switch.data matches 226.. run data modify storage switch:main MessageToLog set value '{"text": "La map `pitchout_1` a fini sa regeneration !"}'
