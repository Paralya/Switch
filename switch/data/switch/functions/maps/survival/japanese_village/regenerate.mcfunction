...
execute if score #rg_japanese_village switch.data matches 1805.. run data modify storage switch:main MessageToLog set value '{"text": "La map `japanese_village` a fini sa regeneration !"}'
