...
execute if score #rg_lava_castle switch.data matches 259.. run data modify storage switch:main MessageToLog set value '{"text": "La map `lava_castle` a fini sa régénération !"}'
