...
execute if score #rg_layers_4_teams switch.data matches 125.. run kill @e[type=item,x=74018,y=0,z=74031,distance=..1000]
execute if score #rg_layers_4_teams switch.data matches 125.. run forceload remove 74000 74000 74018 74062
execute if score #rg_layers_4_teams switch.data matches 125.. run forceload remove 74018 74000 74036 74062
execute if score #rg_layers_4_teams switch.data matches 125.. run tellraw @a ["",{"nbt":"ParalyaWarning","storage":"switch:main","interpret":true},{"text":" La map '","color":"yellow"},{"text":"layers_4_teams","color":"gold"},{"text":"' vient de finir de se régénérer en ","color":"yellow"},{"text":"0","color":"gold"},{"text":"m","color":"yellow"},{"text":"06","color":"gold"},{"text":"s","color":"yellow"}]
execute if score #rg_layers_4_teams switch.data matches 125.. run data modify storage switch:main MessageToLog set value '{"text": "La map `layers_4_teams` a fini sa regeneration !"}'
