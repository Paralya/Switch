...
execute if score #rg_layers_4_teams switch.data matches 125.. run data modify storage switch:main MessageToLog set value '{"text": "La map `layers_4_teams` a fini sa régénération !"}'
