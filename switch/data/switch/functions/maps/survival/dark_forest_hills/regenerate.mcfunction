...
execute if score #rg_dark_forest_hills switch.data matches 771.. run kill @e[type=item,x=39071,y=0,z=39110,distance=..1000]
execute if score #rg_dark_forest_hills switch.data matches 771.. run forceload remove 39000 39000 39013 39221
execute if score #rg_dark_forest_hills switch.data matches 771.. run forceload remove 39013 39000 39026 39221
execute if score #rg_dark_forest_hills switch.data matches 771.. run forceload remove 39026 39000 39039 39221
execute if score #rg_dark_forest_hills switch.data matches 771.. run forceload remove 39039 39000 39052 39221
execute if score #rg_dark_forest_hills switch.data matches 771.. run forceload remove 39052 39000 39065 39221
execute if score #rg_dark_forest_hills switch.data matches 771.. run forceload remove 39065 39000 39078 39221
execute if score #rg_dark_forest_hills switch.data matches 771.. run forceload remove 39078 39000 39091 39221
execute if score #rg_dark_forest_hills switch.data matches 771.. run forceload remove 39091 39000 39104 39221
execute if score #rg_dark_forest_hills switch.data matches 771.. run forceload remove 39104 39000 39117 39221
execute if score #rg_dark_forest_hills switch.data matches 771.. run forceload remove 39117 39000 39130 39221
execute if score #rg_dark_forest_hills switch.data matches 771.. run forceload remove 39130 39000 39143 39221
execute if score #rg_dark_forest_hills switch.data matches 771.. run tellraw @a ["",{"nbt":"ParalyaWarning","storage":"switch:main","interpret":true},{"text":" La map '","color":"yellow"},{"text":"dark_forest_hills","color":"gold"},{"text":"' vient de finir de se régénérer en ","color":"yellow"},{"text":"0","color":"gold"},{"text":"m","color":"yellow"},{"text":"38","color":"gold"},{"text":"s","color":"yellow"}]
execute if score #rg_dark_forest_hills switch.data matches 771.. run data modify storage switch:main MessageToLog set value '{"text": "La map `dark_forest_hills` a fini sa régénération !"}'
