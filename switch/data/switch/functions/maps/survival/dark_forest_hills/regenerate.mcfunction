...
execute if score #rg_dark_forest_hills switch.data matches 771.. run data modify storage switch:main MessageToLog set value '{"text": "La map `dark_forest_hills` a fini sa regeneration !"}'
