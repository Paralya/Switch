...
execute if score #rg_tnt_run_futuristic switch.data matches 139.. run data modify storage switch:main MessageToLog set value '{"text": "La map `tnt_run_futuristic` a fini sa regeneration !"}'
