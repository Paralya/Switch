...
execute if score #rg_sky_tower switch.data matches 1697.. run data modify storage switch:main MessageToLog set value '{"text": "La map `sky_tower` a fini sa regeneration !"}'
