...
execute if score #rg_spleef_1 switch.data matches 61.. run data modify storage switch:main MessageToLog set value '{"text": "La map `spleef_1` a fini sa regeneration !"}'
