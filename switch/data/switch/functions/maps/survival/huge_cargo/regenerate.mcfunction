...
execute if score #rg_huge_cargo switch.data matches 1695.. run data modify storage switch:main MessageToLog set value '{"text": "La map `huge_cargo` a fini sa regeneration !"}'
