...
execute if score #rg_traitor_original switch.data matches 641.. run data modify storage switch:main MessageToLog set value '{"text": "La map `traitor_original` a fini sa regeneration !"}'
