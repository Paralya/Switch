...
execute if score #rg_warden_escape_statue switch.data matches 745.. run kill @e[type=item,x=69074,y=-64,z=69053,distance=..1000]
execute if score #rg_warden_escape_statue switch.data matches 745.. run forceload remove 69000 69000 69025 69106
execute if score #rg_warden_escape_statue switch.data matches 745.. run forceload remove 69025 69000 69049 69106
execute if score #rg_warden_escape_statue switch.data matches 745.. run forceload remove 69049 69000 69074 69106
execute if score #rg_warden_escape_statue switch.data matches 745.. run forceload remove 69074 69000 69099 69106
execute if score #rg_warden_escape_statue switch.data matches 745.. run forceload remove 69099 69000 69123 69106
execute if score #rg_warden_escape_statue switch.data matches 745.. run forceload remove 69123 69000 69148 69106
execute if score #rg_warden_escape_statue switch.data matches 745.. run tellraw @a ["",{"nbt":"ParalyaWarning","storage":"switch:main","interpret":true},{"text":" La map '","color":"yellow"},{"text":"warden_escape_statue","color":"gold"},{"text":"' vient de finir de se régénérer en ","color":"yellow"},{"text":"0","color":"gold"},{"text":"m","color":"yellow"},{"text":"37","color":"gold"},{"text":"s","color":"yellow"}]
