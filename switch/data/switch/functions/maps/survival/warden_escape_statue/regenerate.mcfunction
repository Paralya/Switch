...
execute if score #rg_warden_escape_statue switch.data matches 751.. run data modify storage switch:main MessageToLog set value '{"text": "La map `warden_escape_statue` a fini sa regeneration !"}'
