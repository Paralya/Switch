...
execute if score #rg_nature_house switch.data matches 100.. run data modify storage switch:main MessageToLog set value '{"text": "La map `nature_house` a fini sa régénération !"}'
