...
execute if score #rg_rush_the_point_1 switch.data matches 257.. run kill @e[type=item,x=14000,y=0,z=14000,distance=..1000]
execute if score #rg_rush_the_point_1 switch.data matches 257.. run forceload remove 13901 13901 13915 14099
execute if score #rg_rush_the_point_1 switch.data matches 257.. run forceload remove 13915 13901 13929 14099
execute if score #rg_rush_the_point_1 switch.data matches 257.. run forceload remove 13929 13901 13943 14099
execute if score #rg_rush_the_point_1 switch.data matches 257.. run forceload remove 13943 13901 13958 14099
execute if score #rg_rush_the_point_1 switch.data matches 257.. run forceload remove 13958 13901 13972 14099
execute if score #rg_rush_the_point_1 switch.data matches 257.. run forceload remove 13972 13901 13986 14099
execute if score #rg_rush_the_point_1 switch.data matches 257.. run forceload remove 13986 13901 14000 14099
execute if score #rg_rush_the_point_1 switch.data matches 257.. run forceload remove 14000 13901 14014 14099
execute if score #rg_rush_the_point_1 switch.data matches 257.. run forceload remove 14014 13901 14028 14099
execute if score #rg_rush_the_point_1 switch.data matches 257.. run forceload remove 14028 13901 14042 14099
execute if score #rg_rush_the_point_1 switch.data matches 257.. run forceload remove 14042 13901 14057 14099
execute if score #rg_rush_the_point_1 switch.data matches 257.. run forceload remove 14057 13901 14071 14099
...
execute if score #rg_rush_the_point_1 switch.data matches 257.. run data modify storage switch:main MessageToLog set value '{"text": "La map `rush_the_point_1` a fini sa regeneration !"}'
