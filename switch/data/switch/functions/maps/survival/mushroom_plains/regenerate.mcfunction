...
execute if score #rg_mushroom_plains switch.data matches 307.. run data modify storage switch:main MessageToLog set value '{"text": "La map `mushroom_plains` a fini sa regeneration !"}'
