...
execute if score #rg_sky_island_tower switch.data matches 585.. run data modify storage switch:main MessageToLog set value '{"text": "La map `sky_island_tower` a fini sa regeneration !"}'
