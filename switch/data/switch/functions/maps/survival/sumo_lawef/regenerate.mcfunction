...
execute if score #rg_sumo_lawef switch.data matches 81.. run data modify storage switch:main MessageToLog set value '{"text": "La map `sumo_lawef` a fini sa regeneration !"}'
