...
generate_clone_survival_folder("snk_lab_s11", (67000, 0, 67000), (67065, 33, 67073), 100)
...
generate_clone_survival_folder("layers_4_teams", (74000, 0, 74000), (74036, 61, 74062), 100)
generate_clone_survival_folder("snk_lab_s9", (75000, 0, 75000), (75089, 35, 75076), 100)
generate_clone_survival_folder("sky_island_tower", (77000, -64, 77000), (77097, 81, 77094), 100)
generate_clone_survival_folder("sprucy_village", (78000, 0, 78000), (78171, 81, 78112), 100)
generate_clone_survival_folder("survival_boat", (79000, 0, 79000), (79126, 99, 79102), 100)
# Sky Tower (80000) #TODO : Malaise c'est trop grand
generate_clone_survival_folder("sky_tower", (80000, -64, 80000), (80142, 147, 80142), 150)
generate_fill_survival_folder("purple_sky_island", (80824, 0, 80822), (81219, 235, 81182), "air", "#switch:purple_sky_island")
# Sea Artificial Island (82000)
generate_clone_survival_folder("lava_castle", (83000, 0, 83000), (83063, 85, 83063), 100)
generate_clone_survival_folder("spruce_dojo", (84000, 0, 84000), (84083, 46, 84069), 100)
generate_clone_survival_folder("highland_mansion", (85000, 0, 85000), (85150, 72, 85142), 100)
generate_clone_survival_folder("sakura_house", (86000, 0, 86000), (86121, 94, 86135), 100)
generate_clone_survival_folder("red_temple", (87000, 0, 87000), (87045, 40, 87094), 100)
generate_clone_survival_folder("nature_house", (88000, 0, 88000), (88068, 32, 88068), 100)
generate_clone_survival_folder("flower_village", (89000, 0, 89000), (89422, 94, 89532), 100)
generate_clone_survival_folder("japanese_village", (90000, 0, 90000), (90224, 85, 90286), 100)
generate_clone_survival_folder("whity_lab", (91000, 0, 91000), (91102, 35, 91102), 100)
generate_clone_survival_folder("snowy_village", (92000, 0, 92000), (92200, 70, 92229), 100)
generate_clone_survival_folder("werewolf_village", (93000, 0, 93000), (93122, 64, 93122), 100)
generate_clone_survival_folder("wyvern_towers", (94000, 0, 94000), (94076, 99, 94076), 100)
