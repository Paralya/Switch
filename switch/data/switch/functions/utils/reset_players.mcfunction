...
execute unless score #set_spec switch.data matches 1 run gamemode adventure @a[tag=!switch.detached,tag=!convention.debug]
execute if score #set_spec switch.data matches 1 run gamemode spectator @a[tag=!switch.detached,tag=!convention.debug]
