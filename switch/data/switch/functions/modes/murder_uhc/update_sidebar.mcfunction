...
execute store result score #count switch.data if entity @e[type=marker,tag=switch.traitors_game.detective]
...
scoreboard players set #count switch.data 0
execute store result score #count switch.data if entity @e[type=marker,tag=switch.traitors_game.ninja]
...
scoreboard players set #count switch.data 0
execute store result score #count switch.data if entity @e[type=marker,tag=switch.traitors_game.innocent]
...
scoreboard players set #count switch.data 0
execute store result score #count switch.data if entity @e[type=marker,tag=switch.traitors_game.traitor,tag=!switch.traitors_game.big_traitor]
...
scoreboard players set #count switch.data 0
execute store result score #count switch.data if entity @e[type=marker,tag=switch.traitors_game.big_traitor]
