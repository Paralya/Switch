...
execute if score #remaining_players switch.data matches ..0 run function switch:modes/moutron/process_end
execute if score #moutron_seconds switch.data matches 600000.. run function switch:modes/moutron/process_end
