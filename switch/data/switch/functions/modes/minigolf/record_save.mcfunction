...
$execute if score #new_record switch.data matches 1 run data modify storage switch:records minigolf.$(current_map).player set from entity @s Inventory[0].tag.SkullOwner.Name
