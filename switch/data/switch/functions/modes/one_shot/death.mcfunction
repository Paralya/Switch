...
execute if entity @s[scores={switch.alive=2}] run tellraw @a[tag=!detached] [{"selector":"@s","color":"red"},{"text":" a été tué, il ne lui reste plus qu'1 vie !"}]
...
execute if entity @s[scores={switch.alive=6}] run tellraw @a[tag=!detached] [{"selector":"@s","color":"yellow"},{"text":" a été tué, il lui reste 5 vies !"}]
execute if entity @s[scores={switch.alive=7}] run tellraw @a[tag=!detached] [{"selector":"@s","color":"lime"},{"text":" a été tué, il lui reste 6 vies !"}]
