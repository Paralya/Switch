...
execute if score #random switch.data matches 8 if data storage switch:main {map:"luxio_one_shot"} run summon pufferfish 151026 127 151026 {Glowing:1b,CustomNameVisible:1b,CustomName:'{"text":"Poisson mécontent","color":"green","bold":true}'}
execute if score #random switch.data matches 8 if data storage switch:main {map:"luxio_one_shot"} run summon pufferfish 151026 127 151026 {Glowing:1b,CustomNameVisible:1b,CustomName:'{"text":"Poisson mécontent","color":"green","bold":true}'}
execute if score #random switch.data matches 8 if data storage switch:main {map:"luxio_one_shot"} run summon pufferfish 151026 127 151026 {Glowing:1b,CustomNameVisible:1b,CustomName:'{"text":"Poisson mécontent","color":"green","bold":true}'}
execute if score #random switch.data matches 8 if data storage switch:main {map:"luxio_one_shot"} run summon pufferfish 151040 124 151032 {Glowing:1b,CustomNameVisible:1b,CustomName:'{"text":"Poisson mécontent","color":"green","bold":true}'}
execute if score #random switch.data matches 8 if data storage switch:main {map:"luxio_one_shot"} run summon pufferfish 151015 124 151020 {Glowing:1b,CustomNameVisible:1b,CustomName:'{"text":"Poisson mécontent","color":"green","bold":true}'}


execute if score #random switch.data matches 8 if data storage switch:main {map:"airdox_one_shot"} run summon pufferfish 156007 155 155998 {Glowing:1b,CustomNameVisible:1b,CustomName:'{"text":"Poisson mécontent","color":"green","bold":true}'}
execute if score #random switch.data matches 8 if data storage switch:main {map:"airdox_one_shot"} run summon pufferfish 156007 155 155998 {Glowing:1b,CustomNameVisible:1b,CustomName:'{"text":"Poisson mécontent","color":"green","bold":true}'}
execute if score #random switch.data matches 8 if data storage switch:main {map:"airdox_one_shot"} run summon pufferfish 156007 155 155998 {Glowing:1b,CustomNameVisible:1b,CustomName:'{"text":"Poisson mécontent","color":"green","bold":true}'}
execute if score #random switch.data matches 8 if data storage switch:main {map:"airdox_one_shot"} run summon pufferfish 156003 154 155972 {Glowing:1b,CustomNameVisible:1b,CustomName:'{"text":"Poisson mécontent","color":"green","bold":true}'}
execute if score #random switch.data matches 8 if data storage switch:main {map:"airdox_one_shot"} run summon pufferfish 156003 154 155972 {Glowing:1b,CustomNameVisible:1b,CustomName:'{"text":"Poisson mécontent","color":"green","bold":true}'}
