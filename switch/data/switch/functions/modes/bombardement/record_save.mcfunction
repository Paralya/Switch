...
execute if score #bombardement_seconds switch.data > #record switch.data run data modify storage switch:records bombardement.player set from entity @s Inventory[0].tag.SkullOwner.Name
