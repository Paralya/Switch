...
execute if score #warden_escape_seconds switch.data matches 0 if data storage switch:main {map:"warden_forest"} as @e[limit=2] run summon warden 10000 101.69 10000
execute if score #warden_escape_seconds switch.data matches 0 if data storage switch:main {map:"warden_forest"} as @e[limit=2] run summon warden 10040 101.69 10040
execute if score #warden_escape_seconds switch.data matches 0 if data storage switch:main {map:"warden_forest"} as @e[limit=2] run summon warden 9960 101.69 10040
execute if score #warden_escape_seconds switch.data matches 0 if data storage switch:main {map:"warden_forest"} as @e[limit=2] run summon warden 10040 101.69 9960
execute if score #warden_escape_seconds switch.data matches 0 if data storage switch:main {map:"warden_forest"} as @e[limit=2] run summon warden 9960 101.69 9960
