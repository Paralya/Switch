...
# Détection des morts
execute as @a[tag=!switch.detached,x=0,y=69,z=0,distance=..10] run function switch:modes/layers_2_teams/death

# Enchantement efficiency 5 sur les pioches
execute as @a[tag=!switch.detached] run item modify entity @s weapon.mainhand switch:handheld/enchant_efficiency_5
