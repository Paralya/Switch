...
scoreboard players remove @e[type=horse,scores={switch.temp.engine=1..}] switch.temp.engine 1
scoreboard players operation @e[type=horse,scores={switch.temp.engine=1..}] switch.temp.engine *= #14 switch.data
scoreboard players operation @e[type=horse,scores={switch.temp.engine=1..}] switch.temp.engine /= #15 switch.data
