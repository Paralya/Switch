...
execute if score @s switch.glassrunner.money matches 3.. if data entity @s SelectedItem.tag{Charged:0b} run function switch:modes/glassrunner/destroying_crossbow/charge
