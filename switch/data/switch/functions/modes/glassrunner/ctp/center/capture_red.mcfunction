...
scoreboard players add @a[tag=!switch.detached,team=switch.glassrunner.red] switch.glassrunner.money 10
xp add @a[tag=!switch.detached,team=switch.glassrunner.red] 10 levels
