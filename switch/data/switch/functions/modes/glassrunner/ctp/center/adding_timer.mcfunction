...
execute store success score #temp switch.data if entity @s[team=switch.glassrunner.red] if entity @a[dx=5,dy=3,dz=5,team=switch.glassrunner.blue] run scoreboard players set #glassrunner.ctp.center.red.timer switch.data 0
execute store success score #temp2 switch.data if entity @s[team=switch.glassrunner.blue] if entity @a[dx=5,dy=3,dz=5,team=switch.glassrunner.red] run scoreboard players set #glassrunner.ctp.center.blue.timer switch.data 0
