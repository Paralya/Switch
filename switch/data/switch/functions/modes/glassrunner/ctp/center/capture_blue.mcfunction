...
scoreboard players add @a[tag=!detached,team=switch.glassrunner.blue] switch.glassrunner.money 10
xp add @a[tag=!detached,team=switch.glassrunner.blue] 10 levels
