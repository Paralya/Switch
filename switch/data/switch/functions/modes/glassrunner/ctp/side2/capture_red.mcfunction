...
scoreboard players add @a[tag=!detached,team=switch.glassrunner.red] switch.glassrunner.money 5
xp add @a[tag=!detached,team=switch.glassrunner.red] 5 levels
