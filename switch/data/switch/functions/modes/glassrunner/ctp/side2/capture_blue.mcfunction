...
scoreboard players add @a[tag=!switch.detached,team=switch.glassrunner.blue] switch.glassrunner.money 5
xp add @a[tag=!switch.detached,team=switch.glassrunner.blue] 5 levels
