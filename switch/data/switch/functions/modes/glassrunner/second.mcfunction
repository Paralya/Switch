...
execute positioned 2997 128 2997 as @a[tag=!switch.detached,dx=5,dy=3,dz=5] run function switch:modes/glassrunner/ctp/center/adding_timer
execute positioned 2997 128 2997 unless entity @a[tag=!switch.detached,dx=5,dy=3,dz=5] run function switch:modes/glassrunner/ctp/center/reset
...
execute positioned 2924 128 3074 as @a[tag=!switch.detached,dx=2,dy=3,dz=2] run function switch:modes/glassrunner/ctp/side1/adding_timer
execute positioned 2924 128 3074 unless entity @a[tag=!switch.detached,dx=2,dy=3,dz=2] run function switch:modes/glassrunner/ctp/side1/reset
...
execute positioned 3074 128 2924 as @a[tag=!switch.detached,dx=2,dy=3,dz=2] run function switch:modes/glassrunner/ctp/side2/adding_timer
execute positioned 3074 128 2924 unless entity @a[tag=!switch.detached,dx=2,dy=3,dz=2] run function switch:modes/glassrunner/ctp/side2/reset
