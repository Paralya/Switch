...
execute at @a[tag=switch.beat_the_kings.king,gamemode=!spectator,predicate=!switch:is_sneaking,predicate=!switch:in_air] run particle dolphin ~ ~ ~ 0.2 0 0.2 0 2 normal
...
execute at @a[gamemode=!spectator,tag=switch.beat_the_kings.king] run particle dust 1 1 0.5 1 ~ ~2.1 ~ 0.2 0 0.2 0 1 force @a[tag=switch.beat_the_kings.king]
