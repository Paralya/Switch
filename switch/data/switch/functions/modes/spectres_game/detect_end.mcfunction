...
execute if score #game_state switch.data matches 2 unless entity @a[team=switch.temp.spectre,scores={switch.temp.spectror=0}] run scoreboard players set #game_state switch.data 4
