...
#Starter kit
clear @s
item replace entity @s[tag=switch.spectres_game.visible] armor.head with chainmail_helmet{Enchantments:[{id:"minecraft:protection",lvl:2s}]}
item replace entity @s[tag=switch.spectres_game.visible] armor.chest with iron_chestplate{Enchantments:[{id:"minecraft:fire_protection",lvl:2s}]}
...
effect give @s[tag=switch.spectres_game.spectre] resistance 99999 1 true
