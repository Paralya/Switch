...
item replace entity @s[tag=switch.spectres_game.visible] hotbar.4 with potion{Potion:"minecraft:strong_healing"} 5
...
item replace entity @s[tag=switch.spectres_game.spectre] hotbar.4 with potion{Potion:"minecraft:strong_healing"} 5
