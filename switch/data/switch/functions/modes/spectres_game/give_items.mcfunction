...
item replace entity @s[tag=switch.spectres_game.visible] hotbar.4 with golden_apple 5
...
item replace entity @s[tag=switch.spectres_game.spectre] hotbar.4 with golden_apple 5
