...
execute as @a[tag=!switch.detached,sort=random] at @s run function switch:modes/spectres_game/roles/
execute as @a[tag=!switch.detached] at @s run function switch:modes/spectres_game/give_items
