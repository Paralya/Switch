...
execute if score #feed_fast_seconds switch.data matches 0 run effect give @a[tag=switch.alive] hunger infinite 255 true
execute if score #feed_fast_seconds switch.data matches 0 at @e[limit=8] at @a[tag=switch.alive] run function switch:modes/feed_fast/summon_food
