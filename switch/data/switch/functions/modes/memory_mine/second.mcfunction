...
execute if score #temp switch.data matches 10..19 at @e[type=marker,tag=switch.zone] run function switch:modes/memory_mine/zone/particles
execute if score #temp switch.data matches 20 as @e[type=marker,tag=switch.zone] at @s run function switch:modes/memory_mine/zone/end
