...
execute if score #engine_state switch.data matches 3 if data storage switch:main {current_game:"gay_shooter"} if score @s switch.temp.shot_player matches 42.. run advancement grant @s only switch:visible/22
