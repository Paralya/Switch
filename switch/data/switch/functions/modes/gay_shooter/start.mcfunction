...
execute as @a[tag=!switch.detached,sort=random] at @s run function switch:modes/gay_shooter/roles
execute as @a[tag=!switch.detached] at @s run function switch:modes/gay_shooter/give_items
