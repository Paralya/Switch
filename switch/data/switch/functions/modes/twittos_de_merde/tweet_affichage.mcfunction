...
execute unless data entity @r[scores={passage_vote=0}] Inventory[{id:"minecraft:written_book"}] run tellraw @a [{"text":"@","color":"aqua"},{"selector":"@r[scores={passage_vote=0}]"},{"text":" \n➡ "},{"nbt":"Inventory[0].tag.pages[0]","interpret":false,"entity":"@r[scores={passage_vote=0}]","color":"gold"},{"text":" \n\n "}]
...
execute if data entity @r[scores={passage_vote=0}] Inventory[{id:"minecraft:written_book"}] run tellraw @a [{"text":"@","color":"aqua"},{"selector":"@r[scores={passage_vote=0}]"},{"text":" \n➡ "},{"nbt":"Inventory[0].tag.pages[0]","interpret":true,"entity":"@r[scores={passage_vote=0}]","color":"gold"},{"text":" \n\n "}]
