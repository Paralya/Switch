...
execute unless data entity @r[scores={passage_vote=0}] Inventory[{id:"minecraft:written_book"}] run function switch:modes/twittos_de_merde/tweet_pas_signe
...
execute if data entity @r[scores={passage_vote=0}] Inventory[{id:"minecraft:written_book"}] run function switch:modes/twittos_de_merde/tweet_signe
