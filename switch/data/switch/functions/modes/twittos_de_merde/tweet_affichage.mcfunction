...
execute unless data entity @r[scores={passage_vote=0}] Inventory[{id:"minecraft:written_book"}] run say pas signé
...
execute if data entity @r[scores={passage_vote=0}] Inventory[{id:"minecraft:written_book"}] run say signé
