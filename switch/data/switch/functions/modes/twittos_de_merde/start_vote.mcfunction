...
scoreboard players add #phase_de_vote switch.data 1
scoreboard players add @a passage_vote 1
...
# tellraw @a [{"text":"[Tweet de @","color":"aqua"},{"selector":"@s"},{"text":"] "},{"nbt":"Inventory[0].tag.pages","interpret":true,"entity":"@s","color":"yellow"}]
