...
execute if score #timer_phase_de_vote switch.data matches 7.. if entity @a[scores={passage_vote=0..1}] run function switch:modes/twittos_de_merde/tweet_affichage
