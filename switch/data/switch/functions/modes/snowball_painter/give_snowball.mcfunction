...
execute if score #random switch.data matches 3 run item replace entity @s hotbar.3 with snowball
execute if score #random switch.data matches 4 run item replace entity @s hotbar.4 with snowball
execute if score #random switch.data matches 5 run item replace entity @s hotbar.5 with snowball
execute if score #random switch.data matches 6 run item replace entity @s hotbar.6 with snowball
