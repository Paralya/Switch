...
execute if score #blue_points switch.data matches 2000..2099 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"20","color":"yellow"}]
execute if score #blue_points switch.data matches 2100..2199 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"21","color":"yellow"}]
execute if score #blue_points switch.data matches 2200..2299 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"22","color":"yellow"}]
execute if score #blue_points switch.data matches 2300..2399 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"23","color":"yellow"}]
execute if score #blue_points switch.data matches 2400..2499 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"24","color":"yellow"}]
execute if score #blue_points switch.data matches 2500..2599 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"25","color":"yellow"}]
execute if score #blue_points switch.data matches 2600..2699 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"26","color":"yellow"}]
execute if score #blue_points switch.data matches 2700..2799 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"27","color":"yellow"}]
execute if score #blue_points switch.data matches 2800..2899 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"28","color":"yellow"}]
execute if score #blue_points switch.data matches 2900..2999 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"29","color":"yellow"}]
execute if score #blue_points switch.data matches 3000..3099 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"30","color":"yellow"}]
execute if score #blue_points switch.data matches 3100..3199 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"31","color":"yellow"}]
execute if score #blue_points switch.data matches 3200..3299 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"32","color":"yellow"}]
execute if score #blue_points switch.data matches 3300..3399 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"33","color":"yellow"}]
execute if score #blue_points switch.data matches 3400..3499 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"34","color":"yellow"}]
execute if score #blue_points switch.data matches 3500..3599 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"35","color":"yellow"}]
execute if score #blue_points switch.data matches 3600..3699 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"36","color":"yellow"}]
execute if score #blue_points switch.data matches 3700..3799 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"37","color":"yellow"}]
execute if score #blue_points switch.data matches 3800..3899 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"38","color":"yellow"}]
execute if score #blue_points switch.data matches 3900..3999 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"39","color":"yellow"}]
execute if score #blue_points switch.data matches 4000..4099 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"40","color":"yellow"}]
execute if score #blue_points switch.data matches 4100..4199 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"41","color":"yellow"}]
execute if score #blue_points switch.data matches 4200..4299 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"42","color":"yellow"}]
execute if score #blue_points switch.data matches 4300..4399 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"43","color":"yellow"}]
execute if score #blue_points switch.data matches 4400..4499 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"44","color":"yellow"}]
execute if score #blue_points switch.data matches 4500..4599 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"45","color":"yellow"}]
execute if score #blue_points switch.data matches 4600..4699 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"46","color":"yellow"}]
execute if score #blue_points switch.data matches 4700..4799 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"47","color":"yellow"}]
execute if score #blue_points switch.data matches 4800..4899 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"48","color":"yellow"}]
execute if score #blue_points switch.data matches 4900..4999 run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"49","color":"yellow"}]
execute if score #blue_points switch.data matches 5000.. run team modify switch.temp.sidebar.2 prefix [{"text":"Équipe Bleue : ","color":"blue"},{"text":"50","color":"yellow"}]
