...
execute as @a[tag=!switch.detached,x=14000,y=99,z=14000,distance=..11] at @s if entity @s[y=99,dy=1] run function switch:modes/rush_the_point/on_capture_point
