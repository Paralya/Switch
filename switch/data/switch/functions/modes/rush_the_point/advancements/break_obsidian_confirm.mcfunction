...
execute if score #random switch.data matches 5 if score #color switch.data matches 0 run effect give @a[team=switch.rush_the_point.blue] slowness 60 1 true
...
execute if score #random switch.data matches 7 if score #color switch.data matches 0 run effect give @a[team=switch.rush_the_point.blue] levitation 1 20 true
execute if score #random switch.data matches 8 if score #color switch.data matches 0 run effect give @a[team=switch.rush_the_point.blue] wither 60 0 true
...
execute if score #random switch.data matches 5 if score #color switch.data matches 1 run effect give @a[team=switch.rush_the_point.red] slowness 60 1 true
...
execute if score #random switch.data matches 7 if score #color switch.data matches 1 run effect give @a[team=switch.rush_the_point.red] levitation 1 20 true
execute if score #random switch.data matches 8 if score #color switch.data matches 1 run effect give @a[team=switch.rush_the_point.red] wither 60 0 true
