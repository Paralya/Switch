...
execute if score #color switch.data matches 0 run scoreboard players add #red_points switch.data 5
execute if score #color switch.data matches 0 run function switch:modes/rush_the_point/update_sidebar/red_points/

execute if score #color switch.data matches 1 run scoreboard players add #blue_points switch.data 5
