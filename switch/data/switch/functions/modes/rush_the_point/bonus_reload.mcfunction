...
tellraw @a[tag=!switch.detached] ["",{"nbt":"ParalyaWarning","storage":"switch:main","interpret":true},{"text":" Un bloc d'obsidienne est apparu, cassez-le pour obtenir un bonus !"}]
execute as @a[tag=!switch.detached] at @s run playsound entity.villager.hurt ambient @s
execute as @a[tag=!switch.detached] at @s run playsound entity.villager.hurt ambient @s
execute as @a[tag=!switch.detached] at @s run playsound entity.villager.hurt ambient @s
