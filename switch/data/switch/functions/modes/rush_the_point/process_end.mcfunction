...
execute if score #process_end switch.data matches 1 if score #red_points switch.data > #blue_points switch.data run scoreboard players add @a[team=switch.rush_the_point.red] switch.money 1
execute if score #process_end switch.data matches 1 if score #red_points switch.data < #blue_points switch.data run scoreboard players add @a[team=switch.rush_the_point.blue] switch.money 1
