...
item replace entity @s hotbar.2 with bow{switch:{class_item:1b},CustomModelData:2013149,display:{Name:'{"text":"Archer","color":"red","italic":false}'}}
item replace entity @s hotbar.4 with elytra{switch:{class_item:1b},CustomModelData:2013143,display:{Name:'{"text":"Kamikaze","color":"red","italic":false}'}}
item replace entity @s hotbar.6 with bricks{switch:{class_item:1b},display:{Name:'{"text":"Builder","color":"red","italic":false}'}}
item replace entity @s hotbar.8 with tnt{switch:{class_item:1b},display:{Name:'{"text":"Destroyer","color":"red","italic":false}'}}
