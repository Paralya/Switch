...
execute as @a[tag=!switch.detached,scores={switch.right_click=1..},nbt={SelectedItem:{tag:{switch:{fireball_stick:1b}}}}] if score @s crazy_adventure.cooldown matches 1.. at @s run function switch:modes/rush_the_point/fireball/no_cooldown
execute as @a[tag=!switch.detached,scores={switch.right_click=1..},nbt={SelectedItem:{tag:{switch:{fireball_stick:1b}}}}] if score @s crazy_adventure.cooldown matches 0 at @s run function switch:modes/rush_the_point/fireball/right_click
...
# Class System
execute as @a[tag=!switch.detached,scores={switch.temp.choosen_class=0}] run function switch:modes/rush_the_point/classes/

# Death System
execute as @e[type=player,tag=switch.to_tp] run function switch:modes/rush_the_point/teleport_to_death
execute as @a[tag=!switch.detached,x=0,y=69,z=0,distance=..10] run function switch:modes/rush_the_point/death/player
