...
execute at @a[tag=switch.third_life] run particle dust 0 .75 0 1 ~ ~2 ~ .2 .2 .2 0 1
execute at @a[tag=switch.second_life,tag=!switch.third_life] run particle dust .75 .75 0 1 ~ ~2 ~ .2 .2 .2 0 1
execute at @a[tag=switch.first_life,tag=!switch.second_life] run particle dust .75 0 0 1 ~ ~2 ~ .2 .2 .2 0 1
