...
execute as @e[type=item,tag=!switch.done,distance=..1,nbt={Item:{id:"minecraft:bow"}}] run data modify entity @s Item.tag.Enchantments set value [{id:"minecraft:infinity",lvl:1},{id:"minecraft:punch",lvl:2}]
execute as @e[type=item,tag=!switch.done,distance=..1] run data modify entity @s Item.tag.Unbreakable set value 1b
