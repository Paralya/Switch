...
execute if score #process_end switch.data matches 1 if score #remaining_players switch.data matches 1 as @a[tag=switch.first_life] at @s run function switch:engine/add_money
