...
item replace entity @s hotbar.4 with potion{display:{Name:'{"text":"Suicide Potion","color":"dark_purple","italic":false}'},custom_potion_effects:[{id:"minecraft:instant_damage",amplifier:1b,duration:20},{id:"minecraft:wither",amplifier:10b,duration:-1},{id:"minecraft:poison",amplifier:10b,duration:-1}],CustomPotionColor:4391004}
