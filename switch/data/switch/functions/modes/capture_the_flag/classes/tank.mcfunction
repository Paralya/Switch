...
item replace entity @s hotbar.7 with potion{display:{Name:'{"text":"Suicide Potion","color":"dark_purple","italic":false}'},custom_potion_effects:[{id:"minecraft:wither",amplifier:10b,duration:-1}],CustomPotionColor:4391004}
