...
execute if data storage switch:main {map:"luxio_OneShot"} run function switch:maps/spread_one_player
execute if data storage switch:main {map:"airdox_OneShot"} run function switch:modes/OneShot/tp_airdox


function switch:modes/OneShot/xp_bar
...
function switch:modes/OneShot/give_items
