...
execute if score @s switch.temp.throw_reload matches 1..170 if score @s switch.right_click matches 1.. run function switch:modes/murder_mystery/throw/error
