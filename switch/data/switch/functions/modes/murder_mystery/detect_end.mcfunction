...
execute if entity @a[gamemode=!spectator,scores={switch.temp.role=3}] unless entity @a[gamemode=!spectator,scores={switch.temp.role=1..2}] run scoreboard players set #game_state switch.data 2
