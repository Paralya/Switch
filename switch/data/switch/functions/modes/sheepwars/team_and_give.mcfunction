...
# Kit Better Sword
execute if score @s switch.sheepwars.choosen_kit matches 3 unless score @s switch.sheepwars.kit_sword matches 1.. run item replace entity @s hotbar.0 with stone_sword{Unbreakable:1b,HideFlags:8,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:0.42,Operation:0,UUID:[I;20231201,3,1,1],Slot:"mainhand"}]}
execute if score @s switch.sheepwars.choosen_kit matches 3 if score @s switch.sheepwars.kit_sword matches 1 run item replace entity @s hotbar.0 with stone_sword{Unbreakable:1b,HideFlags:8,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:0.44,Operation:0,UUID:[I;20231201,3,1,1],Slot:"mainhand"}]}
execute if score @s switch.sheepwars.choosen_kit matches 3 if score @s switch.sheepwars.kit_sword matches 2 run item replace entity @s hotbar.0 with stone_sword{Unbreakable:1b,HideFlags:8,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:0.46,Operation:0,UUID:[I;20231201,3,1,1],Slot:"mainhand"}]}
execute if score @s switch.sheepwars.choosen_kit matches 3 if score @s switch.sheepwars.kit_sword matches 3 run item replace entity @s hotbar.0 with stone_sword{Unbreakable:1b,HideFlags:8,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:0.48,Operation:0,UUID:[I;20231201,3,1,1],Slot:"mainhand"}]}
execute if score @s switch.sheepwars.choosen_kit matches 3 if score @s switch.sheepwars.kit_sword matches 4 run item replace entity @s hotbar.0 with stone_sword{Unbreakable:1b,HideFlags:8}
# Kit Builder
