...
execute as @a[sort=random] run function switch:modes/glassrunner/teleport_players
execute as @a at @s run function switch:modes/glassrunner/give_items
...
scoreboard players set #glassrunner_seconds switch.data -5
