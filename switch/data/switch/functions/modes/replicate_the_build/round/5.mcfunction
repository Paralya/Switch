...
execute if score #rtb_round_state switch.data matches 5 unless entity @a[gamemode=!spectator,scores={switch.alive=1..}] run function switch:modes/replicate_the_build/round/5_end
