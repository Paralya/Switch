...
gamemode spectator @a[tag=!detached,scores={switch.alive=1..},gamemode=!spectator]
...
scoreboard players set @a[tag=!detached,scores={switch.alive=1..}] switch.rtb.points 0
