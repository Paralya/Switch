...
scoreboard players add #replicate_the_build_ticks switch.rtb.data 1
...
execute unless entity @a[tag=switch.alive] unless score #rtb_round_state switch.rtb.data matches 9 run function switch:modes/replicate_the_build/process_end
#execute if score #replicate_the_build_seconds switch.rtb.data matches 600.. run function switch:modes/replicate_the_build/process_end
