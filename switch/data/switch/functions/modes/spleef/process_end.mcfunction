...
execute if score #process_end switch.data matches 1 if score #remaining_players switch.data matches 1 run scoreboard players add @a[tag=switch.first_life] switch.money 2
...
execute if score #process_end switch.data matches 1 as @a[sort=random] run function switch:modes/spleef/death
