...
execute if score #reconnect switch.data matches 0 run say new player, launch join function
execute if score #reconnect switch.data matches 1 run say reconnected
