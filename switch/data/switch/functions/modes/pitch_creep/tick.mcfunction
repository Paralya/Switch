...
execute as @a[tag=!switch.detached,x=0,y=69,z=0,distance=..10] run function switch:modes/pitch_creep/death
...
execute unless entity @a[tag=!switch.detached,scores={switch.alive=1..}] run function switch:modes/pitch_creep/process_end
