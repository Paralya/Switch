...
execute as @a[gamemode=!spectator,scores={switch.alive=1},x=5033,y=105,z=5000,dx=3,dy=4,dz=4] at @s run function switch:modes/boat_race/finish
execute as @a[gamemode=!spectator,scores={switch.alive=1},x=50997,y=92,z=50964,dx=6,dy=4,dz=5] at @s run function switch:modes/boat_race/finish
