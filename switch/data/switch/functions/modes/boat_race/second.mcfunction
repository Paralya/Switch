...
execute as @a[predicate=!switch:has_vehicle] at @s run ride @s mount @e[type=chest_boat,predicate=!switch:has_passenger,distance=..10,sort=nearest,limit=1]
