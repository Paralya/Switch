...
execute unless score #test_mode switch.data matches 1 run advancement grant @a[tag=!detached,gamemode=adventure,scores={switch.temp.time_since_movement=30..}] only switch:visible/82
