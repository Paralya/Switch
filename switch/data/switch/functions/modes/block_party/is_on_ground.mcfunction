...
execute if score #temp switch.data matches -8 run summon marker ~ ~ ~ {Tags:["switch.block_party"]}
execute unless score #temp switch.data matches -8 unless block ~ ~-.25 ~ air run summon marker ~ ~ ~ {Tags:["switch.block_party"]}
