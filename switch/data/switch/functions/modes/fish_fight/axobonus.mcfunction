...
execute if score #random switch.data matches 0 run effect give @s slow_falling 25 1 true
execute if score #random switch.data matches 0 as @a[tag=!detached] at @s run playsound entity.generic.drink ambient @s
execute if score #random switch.data matches 0 run tellraw @a[tag=!detached] ["",{"text":"AxoBonus","bold":false,"color":"light_purple"},{"text":" \u2022 ","bold":true,"color":"gray"},{"selector":"@s","color":"yellow","bold":true},{"text":" a obtenu un effet de Slow Falling !","color":"white"},{"text":"\n "}]
...
execute if score #random switch.data matches 1 run effect give @s speed 10 1 true
execute if score #random switch.data matches 1 as @a[tag=!detached] at @s run playsound entity.generic.drink ambient @s
execute if score #random switch.data matches 1 run tellraw @a[tag=!detached] ["",{"text":"AxoBonus","bold":false,"color":"light_purple"},{"text":" \u2022 ","bold":true,"color":"gray"},{"selector":"@s","color":"yellow","bold":true},{"text":" a obtenu un effet de Speed !","color":"white"},{"text":"\n "}]
...
execute if score #random switch.data matches 2 run give @s white_wool 25
...
#si le score est 12, on donne un effet de jump boost au détenteur
execute if score #random switch.data matches 12 run effect give @s jump_boost 8 1 true
execute if score #random switch.data matches 12 as @a[tag=!detached] at @s run playsound entity.generic.drink ambient @s
execute if score #random switch.data matches 12 run tellraw @a[tag=!detached] ["",{"text":"AxoBonus","bold":false,"color":"light_purple"},{"text":" \u2022 ","bold":true,"color":"gray"},{"selector":"@s","color":"yellow","bold":true},{"text":" a obtenu un effet de Jump Boost !","color":"white"},{"text":"\n "}]
