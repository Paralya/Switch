...
item replace entity @s hotbar.0 with tropical_fish{Enchantments:[{id:"minecraft:knockback",lvl:2s},{id:"minecraft:sharpness",lvl:1s}],display:{Name:'{"text":"Fishy Fish","italic":false,"color":"aqua"}'}}
