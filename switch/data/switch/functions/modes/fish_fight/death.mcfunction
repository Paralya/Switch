...
execute if entity @s[scores={switch.alive=1}] run tellraw @a[tag=!detached] [{"selector":"@s","color":"dark_red"},{"text":" est mort. il a survécu "},{"score":{"name":"#fish_fight_seconds","objective":"switch.data"}},{"text":" secondes !"}]
