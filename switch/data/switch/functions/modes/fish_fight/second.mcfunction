...
execute if score #temp switch.data matches 1 run execute if score #TEAM_FISH switch.data matches 1 run give @s[team=switch.temp.blue] blue_wool 1 
execute if score #temp switch.data matches 1 run execute if score #TEAM_FISH switch.data matches 1 run give @s[team=switch.temp.red] red_wool 1
