...
execute if score #remaining_time switch.data matches 270 run scoreboard players set @a[tag=!detached] switch.temp.theme_vote 0
execute if score #remaining_time switch.data matches 270 run scoreboard players enable @a[tag=!detached] switch.temp.theme_vote
