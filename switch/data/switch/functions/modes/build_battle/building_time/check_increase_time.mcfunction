...
execute if score #success switch.data matches 1 run tellraw @a[tag=!detached] ["",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" La population a voté pour augmenter le temps de construction de 5 minutes !","color":"green"}]
...
execute unless score #success switch.data matches 1 run tellraw @a[tag=!detached] ["",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Il n'y a pas eu assez de votes pour augmenter le temps de construction...","color":"red"}]
