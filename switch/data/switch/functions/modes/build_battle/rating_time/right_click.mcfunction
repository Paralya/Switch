...
execute if score #slot switch.data matches 0 run tellraw @a {"text":"Super Poop","color":"#8B4513"}
execute if score #slot switch.data matches 1 run tellraw @a {"text":"Poop","color":"red"}
execute if score #slot switch.data matches 2 run tellraw @a {"text":"OK","color":"dark_green"}
execute if score #slot switch.data matches 3 run tellraw @a {"text":"Good","color":"green"}
execute if score #slot switch.data matches 4 run tellraw @a {"text":"Epic","color":"light_purple"}
execute if score #slot switch.data matches 5 run tellraw @a {"text":"Legendary","color":"gold"}
