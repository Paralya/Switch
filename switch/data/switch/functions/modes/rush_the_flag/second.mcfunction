...
# Summon the flags
execute if score #rush_the_point_seconds switch.data matches 0 if data storage switch:main {map:"rush_the_point_1"} run summon armor_stand 14077 99 14000 {Invisible:1b,Invulnerable:1b,Passengers:[{id:"minecraft:item_display",Tags:["switch.flag","switch.free","switch.original_pos","switch.blue_flag"],item:{id:"minecraft:blue_banner",Count:1b},Rotation:[-90.0f,0.0f]}],Rotation:[-90.0f,0.0f]}
execute if score #rush_the_point_seconds switch.data matches 0 if data storage switch:main {map:"rush_the_point_1"} run summon armor_stand 13923 99 14000 {Invisible:1b,Invulnerable:1b,Passengers:[{id:"minecraft:item_display",Tags:["switch.flag","switch.free","switch.original_pos","switch.red_flag"],item:{id:"minecraft:red_banner",Count:1b},Rotation:[90.0f,0.0f]}],Rotation:[90.0f,0.0f]}
