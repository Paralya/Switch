...
# Messages
execute if score #random switch.data matches 0 run tellraw @a[tag=!detached] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" "},{"selector":"@s"},{"text":" a récuperé le bonus, cela donne l'effet Absorption à son équipe !\n"}]
execute if score #random switch.data matches 1 run tellraw @a[tag=!detached] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" "},{"selector":"@s"},{"text":" a récuperé le bonus, cela donne l'effet Speed à son équipe !\n"}]
execute if score #random switch.data matches 2 run tellraw @a[tag=!detached] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" "},{"selector":"@s"},{"text":" a récuperé le bonus, cela donne l'effet Strength à son équipe !\n"}]
execute if score #random switch.data matches 3 run tellraw @a[tag=!detached] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" "},{"selector":"@s"},{"text":" a récuperé le bonus, cela donne l'effet Resistance à son équipe !\n"}]
execute if score #random switch.data matches 4 run tellraw @a[tag=!detached] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" "},{"selector":"@s"},{"text":" a récuperé le bonus, un Wither a été invoqué contre l'équipe ennemi !\n"}]
execute if score #random switch.data matches 5 run tellraw @a[tag=!detached] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" "},{"selector":"@s"},{"text":" a récuperé le bonus, cela donne l'effet Slowness à l'équipe ennemi !\n"}]
execute if score #random switch.data matches 6 run tellraw @a[tag=!detached] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" "},{"selector":"@s"},{"text":" a récuperé le bonus, cela donne l'effet Glowing à l'équipe ennemi !\n"}]
execute if score #random switch.data matches 7 run tellraw @a[tag=!detached] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" "},{"selector":"@s"},{"text":" a récuperé le bonus, cela donne l'effet Levitation à l'équipe ennemi !\n"}]
execute if score #random switch.data matches 8 run tellraw @a[tag=!detached] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" "},{"selector":"@s"},{"text":" a récuperé le bonus, cela donne l'effet Wither à l'équipe ennemi !\n"}]
execute if score #random switch.data matches 9 run tellraw @a[tag=!detached] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" "},{"selector":"@s"},{"text":" a récuperé le bonus, cela donne l'effet Weakness à l'équipe ennemi !\n"}]
