...
data modify storage switch:main maps_to_choose set value ["traitor_original", "zone_51", "spectre_original"]
...
execute if data storage switch:main {map:"spectre_original"} run spreadplayers 2500 2500 1 100 under 185 false @a
