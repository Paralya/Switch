...
execute if entity @a[scores={switch.alive=1..,switch.temp.role=..4}] run scoreboard players add #game_state switch.data 1
execute if entity @a[scores={switch.alive=1..,switch.temp.role=5}] run scoreboard players add #game_state switch.data 2
execute if entity @a[scores={switch.alive=1..,switch.temp.role=6}] run scoreboard players add #game_state switch.data 4
...
execute if score #game_state switch.data matches 1 as @a[scores={switch.alive=1..,switch.temp.role=..4}] at @s run function switch:engine/add_money
execute if score #game_state switch.data matches 2 as @a[scores={switch.alive=1..,switch.temp.role=5},tag=!switch.traitors_game.big_traitor] at @s run function switch:engine/add_money
execute if score #game_state switch.data matches 4 as @a[scores={switch.alive=1..,switch.temp.role=6}] at @s run function switch:engine/add_money
