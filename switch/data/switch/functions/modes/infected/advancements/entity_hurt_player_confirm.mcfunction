...
execute if score #zombie_attacker switch.data matches 1 run scoreboard players set #damage switch.data 40
execute if score #zombie_attacker switch.data matches 1 on attacker if score @s switch.infected.zombie_damage matches 1 run scoreboard players set #damage switch.data 45
