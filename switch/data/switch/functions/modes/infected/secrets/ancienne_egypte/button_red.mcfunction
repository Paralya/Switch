...
execute if score #random switch.data matches 0 as @p[team=switch.temp.human,distance=..12] run tellraw @a[tag=!detached,distance=..12] [{"text":"<","color":"gray","italic":true},{"selector":"@s","color":"gray","italic":true},{"text":"> Pardonnez-moi, je... compte sur vous pour la suite !"}]
execute if score #random switch.data matches 1 as @p[team=switch.temp.human,distance=..12] run tellraw @a[tag=!detached,distance=..12] [{"text":"<","color":"gray","italic":true},{"selector":"@s","color":"gray","italic":true},{"text":"> Vous êtes vraiment des personnes de confiance, c'est pourquoi je vous confie la suite. Adieu..."}]
