...
execute if score #infected_secret switch.data matches 4 run tellraw @a[tag=!detached] [{"text":"<","color":"gray","italic":true},{"selector":"@s","color":"gray","italic":true},{"text":"> Ahhh, le pot vient d'éclater, la puissance était tellment grande que la porte s'est vue détruite !"}]
execute if score #infected_secret switch.data matches 4 run fill 127123 113 127050 127124 115 127052 air destroy
execute if score #infected_secret switch.data matches 4 positioned 127132 113 127051 as @e[limit=2] as @e[limit=2] as @e[limit=2] run summon creeper
execute if score #infected_secret switch.data matches 4 positioned 127132 113 127051 as @e[limit=2] as @e[limit=2] as @e[limit=2] run summon zombie
...
execute if score #infected_secret switch.data matches 6 run function switch:modes/infected/secrets/drop_element_115
execute if score #infected_secret switch.data matches 6 as @a[team=switch.temp.human] run advancement grant @s only switch:visible/52
execute if score #infected_secret switch.data matches 6 as @a[team=switch.temp.human] run function switch:modes/infected/secrets/check_if_all_secrets
