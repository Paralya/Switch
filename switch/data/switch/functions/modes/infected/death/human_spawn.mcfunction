...
execute unless score @s switch.infected.armor matches 1.. run item replace entity @s armor.chest with leather_chestplate{Unbreakable:1b		,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:1,Operation:0,UUID:[I;26112013,1,1,1],Slot:"chest"}]}
execute if score @s switch.infected.armor matches 1 run item replace entity @s armor.chest with chainmail_chestplate{Unbreakable:1b			,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:2,Operation:0,UUID:[I;26112013,1,1,1],Slot:"chest"}]}
execute if score @s switch.infected.armor matches 2 run item replace entity @s armor.chest with golden_chestplate{Unbreakable:1b			,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:3,Operation:0,UUID:[I;26112013,1,1,1],Slot:"chest"}]}
execute if score @s switch.infected.armor matches 3 run item replace entity @s armor.chest with iron_chestplate{Unbreakable:1b				,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:4,Operation:0,UUID:[I;26112013,1,1,1],Slot:"chest"}]}
execute if score @s switch.infected.armor matches 4 run item replace entity @s armor.chest with diamond_chestplate{Unbreakable:1b			,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:5,Operation:0,UUID:[I;26112013,1,1,1],Slot:"chest"}]}
execute if score @s switch.infected.armor matches 5 run item replace entity @s armor.chest with leather_chestplate{Unbreakable:1b			,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:6,Operation:0,UUID:[I;26112013,1,1,1],Slot:"chest"}],display:{color:546752},CustomModelData:2013115}
