...
execute if score @s switch.infected.armor matches 3 run item replace entity @s armor.chest with iron_chestplate{Unbreakable:1b				,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:7,Operation:0,UUID:[I;26112013,1,1,1],Slot:"chest"}]}
execute if score @s switch.infected.armor matches 4 run item replace entity @s armor.chest with diamond_chestplate{Unbreakable:1b			,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:8,Operation:0,UUID:[I;26112013,1,1,1],Slot:"chest"}]}
execute if score @s switch.infected.armor matches 5 run item replace entity @s armor.chest with leather_chestplate{Unbreakable:1b			,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:10,Operation:0,UUID:[I;26112013,1,1,1],Slot:"chest"}],display:{color:546752},CustomModelData:2013115}
