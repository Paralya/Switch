...
effect give @s[team=!switch.temp.human,team=!switch.temp.zombie] glowing infinite 255 true
item replace entity @s[team=!switch.temp.human,team=!switch.temp.zombie] hotbar.0 with netherite_sword{Enchantments:[{id:"minecraft:sharpness",lvl:2s}]}
attribute @s[team=!switch.temp.human,team=!switch.temp.zombie] generic.max_health base set 40.0

# Leather cap color
item replace entity @s[team=switch.temp.human] armor.head with leather_helmet{display:{color:16711680},Unbreakable:1b,Enchantments:[{id:"minecraft:protection",lvl:2s}],AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:3,Operation:0,UUID:[I;0,-1,-1,0],Slot:"head"},{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Amount:2,Operation:0,UUID:[I;1,-1,-1,-1],Slot:"head"}]}
item replace entity @s[team=switch.temp.human_king] armor.head with leather_helmet{display:{color:16711680},Unbreakable:1b,Enchantments:[{id:"minecraft:protection",lvl:2s}],AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:3,Operation:0,UUID:[I;0,-1,-1,0],Slot:"head"},{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Amount:2,Operation:0,UUID:[I;1,-1,-1,-1],Slot:"head"}]}
item replace entity @s[team=switch.temp.zombie] armor.head with leather_helmet{display:{color:255},Unbreakable:1b,Enchantments:[{id:"minecraft:protection",lvl:2s}],AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:3,Operation:0,UUID:[I;0,-1,-1,0],Slot:"head"},{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Amount:2,Operation:0,UUID:[I;1,-1,-1,-1],Slot:"head"}]}
item replace entity @s[team=switch.temp.zombie_king] armor.head with leather_helmet{display:{color:255},Unbreakable:1b,Enchantments:[{id:"minecraft:protection",lvl:2s}],AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:3,Operation:0,UUID:[I;0,-1,-1,0],Slot:"head"},{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Amount:2,Operation:0,UUID:[I;1,-1,-1,-1],Slot:"head"}]}
