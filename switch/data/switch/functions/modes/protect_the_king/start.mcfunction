...
execute unless data storage switch:main protect_the_king_maps[0] run data modify storage switch:main protect_the_king_maps set value ["traitor_original", "mushroom_plains", "jayl_dark_forest"]
