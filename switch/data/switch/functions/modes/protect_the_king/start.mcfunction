...
execute as @a[tag=!switch.detached,sort=random] at @s run function switch:modes/protect_the_king/roles
function switch:modes/protect_the_king/better_tp
tp @a[tag=!switch.detached,team=switch.temp.red] @p[team=switch.temp.red_king]
tp @a[tag=!switch.detached,team=switch.temp.blue] @p[team=switch.temp.blue_king]
execute as @a[tag=!switch.detached] at @s run function switch:modes/protect_the_king/give_items
