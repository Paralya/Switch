...
execute if score #protect_the_king_seconds switch.data matches 0.. run effect give @a[gamemode=!spectator,team=!switch.temp.red,team=!switch.temp.blue] glowing infinite 255 true
