...
# Advancement
execute if score #game_state switch.data matches 1 as @a[tag=!detached,gamemode=!spectator,team=switch.temp.red_king] unless entity @a[tag=!detached,gamemode=!spectator,team=switch.temp.red] run advancement grant @s only switch:visible/14
execute if score #game_state switch.data matches 2 as @a[tag=!detached,gamemode=!spectator,team=switch.temp.blue_king] unless entity @a[tag=!detached,gamemode=!spectator,team=switch.temp.blue] run advancement grant @s only switch:visible/14
