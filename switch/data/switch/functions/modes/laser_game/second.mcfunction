...
execute if score #laser_game_seconds switch.data matches 10 if data storage switch:main {map:"operation_pigclaw"} run summon item_frame 36041 122 36011 {Tags:["switch.laser_game.base"],Facing:5b,Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Glowing:1b}
...
execute if score #base_reload switch.data matches 0 run setblock 36041 122 36011 iron_trapdoor[powered=true,open=true,facing=east]
execute if score #base_reload switch.data matches 0 run setblock 36041 122 36012 iron_trapdoor[powered=true,open=true,facing=east]
...
execute if score #base_reload switch.data matches 1.. run setblock 36041 122 36011 dark_oak_trapdoor[powered=true,open=true,facing=east]
