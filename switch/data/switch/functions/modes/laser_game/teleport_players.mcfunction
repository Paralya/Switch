...
gamemode adventure @a[tag=!switch.detached,gamemode=!adventure]
...
execute if score #team_boolean switch.data matches 0 if data storage switch:main {map:"operation_pigclaw"} in overworld run tp @s 36117 151 35926 45 0
execute if score #team_boolean switch.data matches 0 if data storage switch:main {map:"nuketown"} in overworld run tp @s 72032 111 72077 -90 0
...
execute if score #team_boolean switch.data matches 1 if data storage switch:main {map:"operation_pigclaw"} in overworld run tp @s 35934 136 36074 -135 0
execute if score #team_boolean switch.data matches 1 if data storage switch:main {map:"nuketown"} in overworld run tp @s 72174 111 72091 90 0
