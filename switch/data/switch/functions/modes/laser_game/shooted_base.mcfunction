...
execute if score #color switch.data matches 0 run tellraw @a[tag=!detached,scores={switch.alive=11}] [{"selector":"@s"},{"text":" a tiré sur la base de bonus !","color":"green"}]
execute if score #color switch.data matches 1 run tellraw @a[tag=!detached,scores={switch.alive=10}] [{"selector":"@s"},{"text":" a tiré sur la base de bonus !","color":"green"}]
execute as @a[tag=!detached] at @s run playsound entity.player.levelup ambient @s

execute if score #color switch.data matches 0 run tag @a[tag=!detached,scores={switch.alive=10}] add switch.message
execute if score #color switch.data matches 1 run tag @a[tag=!detached,scores={switch.alive=11}] add switch.message
...
execute if score #random switch.data matches 2 if score #color switch.data matches 0 run effect give @a[tag=!detached,scores={switch.alive=11}] darkness 5 255 true
execute if score #random switch.data matches 2 if score #color switch.data matches 1 run effect give @a[tag=!detached,scores={switch.alive=10}] darkness 5 255 true
execute if score #random switch.data matches 3 if score #color switch.data matches 0 run effect give @a[tag=!detached,scores={switch.alive=11}] glowing 5 255 true
execute if score #random switch.data matches 3 if score #color switch.data matches 1 run effect give @a[tag=!detached,scores={switch.alive=10}] glowing 5 255 true
...
execute if score #random switch.data matches 5 if score #color switch.data matches 0 run effect give @a[tag=!detached,scores={switch.alive=10}] speed 15 1 true
execute if score #random switch.data matches 5 if score #color switch.data matches 1 run effect give @a[tag=!detached,scores={switch.alive=11}] speed 15 1 true
