...
execute if score #process_end switch.data matches 1 if score #detect_end switch.data matches 1 as @a[scores={switch.temp.lives=1..}] at @s run function switch:engine/add_money
