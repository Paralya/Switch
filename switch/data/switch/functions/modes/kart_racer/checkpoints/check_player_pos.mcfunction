...
# tellraw @a[tag=!detached] [{"text":"#x : ","color":"yellow"},{"score":{"name":"#x","objective":"switch.data"},"color":"aqua"},{"text":", #y : "},{"score":{"name":"#y","objective":"switch.data"},"color":"aqua"},{"text":", #z : "},{"score":{"name":"#z","objective":"switch.data"},"color":"aqua"}]
# tellraw @a[tag=!detached] [{"text":"#dx : ","color":"yellow"},{"score":{"name":"#dx","objective":"switch.data"},"color":"aqua"},{"text":", #dy : "},{"score":{"name":"#dy","objective":"switch.data"},"color":"aqua"},{"text":", #dz : "},{"score":{"name":"#dz","objective":"switch.data"},"color":"aqua"}]
# tellraw @a[tag=!detached] [{"text":"#px : ","color":"yellow"},{"score":{"name":"#px","objective":"switch.data"},"color":"aqua"},{"text":", #py : "},{"score":{"name":"#py","objective":"switch.data"},"color":"aqua"},{"text":", #pz : "},{"score":{"name":"#pz","objective":"switch.data"},"color":"aqua"}]
