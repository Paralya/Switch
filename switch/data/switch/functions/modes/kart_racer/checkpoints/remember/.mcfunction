...
data modify storage switch:main temp set value {id:0,Pos:[0.d,0.d,0.d],Rotation:[0.f,0.f],Motion:[0.d,0.d,0.d],Tags:[],scores:{shopping_kart:{engine:0,max_engine:0,motion_x:0,motion_z:0,predicted_pos_x:0,predicted_pos_z:0,old_pos_x:0,old_pos_y:0,old_pos_z:0,booster_timer:0,reactor_boost:0}}}
execute as @e[tag=shopping_kart.kart,predicate=shopping_kart:have_player_passenger] run function switch:modes/kart_racer/checkpoints/remember/get_from_kart
