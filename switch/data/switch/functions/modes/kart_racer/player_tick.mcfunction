...
execute if score #success switch.data matches 0 store success score #success switch.data unless data entity @s Inventory[0].tag.switch.classic_respawn
execute if score #success switch.data matches 0 store success score #success switch.data unless data entity @s Inventory[1].tag.switch.hard_respawn
execute if score #success switch.data matches 0 store success score #success switch.data unless data entity @s Inventory[2].tag.switch.enable_collisions
execute if score #success switch.data matches 0 store success score #success switch.data unless data entity @s Inventory[3].tag.switch.change_map
