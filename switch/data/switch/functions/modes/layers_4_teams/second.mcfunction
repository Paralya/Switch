...
execute if score #mins switch.data matches ..4 as @e[tag=switch.layers_4_teams.marker] at @s run tp @s ~ ~-0.35 ~
execute if score #mins switch.data matches ..4 as @e[tag=switch.layers_4_teams.marker] at @s if entity @s[y=100,dy=5] run kill @s
