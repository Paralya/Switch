...
execute if entity @a[gamemode=!spectator,team=switch.temp.red] unless entity @a[gamemode=!spectator,team=!switch.temp.red] run scoreboard players set #game_state switch.data 1
execute if entity @a[gamemode=!spectator,team=switch.temp.blue] unless entity @a[gamemode=!spectator,team=!switch.temp.blue] run scoreboard players set #game_state switch.data 2
execute if entity @a[gamemode=!spectator,team=switch.temp.green] unless entity @a[gamemode=!spectator,team=!switch.temp.green] run scoreboard players set #game_state switch.data 3
execute if entity @a[gamemode=!spectator,team=switch.temp.yellow] unless entity @a[gamemode=!spectator,team=!switch.temp.yellow] run scoreboard players set #game_state switch.data 4
execute unless entity @a[gamemode=!spectator] run scoreboard players set #game_state switch.data 5
...
execute if score #game_state switch.data matches 3 as @a[gamemode=!spectator,team=switch.temp.green] at @s run function switch:engine/add_money
execute if score #game_state switch.data matches 4 as @a[gamemode=!spectator,team=switch.temp.yellow] at @s run function switch:engine/add_money
