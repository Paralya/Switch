...
execute if score #state switch.data matches 0 run tellraw @s {"text":"Test Mode ON","color":"green"}
...
execute if score #state switch.data matches 1 run tellraw @s {"text":"Test Mode OFF","color":"red"}
