...
execute if data entity @s Inventory[].components."minecraft:custom_data".switch.detective_bow run summon item_display ~ ~1 ~ {item:{id:"minecraft:bow",count:1},Tags:["switch.detective_bow"],Glowing:1b}
