...
execute rotated ~ 0 run summon armor_stand ^ ^1.5 ^1.5 {Tags:["switch.thrown"],Marker:1b,Invisible:1b,Passengers:[{id:"minecraft:item_display",item:{id:"minecraft:golden_sword",count:1},item_display:"firstperson_righthand",Tags:["switch.thrown"]}]}
