...
execute if score @s switch.temp.throw_reload matches 0 if data entity @s SelectedItem{id:"golden_sword"} run function switch:modes/murder_mystery/throw/init
