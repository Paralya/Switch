...
item replace entity @s hotbar.2 with bow[custom_name='{"text":"Archer","color":"red","italic":false}',custom_model_data=2013149,custom_data={switch:{class_item:2b,rtp_class:true}},food={nutrition:0,saturation:0,can_always_eat:true,eat_seconds:1024}]
