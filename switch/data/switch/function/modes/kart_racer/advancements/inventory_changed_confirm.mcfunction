...
execute if score #success switch.data matches 1 if score #can_vote switch.data matches 1 run item replace entity @s hotbar.7 with warped_fungus_on_a_stick{CustomModelData:2012111,switch:{enable_collisions:1b,vote:1b},Unbreakable:1b,display:{Name:'{"text":"Voter pour activer les collisions joueurs","color":"yellow","italic":false}'}}
execute if score #success switch.data matches 1 if score #can_vote switch.data matches 1 run item replace entity @s hotbar.8 with warped_fungus_on_a_stick{CustomModelData:2013219,switch:{change_map:1b,vote:1b},Unbreakable:1b,display:{Name:'{"text":"Voter pour changer de map","color":"yellow","italic":false}'}}
