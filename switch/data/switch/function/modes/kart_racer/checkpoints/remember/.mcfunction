...
execute as @e[tag=shopping_kart.kart,predicate=shopping_kart:have_temp_player_passenger] run function switch:modes/kart_racer/checkpoints/remember/get_from_kart
