...
execute if score #success switch.data matches 1 if data storage switch:main {map:"area_51"} run data modify storage switch:temp input set value {Slot:7b,count:1,with:'redstone_torch{switch:{redstone_torch:1b},CanPlaceOn:["cracked_polished_blackstone_bricks"]}'}
execute if score #success switch.data matches 1 if data storage switch:main {map:"ancienne_egypte_2013"} run data modify storage switch:temp input set value {Slot:7b,count:1,with:'redstone_torch{switch:{redstone_torch:1b},CanPlaceOn:["red_sandstone"]}'}
...
execute if score #success switch.data matches 1 run data modify storage switch:temp input set value {Slot:7b,count:1,with:'potion{switch:{water_bottle:1b},display:{Name:\'{"text":"Zombie blood","italic":false,"color":"light_purple"}\',Lore:[\'{"text":"Infected","italic":true,"color":"dark_green"}\']}}'}
execute if score #success switch.data matches 1 run data modify storage switch:temp input.Slot set from storage switch:temp temp.Slot
execute if score #success switch.data matches 1 run data modify storage switch:temp input.count set from storage switch:temp temp.count
execute if score #success switch.data matches 1 run function switch:modes/infected/advancements/macro_slot with storage switch:temp input
...
execute if score #success switch.data matches 1 run data modify storage switch:temp input set value {Slot:7b,count:1,with:'tnt{switch:{tnt:1b},CanPlaceOn:["scaffolding"],display:{Name:\'{"text":"TNT","italic":false,"color":"light_purple"}\',Lore:[\'{"text":"Infected","italic":true,"color":"dark_green"}\']}}'}
execute if score #success switch.data matches 1 run data modify storage switch:temp input.Slot set from storage switch:temp temp.Slot
execute if score #success switch.data matches 1 run data modify storage switch:temp input.count set from storage switch:temp temp.count
execute if score #success switch.data matches 1 run function switch:modes/infected/advancements/macro_slot with storage switch:temp input
...
execute if score #success switch.data matches 1 run data modify storage switch:temp input set value {Slot:7b,count:1,with:'flint_and_steel{switch:{flint_and_steel:1b},CanPlaceOn:["tnt"],display:{Name:\'{"text":"Flint and steel","italic":false,"color":"light_purple"}\',Lore:[\'{"text":"Infected","italic":true,"color":"dark_green"}\']}}'}
execute if score #success switch.data matches 1 run data modify storage switch:temp input.Slot set from storage switch:temp temp.Slot
execute if score #success switch.data matches 1 run data modify storage switch:temp input.count set from storage switch:temp temp.count
execute if score #success switch.data matches 1 run function switch:modes/infected/advancements/macro_slot with storage switch:temp input
...
execute if score #success switch.data matches 1 run data modify storage switch:temp input set value {Slot:7b,count:1,with:'beacon{switch:{beacon:1b},CanPlaceOn:["gold_block"],display:{Name:\'{"text":"Bacon","italic":false,"color":"light_purple"}\',Lore:[\'{"text":"Infected","italic":true,"color":"dark_green"}\']}}'}
execute if score #success switch.data matches 1 run data modify storage switch:temp input.Slot set from storage switch:temp temp.Slot
execute if score #success switch.data matches 1 run data modify storage switch:temp input.count set from storage switch:temp temp.count
execute if score #success switch.data matches 1 run function switch:modes/infected/advancements/macro_slot with storage switch:temp input
