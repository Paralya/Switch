...
# Items to pickup
execute if score #infected_secret switch.data matches 0..16 unless entity @e[type=item,tag=switch.infected.pickaxe] run summon item 129014 104 129014 {Tags:["switch.infected.pickaxe","switch.infected.item"],Item:{id:"minecraft:diamond_pickaxe",Count:1b,components:{"minecraft:can_break":{blocks:["obsidian"]},"minecraft:damage":23,"minecraft:item_name":'{"text":"Pioche en diamant","italic":false,"color":"light_purple"}',"minecraft:lore":['{"text":"Infected","italic":true,"color":"dark_green"}']}}}
execute if score #infected_secret switch.data matches 0..16 unless entity @e[type=item,tag=switch.infected.nether_star] run summon item 129018 138 129082 {Tags:["switch.infected.nether_star","switch.infected.item"],Item:{id:"minecraft:nether_star",Count:1b,components:{"minecraft:item_name":'{"text":"Étoile du nether","italic":false,"color":"light_purple"}',"minecraft:lore":['{"text":"Infected","italic":true,"color":"dark_green"}']}}}
execute if score #infected_secret switch.data matches 0..16 unless entity @e[type=item,tag=switch.infected.glass] run summon item 129035 113 129095 {Tags:["switch.infected.glass","switch.infected.item"],Item:{id:"minecraft:glass",Count:5b,components:{"minecraft:item_name":'{"text":"Carreau carré","italic":false,"color":"light_purple"}',"minecraft:lore":['{"text":"Infected","italic":true,"color":"dark_green"}']}}}
