...
# Death system
execute if score #bombardement_seconds switch.data matches ..-1 in minecraft:overworld run tp @a[tag=!detached,gamemode=!spectator,predicate=switch:in_water] 121057 110 121064 180 -30
