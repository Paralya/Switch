...
execute if score #random switch.data matches 1 run summon armor_stand 121054 132 121026 {NoGravity:1b,Silent:1b,Invulnerable:1b,Invisible:1b,Tags:["switch.ball","switch.new"],Passengers:[{id:"minecraft:item_display",transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,-1.5f,0f],scale:[1f,1f,1f]},item:{id:"minecraft:coal_block",count:1}}]}
