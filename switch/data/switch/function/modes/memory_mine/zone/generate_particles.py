...
with open("particles.mcfunction", "w") as f:
	...
	for i in range(N_points):
		...
		f.write(f"particle dust{{color:[0.0,1.0,0.0],scale:1.0}} ~{round(x, 5)} ~ ~{round(z, 5)} 0 0 0 0 5 force @a[distance=..50]\n")
	f.write(f"""particle dust{{color:[0.0,0.75,0.0],scale:2.0}} ~ ~ ~ 2 0 2 0 10 force @a[distance=..50]
