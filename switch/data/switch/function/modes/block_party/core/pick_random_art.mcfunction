...
execute if predicate switch:chance/0.33 at @e[tag=switch.selected_map,limit=1] run summon ravager ~ ~ ~ {Invulnerable:true,CustomName:'{"text":"Vachette","color":"red"}',CustomNameVisible:true,Tags:["switch.ravager"],DeathLootTable:"none"}
