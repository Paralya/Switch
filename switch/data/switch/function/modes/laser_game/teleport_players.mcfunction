...
execute if score #team_boolean switch.data matches 0 if data storage switch:main {map:"laser_game"} in minecraft:overworld run tp @s 549 101 501 45 0
...
execute if score #team_boolean switch.data matches 1 if data storage switch:main {map:"laser_game"} in minecraft:overworld run tp @s 501 101 549 -135 0
