...
execute if score #random switch.data matches 7 if data storage switch:main {map:"luxio_fish_fight"} run summon axolotl 151026 130 151026 {Glowing:1b,Health:6f,CustomNameVisible:1b,CustomName:'{"text":"Axobonus","color":"light_purple","bold":true}',active_effects:[{id:"slow_falling",amplifier:10b,duration:2000,show_particles:0b}]}
execute if score #random switch.data matches 7 if data storage switch:main {map:"luxio_fish_fight"} run summon axolotl 151026 130 151026 {Glowing:1b,Health:6f,CustomNameVisible:1b,CustomName:'{"text":"Axobonus","color":"light_purple","bold":true}',active_effects:[{id:"slow_falling",amplifier:10b,duration:2000,show_particles:0b}]}
execute if score #random switch.data matches 7 if data storage switch:main {map:"luxio_fish_fight"} run summon axolotl 151026 130 151026 {Glowing:1b,Health:6f,CustomNameVisible:1b,CustomName:'{"text":"Axobonus","color":"light_purple","bold":true}',active_effects:[{id:"slow_falling",amplifier:10b,duration:2000,show_particles:0b}]}

execute if score #random switch.data matches 7 if data storage switch:main {map:"airdox_fish_fight"} run summon axolotl 155993 152 156013 {Glowing:1b,Health:6f,CustomNameVisible:1b,CustomName:'{"text":"Axobonus","color":"light_purple","bold":true}',active_effects:[{id:"slow_falling",amplifier:10b,duration:2000,show_particles:0b}]}
execute if score #random switch.data matches 7 if data storage switch:main {map:"airdox_fish_fight"} run summon axolotl 155993 152 156013 {Glowing:1b,Health:6f,CustomNameVisible:1b,CustomName:'{"text":"Axobonus","color":"light_purple","bold":true}',active_effects:[{id:"slow_falling",amplifier:10b,duration:2000,show_particles:0b}]}
execute if score #random switch.data matches 7 if data storage switch:main {map:"airdox_fish_fight"} run summon axolotl 155983 164 155995 {Glowing:1b,Health:6f,CustomNameVisible:1b,CustomName:'{"text":"Axobonus","color":"light_purple","bold":true}',active_effects:[{id:"slow_falling",amplifier:10b,duration:2000,show_particles:0b}]}
execute if score #random switch.data matches 7 if data storage switch:main {map:"airdox_fish_fight"} run summon axolotl 155983 164 155995 {Glowing:1b,Health:6f,CustomNameVisible:1b,CustomName:'{"text":"Axobonus","color":"light_purple","bold":true}',active_effects:[{id:"slow_falling",amplifier:10b,duration:2000,show_particles:0b}]}
