...
execute if score #points switch.data matches 5 run summon firework_rocket ~ ~1 ~ {LifeTime:30,FireworksItem:{id:"firework_rocket",Count:1,components:{"minecraft:fireworks":{"flight_duration":2},"minecraft:firework_explosion":{"shape":"star","has_trail":true,"has_flicker":true,"colors":[3789123]}}}}
...
execute if score #points switch.data matches 1..4 run summon firework_rocket ~ ~1 ~ {LifeTime:10,FireworksItem:{id:"firework_rocket",Count:1,components:{"minecraft:fireworks":{"flight_duration":2},"minecraft:firework_explosion":{"shape":"star","has_trail":true,"has_flicker":true,"colors":[5631]}}}}
