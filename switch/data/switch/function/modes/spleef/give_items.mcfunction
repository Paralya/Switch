...
data modify block 0 0 0 Items append value {id:"minecraft:white_shulker_box",Count:1b,Slot:1b,components:{"minecraft:item_name":'{"text":"Powder Snow","color":"white","italic":false}'}}
