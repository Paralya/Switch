...
data modify storage switch:glassrunner ItemsNBT.snowball_bridge_red set value {id:"minecraft:snowball",count:1,components:{"minecraft:custom_data":{glassrunner:{glass_bridge:1b,glass_bridge_red:1b}},"minecraft:item_name":'{"text":"Snowball Bridge Red","color":"red","italic":false}'}}
data modify storage switch:glassrunner ItemsNBT.snowball_bridge_blue set value {id:"minecraft:snowball",count:1,components:{"minecraft:custom_data":{glassrunner:{glass_bridge:1b,glass_bridge_blue:1b}},"minecraft:item_name":'{"text":"Snowball Bridge Blue","color":"blue","italic":false}'}}
data modify storage switch:glassrunner ItemsNBT.renforced_snowball_bridge_red set value {id:"minecraft:snowball",count:1,components:{"minecraft:custom_data":{glassrunner:{glass_bridge:1b,renforced_glass_bridge_red:1b}},"minecraft:item_name":'{"text":"Renforced Snowball Bridge","color":"red","italic":false}'}}
data modify storage switch:glassrunner ItemsNBT.renforced_snowball_bridge_blue set value {id:"minecraft:snowball",count:1,components:{"minecraft:custom_data":{glassrunner:{glass_bridge:1b,renforced_glass_bridge_blue:1b}},"minecraft:item_name":'{"text":"Renforced Snowball Bridge","color":"blue","italic":false}'}}
data modify storage switch:glassrunner ItemsNBT.destroying_crossbow set value {id:"minecraft:crossbow",count:1,components:{"minecraft:custom_data":{glassrunner:{destroying_crossbow:1b}},"minecraft:item_name":'{"text":"Destroying Crossbow","color":"dark_red","italic":false}'}}
