...
data modify storage switch:glassrunner ItemsNBT.snowball_bridge_red set value {id:"minecraft:snowball",Count:1b,components:{"minecraft:custom_data":{glassrunner:{glass_bridge:1b,glass_bridge_red:1b}},"minecraft:item_name":'{"text":"Snowball Bridge Red","color":"red","italic":false}'}}
data modify storage switch:glassrunner ItemsNBT.snowball_bridge_blue set value {id:"minecraft:snowball",Count:1b,components:{"minecraft:custom_data":{glassrunner:{glass_bridge:1b,glass_bridge_blue:1b}},"minecraft:item_name":'{"text":"Snowball Bridge Blue","color":"blue","italic":false}'}}
data modify storage switch:glassrunner ItemsNBT.renforced_snowball_bridge_red set value {id:"minecraft:snowball",Count:1b,components:{"minecraft:custom_data":{glassrunner:{glass_bridge:1b,renforced_glass_bridge_red:1b}},"minecraft:item_name":'{"text":"Renforced Snowball Bridge","color":"red","italic":false}'}}
data modify storage switch:glassrunner ItemsNBT.renforced_snowball_bridge_blue set value {id:"minecraft:snowball",Count:1b,components:{"minecraft:custom_data":{glassrunner:{glass_bridge:1b,renforced_glass_bridge_blue:1b}},"minecraft:item_name":'{"text":"Renforced Snowball Bridge","color":"blue","italic":false}'}}
data modify storage switch:glassrunner ItemsNBT.destroying_crossbow set value {id:"minecraft:crossbow",Count:1b,components:{"minecraft:custom_data":{glassrunner:{destroying_crossbow:1b}},"minecraft:item_name":'{"text":"Destroying Crossbow","color":"dark_red","italic":false}'}}
data modify storage switch:glassrunner ItemsNBT.bow set value {id:"minecraft:bow",Count:1b,components:{"minecraft:custom_data":{ctc:{id:"glassrunner:bow"}},"minecraft:unbreakable":{},"minecraft:enchantments":{"levels":{"minecraft:knockback":5,"minecraft:punch":5}},"minecraft:can_break":{"blocks":["minecraft:glass","minecraft:red_stained_glass","minecraft:blue_stained_glass","minecraft:pink_stained_glass","minecraft:light_blue_stained_glass"]}}}
data modify storage switch:glassrunner ItemsNBT.fireball_wand set value {id:"minecraft:warped_fungus_on_a_stick",Count:1b,components:{"minecraft:custom_data":{ctc:{id:"glassrunner:fireball_wand"},glassrunner:{fireball_wand:1b}},"minecraft:custom_model_data":4220108,"minecraft:item_name":'{"text":"Fireball Wand","color":"dark_red","italic":false}',"minecraft:lore":['{"text":"Fait spawn une fireball devant vous qui détruit tout sur son passage","color":"dark_gray","italic":false}','[{"text":"Prix : ","color":"dark_gray","italic":false},{"text":"15 pièces","color":"gold","italic":false}]']}}
