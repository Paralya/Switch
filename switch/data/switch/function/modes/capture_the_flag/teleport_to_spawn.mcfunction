...
item replace entity @s hotbar.0 with diamond_chestplate[custom_name='{"text":"Tank","color":"red","italic":false}',custom_data={switch:{class_item:1b}}]
item replace entity @s hotbar.2 with iron_sword[custom_name='{"text":"Warrior","color":"red","italic":false}',custom_data={switch:{class_item:2b}}]
item replace entity @s hotbar.4 with crossbow[custom_name='{"text":"Archer","color":"red","italic":false}',custom_data={switch:{class_item:3b}}]
item replace entity @s hotbar.6 with tnt[custom_name='{"text":"Demolisher","color":"red","italic":false}',custom_data={switch:{class_item:4b}}]
item replace entity @s hotbar.8 with glass_bottle[custom_name='{"text":"Chemister","color":"red","italic":false}',custom_data={switch:{class_item:5b}}]
