...
execute if score #random switch.data matches 6 run give @s netherite_shovel[enchantments={efficiency:10},custom_name='{"text":"Teuse","color":"gold","italic":false}',lore=['{"text":"C\'est la pelle Teuse MDR !","color":"white","italic":false}']]
execute if score #random switch.data matches 7 run give @s golden_sword[damage=30,enchantments={knockback:10},custom_name='{"text":"Baseball Bat","color":"gold","italic":false}',lore=['{"text":"Excitant n\'est-ce pas ?","color":"white","italic":false}']]
...
execute if score #random switch.data matches 20 run give @s pufferfish_spawn_egg[custom_name='{"text":"Bubulle","color":"yellow","italic":false}'] 8
