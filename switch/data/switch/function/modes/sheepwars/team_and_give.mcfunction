...
item replace entity @s hotbar.1 with bow{CanDestroy:["#realistic_explosion:all"],Enchantments:[{id:"infinity",lvl:1s}],Unbreakable:1b,HideFlags:8}
...
# Kit Better Bow
execute if score @s switch.sheepwars.choosen_kit matches 2 run item replace entity @s hotbar.1 with bow{CanDestroy:["#realistic_explosion:all"],Enchantments:[{id:"infinity",lvl:1s}],Unbreakable:1b,HideFlags:8,CustomModelData:2013149}
# Kit Better Sword
