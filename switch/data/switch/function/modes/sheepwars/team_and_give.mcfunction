...
## Shop things
# Kit More Health
execute if score @s switch.sheepwars.choosen_kit matches 1 run item replace entity @s armor.chest with chainmail_chestplate[unbreakable={},attribute_modifiers=[{type:"generic.armor",slot:"chest",id:"switch.armor",amount:3,operation:"add_value"}]]
...
# Kit Better Sword
execute if score @s switch.sheepwars.choosen_kit matches 3 unless score @s switch.sheepwars.kit_sword matches 1.. run item replace entity @s hotbar.0 with stone_sword[unbreakable={},can_break={predicates:[{blocks:"#realistic_explosion:all"}],show_in_tooltip:0b},attribute_modifiers=[{type:"generic.attack_damage",slot:"mainhand",id:"switch.attack_damage",amount:0.42,operation:"add_value"}]]
execute if score @s switch.sheepwars.choosen_kit matches 3 if score @s switch.sheepwars.kit_sword matches 1 run item replace entity @s hotbar.0 with stone_sword[unbreakable={},can_break={predicates:[{blocks:"#realistic_explosion:all"}],show_in_tooltip:0b},attribute_modifiers=[{type:"generic.attack_damage",slot:"mainhand",id:"switch.attack_damage",amount:0.44,operation:"add_value"}]]
execute if score @s switch.sheepwars.choosen_kit matches 3 if score @s switch.sheepwars.kit_sword matches 2 run item replace entity @s hotbar.0 with stone_sword[unbreakable={},can_break={predicates:[{blocks:"#realistic_explosion:all"}],show_in_tooltip:0b},attribute_modifiers=[{type:"generic.attack_damage",slot:"mainhand",id:"switch.attack_damage",amount:0.46,operation:"add_value"}]]
execute if score @s switch.sheepwars.choosen_kit matches 3 if score @s switch.sheepwars.kit_sword matches 3 run item replace entity @s hotbar.0 with stone_sword[unbreakable={},can_break={predicates:[{blocks:"#realistic_explosion:all"}],show_in_tooltip:0b},attribute_modifiers=[{type:"generic.attack_damage",slot:"mainhand",id:"switch.attack_damage",amount:0.48,operation:"add_value"}]]
