...
data modify storage switch:temp input set value {tick:0,name:"never_be_alone"}
...
execute if score #temp switch.data >= #never_be_alone switch.music.progress run function switch:music/music_over
