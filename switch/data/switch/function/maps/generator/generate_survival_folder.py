...
## This file is generated by the 'generate_survival_folder.py' script
## Do not edit this file but the script instead
execute if data storage switch:maps to_regenerate{{{survival_maps[-1]}:true}} run schedule function switch:maps/loop_scan_doors_of_every_maps 1t
execute if data storage switch:maps to_regenerate{{{survival_maps[0]}:true}} run function switch:maps/survival/{survival_maps[0]}/scan_doors
""")
	for i in range(1, len(survival_maps)):
		previous_map = survival_maps[i - 1]
		current_map = survival_maps[i]
		f.write(f"execute unless data storage switch:maps to_regenerate.{previous_map} if data storage switch:maps to_regenerate{{{current_map}:true}} run function switch:maps/survival/{current_map}/scan_doors\n")
