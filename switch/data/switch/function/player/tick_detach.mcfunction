...
execute if dimension minecraft:overworld run gamemode adventure @s[gamemode=!adventure,tag=!can_creative]
...
execute unless score #inventory switch.data matches 13 run item replace entity @s inventory.4 with pink_concrete[custom_name='{"text":"Pink Jump","color":"light_purple","italic":false}',lore=['{"text":"by OfChara","color":"gray","italic":false}'],custom_data={switch:{jump:true,jump_pink:true}}]
execute unless score #inventory switch.data matches 13 run item replace entity @s inventory.5 with bricks[custom_name='{"text":"Bricks Jump","color":"#BC4A3C","italic":false}',lore=['{"text":"by Thitanas","color":"gray","italic":false}'],custom_data={switch:{jump:true,jump_bricks:true}}]
execute unless score #inventory switch.data matches 13 run item replace entity @s inventory.10 with lime_concrete[custom_name='{"text":"Green Jump","color":"green","italic":false}',lore=['{"text":"by Stoupy51","color":"gray","italic":false}'],custom_data={switch:{jump:true,jump_green:true}}]
execute unless score #inventory switch.data matches 13 run item replace entity @s inventory.11 with white_concrete[custom_name='{"text":"White Jump","color":"white","italic":false}',lore=['{"text":"by Stoupy51","color":"gray","italic":false}'],custom_data={switch:{jump:true,jump_white:true}}]
execute unless score #inventory switch.data matches 13 run item replace entity @s inventory.12 with blue_concrete[custom_name='{"text":"Blue Jump","color":"blue","italic":false}',lore=['{"text":"by Stoupy51","color":"gray","italic":false}'],custom_data={switch:{jump:true,jump_blue:true}}]
execute unless score #inventory switch.data matches 13 run item replace entity @s inventory.13 with yellow_concrete[custom_name='{"text":"Yellow Jump","color":"yellow","italic":false}',lore=['{"text":"by ArtiGrrr","color":"gray","italic":false}'],custom_data={switch:{jump:true,jump_yellow:true}}]
execute unless score #inventory switch.data matches 13 run item replace entity @s inventory.14 with red_concrete[custom_name='{"text":"Red Jump","color":"red","italic":false}',lore=['{"text":"by Stoupy51","color":"gray","italic":false}'],custom_data={switch:{jump:true,jump_red:true}}]
execute unless score #inventory switch.data matches 13 run item replace entity @s inventory.15 with brown_concrete[custom_name='{"text":"Brown Jump","color":"#8B4513","italic":false}',lore=['{"text":"by OfChara","color":"gray","italic":false}'],custom_data={switch:{jump:true,jump_brown:true}}]
execute unless score #inventory switch.data matches 13 run item replace entity @s inventory.16 with purple_concrete[custom_name='{"text":"Purple Jump","color":"light_purple","italic":false}',lore=['{"text":"by AirDox","color":"gray","italic":false}'],custom_data={switch:{jump:true,jump_purple:true}}]
execute unless score #inventory switch.data matches 13 run item replace entity @s inventory.21 with copper_block[custom_name='{"text":"Duality Jump","color":"#B87333","italic":false}',lore=['{"text":"by Stoupy51 / AirDox / OfChara","color":"gray","italic":false}'],custom_data={switch:{jump:true,jump_duality:true}}]
execute unless score #inventory switch.data matches 13 run item replace entity @s inventory.22 with suspicious_gravel[custom_name='{"text":"GraviGlitch Jump","color":"#676767","italic":false}',lore=['{"text":"by OfChara / Stoupy51","color":"gray","italic":false}'],custom_data={switch:{jump:true,jump_graviglitch:true}}]
execute unless score #inventory switch.data matches 13 run item replace entity @s inventory.23 with crying_obsidian[custom_name='{"text":"Obsidian Jump","color":"dark_gray","italic":false}',lore=['{"text":"by Stoupy51","color":"gray","italic":false}'],custom_data={switch:{jump:true,jump_obsidian:true}}]
