...
def write_translations() -> None:
	...
	path: str = "switch:player/translations"
...
execute if score #engine_state switch.data matches 3 run title @a[tag=detached,scores={switch.lang=0}] actionbar [{"nbt":"current_game_name","storage":"switch:main","interpret":true,"color":"yellow"},{"text":" en cours","color":"aqua"},{"text":" | ","color":"gray"},{"score":{"name":"#players_in_game","objective":"switch.data"}},{"text":" joueurs en jeu","color":"aqua"}]
...
execute if score #engine_state switch.data matches 3 run title @a[tag=detached,scores={switch.lang=1}] actionbar [{"nbt":"current_game_name","storage":"switch:main","interpret":true,"color":"yellow"},{"text":" in progress","color":"aqua"},{"text":" | ","color":"gray"},{"score":{"name":"#players_in_game","objective":"switch.data"}},{"text":" players in game","color":"aqua"}]
""")

	# /joined
	write_function(f"{path}/joined", r"""
# French
...
""")
	...
	# /trigger_attach_
	write_function(f"{path}/trigger_attach_", """
# French
...
""")
	...
	write_function(f"{path}/trigger_attach_real_attach", r"""
# French
...
""")
	...
	write_function(f"{path}/trigger_coupdetat_error", """
# French
...
""")
	...
	# /trigger_help_
	write_function(f"{path}/trigger_help_", r"""
# French
tellraw @s[scores={switch.lang=0,switch.trigger.help=-11..}] ["\n",{"nbt":"ParalyaHelp","storage":"switch:main","interpret":true},{"text":" Page d'aide n°1/1 :"}]
tellraw @s[scores={switch.lang=0,switch.trigger.help=-11..}] ["",{"text":"➤ ","color":"gold"},{"text":"/money [<joueur>] : ","color":"yellow"},{"text":"Affiche votre argent actuel ou celui d'un joueur"}]
tellraw @s[scores={switch.lang=0,switch.trigger.help=-11..}] ["",{"text":"➤ ","color":"gold"},{"text":"/shop : ","color":"yellow"},{"text":"Accède à la boutique cosmétique"}]
tellraw @s[scores={switch.lang=0,switch.trigger.help=-11..}] ["",{"text":"➤ ","color":"gold"},{"text":"/detach ou /spawn : ","color":"yellow"},{"text":"Vous détache du moteur Switch"}]
tellraw @s[scores={switch.lang=0,switch.trigger.help=-11..}] ["",{"text":"➤ ","color":"gold"},{"text":"/attach : ","color":"yellow"},{"text":"Vous re-attache au moteur Switch"}]
tellraw @s[scores={switch.lang=0,switch.trigger.help=-11..}] ["",{"text":"➤ ","color":"gold"},{"text":"/stats [<joueur>] : ","color":"yellow"},{"text":"Affiche vos statistiques ou celles d'un joueur"}]
tellraw @s[scores={switch.lang=0,switch.trigger.help=-11..}] ["",{"text":"➤ ","color":"gold"},{"text":"/succes [<joueur>] : ","color":"yellow"},{"text":"Affiche l'intégralité des succès d'un joueur"}]
tellraw @s[scores={switch.lang=0,switch.trigger.help=-11..}] ["",{"text":"➤ ","color":"gold"},{"text":"/rating : ","color":"yellow"},{"text":"Affiche les notes des mini-jeux"}]
...
tellraw @s[scores={switch.lang=1,switch.trigger.help=-11..}] ["",{"text":"➤ ","color":"gold"},{"text":"/money [<player>]: ","color":"yellow"},{"text":"Display your current money or a player's money"}]
tellraw @s[scores={switch.lang=1,switch.trigger.help=-11..}] ["",{"text":"➤ ","color":"gold"},{"text":"/shop: ","color":"yellow"},{"text":"Access the cosmetic shop"}]
tellraw @s[scores={switch.lang=1,switch.trigger.help=-11..}] ["",{"text":"➤ ","color":"gold"},{"text":"/detach or /spawn: ","color":"yellow"},{"text":"Detaches from Switch Engine"}]
...
tellraw @s[scores={switch.lang=1,switch.trigger.help=-11..}] ["",{"text":"➤ ","color":"gold"},{"text":"/stats [<player>]: ","color":"yellow"},{"text":"Display your statistics or a player's statistics"}]
tellraw @s[scores={switch.lang=1,switch.trigger.help=-11..}] ["",{"text":"➤ ","color":"gold"},{"text":"/succes [<player>]: ","color":"yellow"},{"text":"Display all advancements of a player"}]
...
""")
	...
	# /trigger_money_
	write_function(f"{path}/trigger_money_", """
# French
...
""")
	...
	write_function(f"{path}/trigger_rating_display", r"""
# French
tellraw @s[scores={switch.lang=0}] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Liste des mini-jeux :"}]

# English
tellraw @s[scores={switch.lang=1}] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Minigames list:"}]
""")

	# /trigger_rating_display_loop
	write_function(f"{path}/trigger_rating_display_loop", """
# French
$execute if score #digits switch.data matches ..9 run tellraw @s[scores={switch.lang=0}] [{"text":"➤ ","color":"aqua","hover_event":{"action":"show_text","value":{"text":"Cliquez pour noter","color":"gray"}},"click_event":{"action":"run_command","command":"/trigger switch.trigger.rating set $(index_hundred)"}},{"nbt":"name_fr","storage":"switch:temp","interpret":true,"color":"dark_aqua"},{"text":" avec un score de "},{"text":"$(int).0$(digits)","color":"yellow"},{"text":" (","color":"gray"},{"score":{"name":"#nb_ratings","objective":"switch.data"},"color":"gray"},{"text":" notes)","color":"gray"}]
$execute if score #digits switch.data matches 10.. run tellraw @s[scores={switch.lang=0}] [{"text":"➤ ","color":"aqua","hover_event":{"action":"show_text","value":{"text":"Cliquez pour noter","color":"gray"}},"click_event":{"action":"run_command","command":"/trigger switch.trigger.rating set $(index_hundred)"}},{"nbt":"name_fr","storage":"switch:temp","interpret":true,"color":"dark_aqua"},{"text":" avec un score de "},{"text":"$(int).$(digits)","color":"yellow"},{"text":" (","color":"gray"},{"score":{"name":"#nb_ratings","objective":"switch.data"},"color":"gray"},{"text":" notes)","color":"gray"}]

# English
$execute if score #digits switch.data matches ..9 run tellraw @s[scores={switch.lang=1}] [{"text":"➤ ","color":"aqua","hover_event":{"action":"show_text","value":{"text":"Click to rate","color":"gray"}},"click_event":{"action":"run_command","command":"/trigger switch.trigger.rating set $(index_hundred)"}},{"nbt":"name_en","storage":"switch:temp","interpret":true,"color":"dark_aqua"},{"text":" with a score of "},{"text":"$(int).0$(digits)","color":"yellow"},{"text":" (","color":"gray"},{"score":{"name":"#nb_ratings","objective":"switch.data"},"color":"gray"},{"text":" ratings)","color":"gray"}]
$execute if score #digits switch.data matches 10.. run tellraw @s[scores={switch.lang=1}] [{"text":"➤ ","color":"aqua","hover_event":{"action":"show_text","value":{"text":"Click to rate","color":"gray"}},"click_event":{"action":"run_command","command":"/trigger switch.trigger.rating set $(index_hundred)"}},{"nbt":"name_en","storage":"switch:temp","interpret":true,"color":"dark_aqua"},{"text":" with a score of "},{"text":"$(int).$(digits)","color":"yellow"},{"text":" (","color":"gray"},{"score":{"name":"#nb_ratings","objective":"switch.data"},"color":"gray"},{"text":" ratings)","color":"gray"}]
""")

	# /trigger_rating_note
	write_function(f"{path}/trigger_rating_note", """
# French
...
""")
	...
	write_function(f"{path}/trigger_rating_print", """
# French
...
execute if data storage switch:temp temp if data storage switch:temp {temp:1} run tellraw @s[scores={switch.lang=0}] [{"text":"Votre vote actuel est de ","color":"gold"},{"nbt":"temp","storage":"switch:temp","plain":true,"color":"yellow"},{"text":" étoile."}]
execute if data storage switch:temp temp unless data storage switch:temp {temp:1} run tellraw @s[scores={switch.lang=0}] [{"text":"Votre vote actuel est de ","color":"gold"},{"nbt":"temp","storage":"switch:temp","plain":true,"color":"yellow"},{"text":" étoiles."}]
...
execute if data storage switch:temp temp if data storage switch:temp {temp:1} run tellraw @s[scores={switch.lang=1}] [{"text":"Your current vote is ","color":"gold"},{"nbt":"temp","storage":"switch:temp","plain":true,"color":"yellow"},{"text":" star."}]
execute if data storage switch:temp temp unless data storage switch:temp {temp:1} run tellraw @s[scores={switch.lang=1}] [{"text":"Your current vote is ","color":"gold"},{"nbt":"temp","storage":"switch:temp","plain":true,"color":"yellow"},{"text":" stars."}]
...
""")
	...
	write_function(f"{path}/trigger_stats_display_loop", r"""
# French
...
""")
	...
	# /trigger_stats_main
	write_function(f"{path}/trigger_stats_main", r"""
# French
...
""")
	...
	write_function(f"{path}/trigger_succes_display_loop", r"""
# French
$execute if data storage switch:advancements all[{id:$(id)}].players[{name:"$(player)"}] run tellraw @s[scores={switch.lang=0}] [{"text":"➤","color":"aqua","hover_event":{"action":"show_text","value":[{"text":"[$(name)]\n","color":"$(color)"},{"text":"$(description)\n","color":"white"},{"nbt":"temp.percent.int","storage":"switch:temp","plain":true,"color":"dark_aqua"},{"text":",","color":"dark_aqua"},{"nbt":"temp.percent.digits","storage":"switch:temp","plain":true,"color":"dark_aqua"},{"text":"% de réussite soit $(total) joueurs","color":"aqua"},{"text":"\n\n[Proposé par $(auteur)]","color":"gray"}]}},{"text":" [$(name)] ","color":"$(color)"},{"text":"avec ","color":"aqua"},{"nbt":"temp.percent.int","storage":"switch:temp","plain":true,"color":"dark_aqua"},{"text":",","color":"dark_aqua"},{"nbt":"temp.percent.digits","storage":"switch:temp","plain":true,"color":"dark_aqua"},{"text":"% de réussite","color":"aqua"}]

# English
$execute if data storage switch:advancements all[{id:$(id)}].players[{name:"$(player)"}] run tellraw @s[scores={switch.lang=1}] [{"text":"➤","color":"aqua","hover_event":{"action":"show_text","value":[{"text":"[$(name)]\n","color":"$(color)"},{"text":"$(description_en)\n","color":"white"},{"nbt":"temp.percent.int","storage":"switch:temp","plain":true,"color":"dark_aqua"},{"text":",","color":"dark_aqua"},{"nbt":"temp.percent.digits","storage":"switch:temp","plain":true,"color":"dark_aqua"},{"text":"% success or $(total) players","color":"aqua"},{"text":"\n\n[Suggested by $(auteur)]","color":"gray"}]}},{"text":" [$(name)] ","color":"$(color)"},{"text":"with ","color":"aqua"},{"nbt":"temp.percent.int","storage":"switch:temp","plain":true,"color":"dark_aqua"},{"text":",","color":"dark_aqua"},{"nbt":"temp.percent.digits","storage":"switch:temp","plain":true,"color":"dark_aqua"},{"text":"% success","color":"aqua"}]
""")

	# /trigger_succes_display_loop_2
	write_function(f"{path}/trigger_succes_display_loop_2", r"""
# French
$execute unless data storage switch:advancements all[{id:$(id)}].players[{name:"$(player)"}] run tellraw @s[scores={switch.lang=0}] [{"text":"➤","color":"gray","hover_event":{"action":"show_text","value":[{"text":"[$(name)]\n","color":"$(color)"},{"text":"$(description)\n","color":"white"},{"nbt":"temp.percent.int","storage":"switch:temp","plain":true,"color":"dark_gray"},{"text":",","color":"dark_gray"},{"nbt":"temp.percent.digits","storage":"switch:temp","plain":true,"color":"dark_gray"},{"text":"% de réussite soit $(total) joueurs","color":"gray"},{"text":"\n\n[Proposé par $(auteur)]","color":"gray"}]}},{"text":" [$(name)] ","color":"$(color)"},{"text":"avec ","color":"gray"},{"nbt":"temp.percent.int","storage":"switch:temp","plain":true,"color":"dark_gray"},{"text":",","color":"dark_gray"},{"nbt":"temp.percent.digits","storage":"switch:temp","plain":true,"color":"dark_gray"},{"text":"% de réussite","color":"gray"}]

# English
$execute unless data storage switch:advancements all[{id:$(id)}].players[{name:"$(player)"}] run tellraw @s[scores={switch.lang=1}] [{"text":"➤","color":"gray","hover_event":{"action":"show_text","value":[{"text":"[$(name)]\n","color":"$(color)"},{"text":"$(description_en)\n","color":"white"},{"nbt":"temp.percent.int","storage":"switch:temp","plain":true,"color":"dark_gray"},{"text":",","color":"dark_gray"},{"nbt":"temp.percent.digits","storage":"switch:temp","plain":true,"color":"dark_gray"},{"text":"% success or $(total) players","color":"gray"},{"text":"\n\n[Suggested by $(auteur)]","color":"gray"}]}},{"text":" [$(name)] ","color":"$(color)"},{"text":"with ","color":"gray"},{"nbt":"temp.percent.int","storage":"switch:temp","plain":true,"color":"dark_gray"},{"text":",","color":"dark_gray"},{"nbt":"temp.percent.digits","storage":"switch:temp","plain":true,"color":"dark_gray"},{"text":"% success","color":"gray"}]
""")

	# /trigger_succes_main
	write_function(f"{path}/trigger_succes_main", r"""
# French
...
""")
	...
	# /tutorial_second
	write_function(f"{path}/tutorial_second", r"""
# French
...
execute if score @s switch.tutorial matches 0 if score #dialog_type switch.data matches 0 run tellraw @s[scores={switch.lang=0}] [{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Bienvenue à toi sur l'espace Switch "},{"nbt":"cutted_username","storage":"switch:temp","interpret":true,"color":"gold"},{"text":"-chan !","color":"gold"}]
execute if score @s switch.tutorial matches 0 if score #dialog_type switch.data matches 1 run tellraw @s[scores={switch.lang=0}] [{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Bienvenue à toi sur l'espace Switch "},{"nbt":"cutted_username","storage":"switch:temp","interpret":true,"color":"gold"},{"text":"-kun !","color":"gold"}]
execute if score @s switch.tutorial matches 0 if score #dialog_type switch.data matches 2 run tellraw @s[scores={switch.lang=0}] [{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Bienvenue à toi sur l'espace Switch "},{"nbt":"cutted_username","storage":"switch:temp","interpret":true,"color":"gold"},{"text":"-sama !","color":"gold"}]
execute if score @s switch.tutorial matches 0 if score #dialog_type switch.data matches 3 run tellraw @s[scores={switch.lang=0}] [{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Bienvenue à toi sur l'espace Switch "},{"nbt":"cutted_username","storage":"switch:temp","interpret":true,"color":"gold"},{"text":"-sensei !","color":"gold"}]
execute if score @s switch.tutorial matches 0 if score #dialog_type switch.data matches 4 run tellraw @s[scores={switch.lang=0}] [{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Bienvenue à toi sur l'espace Switch "},{"nbt":"cutted_username","storage":"switch:temp","interpret":true,"color":"gold"},{"text":"-san !","color":"gold"}]
execute if score @s switch.tutorial matches 0 if score #dialog_type switch.data matches 5 run tellraw @s[scores={switch.lang=0}] [{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Bienvenue à toi sur l'espace Switch "},{"nbt":"cutted_username","storage":"switch:temp","interpret":true,"color":"gold"},{"text":"-senpai !","color":"gold"}]
execute if score @s switch.tutorial matches 0 if score #dialog_type switch.data matches 0 run tellraw @s[scores={switch.lang=0}] [{"text":"Ah pardon, je suis peut-être trop familier avec toi, désolé "},{"nbt":"username","storage":"switch:temp","interpret":true,"color":"gold"},{"text":"...\nBref, je suis le moteur de l'espace Switch, je suis là pour t'aider à comprendre comment tout fonctionne ici !\nActuellement, tu es séparé du reste du monde, mais ne t'inquiète pas, tu pourras bientôt rejoindre les autres joueurs !"}]
execute if score @s switch.tutorial matches 0 if score #dialog_type switch.data matches 1 run tellraw @s[scores={switch.lang=0}] [{"text":"Ah excuse-moi, je suis peut-être trop familier avec toi, désolé "},{"nbt":"username","storage":"switch:temp","interpret":true,"color":"gold"},{"text":"...\nBon, je suis le moteur de l'espace Switch et je vais t'expliquer comment tout fonctionne ici !\nPour l'instant, tu ne peux pas lire les messages des autres joueurs, jusqu'à tu finisses ce tutoriel !"}]
execute if score @s switch.tutorial matches 0 if score #dialog_type switch.data matches 2 run tellraw @s[scores={switch.lang=0}] [{"text":"Ah désolé, je suis peut-être un peu trop familier avec toi "},{"nbt":"username","storage":"switch:temp","interpret":true,"color":"gold"},{"text":"...\nEnfin, je suis le moteur de l'espace Switch, et je vais t'aider à comprendre comment tout fonctionne ici !\nActuellement, tu es isolé des autres joueurs, mais ne t'en fais pas, tu pourras bientôt les rejoindre !"}]
execute if score @s switch.tutorial matches 0 if score #dialog_type switch.data matches 3 run tellraw @s[scores={switch.lang=0}] [{"text":"Oh pardon, je suis peut-être un peu trop familier avec toi, désolé "},{"nbt":"username","storage":"switch:temp","interpret":true,"color":"gold"},{"text":"...\nEh bien, je suis le moteur de l'espace Switch, et je vais te guider pour comprendre comment tout fonctionne ici !\nPour le moment, tu es séparé des autres joueurs, mais rassure-toi, tu pourras bientôt les rejoindre !"}]
execute if score @s switch.tutorial matches 0 if score #dialog_type switch.data matches 4 run tellraw @s[scores={switch.lang=0}] [{"text":"Oh excuse-moi, je suis peut-être trop familier avec toi, désolé "},{"nbt":"username","storage":"switch:temp","interpret":true,"color":"gold"},{"text":"...\nAlors voilà, je suis le moteur de l'espace Switch, et je suis là pour t'aider à comprendre comment tout fonctionne ici !\nActuellement, tu es séparé des autres joueurs, mais ne t'inquiète pas, tu pourras bientôt les rejoindre !"}]
execute if score @s switch.tutorial matches 0 if score #dialog_type switch.data matches 5 run tellraw @s[scores={switch.lang=0}] [{"text":"Oh, je m'excuse, peut-être que je suis un peu trop familier avec toi "},{"nbt":"username","storage":"switch:temp","interpret":true,"color":"gold"},{"text":"...\nEnfin, je suis le moteur de l'espace Switch, et je vais te guider pour que tu comprennes comment tout fonctionne ici !\nPour l'instant, tu es séparé des autres joueurs, mais ne t'en fais pas, tu pourras bientôt les rejoindre !"}]
...
execute if score @s switch.tutorial matches 6 run tellraw @s[scores={switch.lang=0}] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Tapez '/detach' ou '/spawn' pour terminer le tutoriel !","color":"green"}]
...
execute if score @s switch.tutorial matches 0 if score #dialog_type switch.data matches 0 run tellraw @s[scores={switch.lang=1}] [{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Welcome to the Switch space"},{"nbt":"cutted_username","storage":"switch:temp","interpret":true,"color":"gold"},{"text":"-chan!","color":"gold"}]
execute if score @s switch.tutorial matches 0 if score #dialog_type switch.data matches 1 run tellraw @s[scores={switch.lang=1}] [{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Welcome to the Switch space"},{"nbt":"cutted_username","storage":"switch:temp","interpret":true,"color":"gold"},{"text":"-kun !","color":"gold"}]
execute if score @s switch.tutorial matches 0 if score #dialog_type switch.data matches 2 run tellraw @s[scores={switch.lang=1}] [{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Welcome to the Switch space"},{"nbt":"cutted_username","storage":"switch:temp","interpret":true,"color":"gold"},{"text":"-sama!","color":"gold"}]
execute if score @s switch.tutorial matches 0 if score #dialog_type switch.data matches 3 run tellraw @s[scores={switch.lang=1}] [{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Welcome to the Switch space"},{"nbt":"cutted_username","storage":"switch:temp","interpret":true,"color":"gold"},{"text":"-sensei!","color":"gold"}]
execute if score @s switch.tutorial matches 0 if score #dialog_type switch.data matches 4 run tellraw @s[scores={switch.lang=1}] [{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Welcome to the Switch space"},{"nbt":"cutted_username","storage":"switch:temp","interpret":true,"color":"gold"},{"text":"-san !","color":"gold"}]
execute if score @s switch.tutorial matches 0 if score #dialog_type switch.data matches 5 run tellraw @s[scores={switch.lang=1}] [{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Welcome to the Switch space"},{"nbt":"cutted_username","storage":"switch:temp","interpret":true,"color":"gold"},{"text":"-senpai !","color":"gold"}]
execute if score @s switch.tutorial matches 0 if score #dialog_type switch.data matches 0 run tellraw @s[scores={switch.lang=1}] [{"text":"Ah sorry, maybe I'm too familiar with you, sorry "},{"nbt":"username","storage":"switch:temp","interpret":true,"color":"gold"},{"text":"...\nHowever, I'm the Switch engine, I'm here to help you understand how everything works here!\nCurrently, you're separated from the rest of the world, but don't worry, you'll soon be able to join the other players!"}]
execute if score @s switch.tutorial matches 0 if score #dialog_type switch.data matches 1 run tellraw @s[scores={switch.lang=1}] [{"text":"Ah excuse me, perhaps I'm too familiar with you, sorry "},{"nbt":"username","storage":"switch:temp","interpret":true,"color":"gold"},{"text":"...\nOkay, I'm the Switch engine and I'm going to explain how everything works here!\nFor the moment, you can't read other players' messages, until you finish this tutorial!"}]
execute if score @s switch.tutorial matches 0 if score #dialog_type switch.data matches 2 run tellraw @s[scores={switch.lang=1}] [{"text":"Ah sorry, maybe I'm a bit too familiar with you "},{"nbt":"username","storage":"switch:temp","interpret":true,"color":"gold"},{"text":"...\nFinally, I'm the Switch engine, and I'm going to help you understand how everything works here!\nAt the moment, you're isolated from the other players, but don't worry, you'll soon be able to join them!"}]
execute if score @s switch.tutorial matches 0 if score #dialog_type switch.data matches 3 run tellraw @s[scores={switch.lang=1}] [{"text":"Oh sorry, maybe I'm a bit too familiar with you, sorry "},{"nbt":"username","storage":"switch:temp","interpret":true,"color":"gold"},{"text":"...\nWell, I'm the Switch engine, and I'm going to guide you through how everything works here!\nFor the moment, you're separated from the other players, but don't worry, you'll soon be able to join them!"}]
execute if score @s switch.tutorial matches 0 if score #dialog_type switch.data matches 4 run tellraw @s[scores={switch.lang=1}] [{"text":"Oh excuse me, maybe I'm too familiar with you, sorry "},{"nbt":"username","storage":"switch:temp","interpret":true,"color":"gold"},{"text":"...\nSo here I am, the Switch engine, and I'm here to help you understand how everything works here!\nCurrently, you're separated from the other players, but don't worry, you'll soon be able to join them!"}]
execute if score @s switch.tutorial matches 0 if score #dialog_type switch.data matches 5 run tellraw @s[scores={switch.lang=1}] [{"text":"Oh, I'm sorry, maybe I'm a little too familiar with you "},{"nbt":"username","storage":"switch:temp","interpret":true,"color":"gold"},{"text":"...\nFinally, I'm the engine of the Switch space, and I'm going to guide you so that you understand how everything works here!\nFor the moment, you're separated from the other players, but don't worry, you'll soon be able to join them!"}]
...
execute if score @s switch.tutorial matches 6 run tellraw @s[scores={switch.lang=1}] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Type '/detach' or '/spawn' to end the tutorial!","color":"green"}]
