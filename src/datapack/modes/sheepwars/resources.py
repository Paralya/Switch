...
def write_resources() -> None:
	...
	switch.advancements["sheepwars/lightning_strike"] = set_json_encoder(Advancement({
		...
		"rewards": {"function": "switch:modes/sheepwars/advancements/lightning_strike"},
	}))
	...
	hooks["signals/magic_wool_shot"] = FunctionTag({"values": ["switch:modes/sheepwars/magic_wool/slot"]})
	hooks["signals/player_killed"] = FunctionTag({"values": ["switch:modes/sheepwars/advancements/call_player_killed"]})
