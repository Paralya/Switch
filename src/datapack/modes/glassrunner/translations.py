...
def write_translations():
	...
	path: str = f"{Mem.ctx.project_id}:modes/glassrunner/translations"

	# /apocalypse_start
	write_function(f"{path}/apocalypse_start", """
# French
tellraw @a[scores={switch.lang=0},tag=!detached] ["\\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" C'est l'APOCALYPSE !","color":"dark_red"}]

# English
tellraw @a[scores={switch.lang=1},tag=!detached] ["\\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" This is APOCALYPSE!","color":"dark_red"}]
""")

	# /end_blue
	write_function(f"{path}/end_blue", """
# French
...
""")
	...
	# /end_null
	write_function(f"{path}/end_null", """
# French
tellraw @a[scores={switch.lang=0},tag=!detached] ["",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Fin du mini-jeu ! Personne n'a gagné, le jeu c'est fini au temps"}]

# English
tellraw @a[scores={switch.lang=1},tag=!detached] ["",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" End of mini-game! Nobody won, the game's over on time"}]
""")

	# /end_red
	write_function(f"{path}/end_red", """
# French
tellraw @a[scores={switch.lang=0},tag=!detached] ["",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Fin du mini-jeu ! Les rouges ont gagnés"}]

# English
tellraw @a[scores={switch.lang=1},tag=!detached] ["",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" End of the mini-game! The reds have won"}]
""")

	# /fireball_use
	write_function(f"{path}/fireball_use", """
# French
tellraw @s[scores={switch.lang=0}] ["",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Vous avez dépensé 15 pièces pour invoquer une boule de feu !"}]

# English
tellraw @s[scores={switch.lang=1}] ["",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" You spent 15 coins to summon a fireball!"}]
""")

	# /shop_apocalypse
	write_function(f"{path}/shop_apocalypse", """
# French
...
""")
	...
	# /shop_arrow
	write_function(f"{path}/shop_arrow", """
# French
...
""")
	...
	# /shop_elytra
	write_function(f"{path}/shop_elytra", """
# French
...
""")
	...
	# /shop_igloo
	write_function(f"{path}/shop_igloo", """
# French
execute unless score @s switch.glassrunner.money matches 20.. run tellraw @s[scores={switch.lang=0}] ["",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Tu n'as pas assez d'argent","color":"red"}]
...
""")
	...
	# /shop_snowball
	write_function(f"{path}/shop_snowball", """
# French
...
# English
execute unless score @s switch.glassrunner.money matches 8.. run tellraw @s[scores={switch.lang=1}] ["",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" You don't have enough coins","color":"red"}]
...
""")
	...
	# /shop_turtle
	write_function(f"{path}/shop_turtle", """
# French
