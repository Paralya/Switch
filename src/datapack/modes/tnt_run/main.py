...
execute if score #count {ns}.data matches 0 run fill ~-.3 ~ ~-.3 ~.3 ~-5 ~.3 air replace #realistic_explosion:equal_and_below_1200
...
execute if score #temp {ns}.data matches -8 run summon marker ~ ~ ~ {{Tags:["{ns}.tnt_run"]}}
execute unless score #temp {ns}.data matches -8 unless block ~ ~-.25 ~ air run summon marker ~ ~ ~ {{Tags:["{ns}.tnt_run"]}}
""")
