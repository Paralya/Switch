...
execute if score @s {ns}.spleef.snow_block matches 0 run item replace entity @s hotbar.8 with snow_block 4
execute if score @s {ns}.spleef.snow_block matches 1 run item replace entity @s hotbar.8 with snow_block 5
execute if score @s {ns}.spleef.snow_block matches 2 run item replace entity @s hotbar.8 with snow_block 6
execute if score @s {ns}.spleef.snow_block matches 3 run item replace entity @s hotbar.8 with snow_block 7
execute if score @s {ns}.spleef.snow_block matches 4 run item replace entity @s hotbar.8 with snow_block 8
execute if score @s {ns}.spleef.snow_block matches 5 run item replace entity @s hotbar.8 with snow_block 9
execute if score @s {ns}.spleef.snow_block matches 6.. run item replace entity @s hotbar.8 with snow_block 10
