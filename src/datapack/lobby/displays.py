""" The lobby boards: jump leaderboards and the global statistics displays.
...
def write_displays() -> None:
	""" Write switch:lobby/second, which refreshes every board once per second. """
