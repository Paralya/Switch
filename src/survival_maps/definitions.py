...
def generate_folders_for_survival_maps() -> None:
	...
	clone_survival(100, (22000, 100, 22000), (22226, 181, 22245), ("bowser_castle", "Bowser Castle", "Flamingosaurus & co"), view=(22073.60, 132.45, 22130.03, 169.63, -8.65), racing_pos=((22065.5, 130.69, 22168.5), 180, 60))
	...
	clone_survival(100, (68000, 100, 68000), (68100, 190, 68100), ("void_desert", "Void Desert", "Stoupy"), view=(68070.03, 137.81, 68006.29, 19.81, 42.61))
	...
	clone_survival(100, (124001, 84, 124047), (124041, 136, 124092), ("gg_grass_1", "Gracy Grass", "Remelta, Fhara"), view=(124012.09, 117.63, 124050.15, -16.77, 12.77))
	clone_survival(100, (124001, 84, 124001), (124041, 136, 124046), ("gg_grass_2", "Bridgy Grass", "Remelta, Fhara"), view=(124029.73, 120.77, 124004.04, 25.30, 25.29))
	clone_survival(100, (124124, 84, 124093), (124164, 136, 124138), ("gg_grass_3", "Cavy Grass", "Remelta, Fhara"), view=(124152.54, 133.53, 124097.18, 23.48, 42.02))
	clone_survival(100, (124042, 84, 124001), (124082, 136, 124046), ("gg_snow_1", "Snow Cloud", "Remelta, Fhara"), view=(124051.89, 129.29, 124040.26, -153.55, 30.40))
	clone_survival(100, (124042, 84, 124047), (124082, 136, 124092), ("gg_snow_2", "Château des bleds", "Remelta, Fhara"), view=(124053.63, 123.16, 124053.23, -22.15, 25.07))
	clone_survival(100, (124083, 84, 124047), (124123, 136, 124092), ("gg_ice_1", "Icy Rage", "Remelta, Fhara"), view=(124091.13, 120.51, 124091.09, 213.64, 15.99))
	clone_survival(100, (124083, 84, 124001), (124123, 136, 124046), ("gg_temple", "Temple des Dieux", "Remelta, Fhara, Oraclette"), view=(124120.78, 121.87, 124004.26, 40.35, 17.71))
	clone_survival(100, (124124, 84, 124001), (124164, 136, 124046), ("gg_volcano", "Volcany-chan", "Remelta, Fhara, Oraclette"), view=(124126.40, 122.20, 124041.21, -129.68, 8.56))
	clone_survival(100, (124124, 84, 124047), (124164, 136, 124092), ("gg_desert_1", "Y fait chaud ici!", "Remelta, Fhara"), view=(124158.17, 117.59, 124053.87, 44.14, 5.92))
	clone_survival(100, (124083, 84, 124093), (124123, 136, 124138), ("gg_end_1", "Back to the overworld", "Remelta, Fhara"), view=(124085.32, 130.43, 124111.17, 286.61, 19.27))
	clone_survival(100, (124042, 84, 124094), (124081, 136, 124138), ("gg_chamber", "Chambre de Stoupette", "Remelta, Fhara"), view=(124077.56, 138.51, 124099.96, 43.15, 25.21))
