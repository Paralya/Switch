...
def generate_folders_for_survival_maps() -> None:
	...
	clone_survival(100, (124083, 84, 124001), (124123, 136, 124046), ("gg_temple", "Temple des Dieux", "Remelta, Fhara"), view=(124120.78, 121.87, 124004.26, 40.35, 17.71))
	clone_survival(100, (124124, 84, 124001), (124164, 136, 124046), ("gg_volcano", "Volcany-chan", "Remelta, Fhara"), view=(124126.40, 122.20, 124041.21, -129.68, 8.56))
