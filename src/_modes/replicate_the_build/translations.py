...
def write_translations():
	...
	path: str = f"{Mem.ctx.project_id}:modes/replicate_the_build/translations"

	# /round_0
	write_function(f"{path}/round_0", r"""
# French
title @a[scores={switch.lang=0},tag=!detached] times 0t 20t 0
title @a[scores={switch.lang=0},tag=!detached] title {"text":"3","color":"green"}

# English
title @a[scores={switch.lang=1},tag=!detached] times 0t 20t 0
title @a[scores={switch.lang=1},tag=!detached] title {"text":"3","color":"green"}
""")

	# /round_1
	write_function(f"{path}/round_1", r"""
# French
title @a[scores={switch.lang=0},tag=!detached] times 0t 20t 0
title @a[scores={switch.lang=0},tag=!detached] title {"text":"2","color":"green"}

# English
title @a[scores={switch.lang=1},tag=!detached] times 0t 20t 0
title @a[scores={switch.lang=1},tag=!detached] title {"text":"2","color":"green"}
""")

	# /round_2
	write_function(f"{path}/round_2", r"""
# French
title @a[scores={switch.lang=0},tag=!detached] times 0t 20t 0
title @a[scores={switch.lang=0},tag=!detached] title {"text":"1","color":"green"}

# English
title @a[scores={switch.lang=1},tag=!detached] times 0t 20t 0
title @a[scores={switch.lang=1},tag=!detached] title {"text":"1","color":"green"}
""")

	# /round_3
	write_function(f"{path}/round_3", r"""
# French
title @a[scores={switch.lang=0},tag=!detached] times 0t 20t 0
title @a[scores={switch.lang=0},tag=!detached] title {"text":"Mémorisez !","color":"green"}
...
""")
	...
	# /round_7_end
	write_function(f"{path}/round_7_end", r"""
# French
...
# English
tellraw @a[scores={switch.lang=1},tag=!detached] ["\n",{"nbt":"Paralya","storage":"switch:main","interpret":true},{"text":" Starting the Replicate The Build game, get ready as you have a 5 second preparation time!"}]
""")

	# /utils_display_score
	write_function(f"{path}/utils_display_score", r"""
# French
title @s[scores={switch.lang=0}] title [{"text":"Votre score est de :","color":"green"}]
title @s[scores={switch.lang=0}] subtitle [{"score":{"name":"@p[tag=switch.temp]","objective":"switch.rtb.points"},"color":"green"},{"text":"/343","color":"green"}]
...
""")
	...
	write_function(f"{path}/utils_finish_building_player", r"""
# French
