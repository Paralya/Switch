...
def main() -> None:
	path: str = "switch:cinematic"

	# /alt_launch
	write_function(f"{path}/alt_launch", """
#> alt_launch
#
...
""")
	...
	# /common_launch
	write_function(f"{path}/common_launch", """
...
""")
	...
	write_function(f"{path}/entity_tick_at_player", """
...
""")
	...
	# /entity_tick_at_self
	write_function(f"{path}/entity_tick_at_self", """
...
""")
	...
	write_function(f"{path}/get_position_between/main", """
...
""")
	...
	write_function(f"{path}/get_position_between/side_offset", """
# Go to the half position
...
""")
	...
	write_function(f"{path}/get_rotation_arguments", """
...
""")
	...
	write_function(f"{path}/intro_spread/cinematic_start", """
...
""")
	...
	write_function(f"{path}/intro_spread/fade_in", """
...
""")
	...
	write_function(f"{path}/intro_spread/fade_out", """
...
""")
	...
	write_function(f"{path}/intro_spread/playsound", """
# Fade in playsound
execute at @e[tag=switch.intro_spread.map_name] run playsound item.mace.smash_ground_heavy ambient @a
""")

	# /intro_spread/start
	write_function(f"{path}/intro_spread/start", """
#> intro_spread
#
...
""")
	...
	# /setup_entity
	write_function(f"{path}/setup_entity", """
