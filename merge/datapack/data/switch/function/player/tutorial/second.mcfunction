...
# Init dialog
execute if score @s switch.tutorial matches 0 run data modify storage switch:temp cutted_username set string entity @s Inventory[-1].components."minecraft:profile".name 0 4
execute if score @s switch.tutorial matches 0 run data modify storage switch:temp username set from entity @s Inventory[-1].components."minecraft:profile".name
