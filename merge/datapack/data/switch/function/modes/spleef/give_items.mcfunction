...
data modify block 0 0 0 Items append value {id:"white_shulker_box",count:1,Slot:1b,components:{"minecraft:item_name":'{"text":"Powder Snow","color":"white","italic":false}',"minecraft:item_model":"minecraft:powder_snow_bucket"}}
execute if score @s switch.spleef.powder_snow matches 0 run data modify block 0 0 0 Items[1].count set value 4
execute if score @s switch.spleef.powder_snow matches 1 run data modify block 0 0 0 Items[1].count set value 5
execute if score @s switch.spleef.powder_snow matches 2 run data modify block 0 0 0 Items[1].count set value 6
execute if score @s switch.spleef.powder_snow matches 3 run data modify block 0 0 0 Items[1].count set value 7
execute if score @s switch.spleef.powder_snow matches 4.. run data modify block 0 0 0 Items[1].count set value 8
