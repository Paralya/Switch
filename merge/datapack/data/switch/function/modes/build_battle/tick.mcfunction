...
execute if score #build_battle_state switch.data matches 0 as @a[tag=!detached] in switch:game run function switch:modes/build_battle/preparation/display_themes with storage switch:main themes
