...
$item replace block 0 0 0 container.0 with paper{display:{Name:'{"text":"$(theme1)","color":"yellow","italic":false}',Lore:['""']},HideFlags:7}
$item replace block 0 0 0 container.1 with paper{display:{Name:'{"text":"$(theme2)","color":"yellow","italic":false}',Lore:['""']},HideFlags:7}
$item replace block 0 0 0 container.2 with paper{display:{Name:'{"text":"$(theme3)","color":"yellow","italic":false}',Lore:['""']},HideFlags:7}
$item replace block 0 0 0 container.3 with paper{display:{Name:'{"text":"$(theme4)","color":"yellow","italic":false}',Lore:['""']},HideFlags:7}
