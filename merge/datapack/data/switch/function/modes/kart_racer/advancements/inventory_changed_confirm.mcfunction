...
execute if score #success switch.data matches 1 run item replace entity @s hotbar.0 with warped_fungus_on_a_stick[unbreakable={},custom_name='{"text":"Classic Respawn","color":"yellow","italic":false}',item_model="switch:wormhole_potion",custom_data={switch:{classic_respawn:1b}}]
execute if score #success switch.data matches 1 run item replace entity @s hotbar.1 with warped_fungus_on_a_stick[unbreakable={},custom_name='{"text":"Hard Respawn","color":"yellow","italic":false}',item_model="switch:travel_staff",custom_data={switch:{hard_respawn:1b}}]
...
execute if score #success switch.data matches 1 if score #can_vote switch.data matches 1 run item replace entity @s hotbar.8 with warped_fungus_on_a_stick[unbreakable={},custom_name='{"text":"Voter pour changer de map","color":"yellow","italic":false}',item_model="switch:quarry_configurator",custom_data={switch:{change_map:1b,vote:1b}}]
execute if score #success switch.data matches 1 run item replace entity @s weapon.offhand with warped_fungus_on_a_stick[unbreakable={},custom_name='{"text":"Détection de click","color":"yellow","italic":false}',item_model="minecraft:air",custom_data={switch:{right_click_detect:1b}}]
