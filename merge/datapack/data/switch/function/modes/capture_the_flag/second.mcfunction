...
execute if score #capture_the_flag_seconds switch.data matches ..-1 as @a[tag=!detached] run attribute @s generic.jump_strength base set 0
...
execute if score #capture_the_flag_seconds switch.data matches 0 as @a[tag=!detached] run attribute @s generic.jump_strength base set 0.42
