...
function switch:utils/choose_map_for {id:"traitors_game", maps:["traitor_original","mushroom_plains","zonweeb_highschool","hider_mansion","bancalvivor_s4","stardust_pvp_zone","la_fromagerie"]}
