...
# Spawning creepers
execute if score #pitch_creep_seconds switch.data matches 0.. if data storage switch:main {map:"pitch_creep_1"} positioned 3520 126 3520 run summon creeper ~-.2 ~ ~ {Health:2048.0f,Tags:["switch.new"],attributes:[{id:"max_health",base:2048.0},{id:"follow_range",base:128}]}
execute if score #pitch_creep_seconds switch.data matches 0.. if data storage switch:main {map:"pitch_creep_1"} positioned 3520 126 3520 run summon creeper ~.2 ~ ~ {Health:2048.0f,Tags:["switch.new"],attributes:[{id:"max_health",base:2048.0},{id:"follow_range",base:128}]}
