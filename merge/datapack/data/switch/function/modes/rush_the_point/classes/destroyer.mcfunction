...
item replace entity @s hotbar.0 with warped_fungus_on_a_stick[unbreakable={show_in_tooltip:false},item_name='{"text":"Fireball Wand","color":"gold","italic":false}',item_model="switch:fireball_wand",custom_data={switch:{fireball_wand:true}}]
