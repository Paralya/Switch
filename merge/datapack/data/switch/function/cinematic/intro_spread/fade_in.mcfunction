...
execute as @e[tag=switch.intro_spread.map_name] run data merge entity @s {interpolation_duration:12,start_interpolation:0,transformation:{scale:[1.0f,1.0f,1.0f]}}
