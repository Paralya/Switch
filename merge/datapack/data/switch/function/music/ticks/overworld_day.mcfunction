...
data modify storage switch:temp input set value {tick:0,name:"overworld_day"}
...
execute if score #temp switch.data >= #overworld_day switch.music.progress run function switch:music/music_over
