...
data modify storage switch:temp input set value {tick:0,name:"monody"}
...
execute if score #temp switch.data >= #monody switch.music.progress run function switch:music/music_over
