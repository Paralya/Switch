...
data modify storage switch:temp input set value {tick:0,name:"dance_of_the_violins"}
...
execute if score #temp switch.data >= #dance_of_the_violins switch.music.progress run function switch:music/music_over
