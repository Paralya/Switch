...
BUILD_COPY_DESTINATIONS: tuple[list, list] = ([f"{ROOT}/_switch_dump"], ["D:/minecraft/snapshot/resourcepacks", "D:/minecraft/latest/resourcepacks"])


# Dev constants
DATABASE_DEBUG: str = f"{ROOT}/database_debug.json"	# Dump of the database for debugging purposes
ENABLE_TRANSLATIONS: bool = False					# Will convert all the text components to translate and generate a lang file in the resource pack.
MERGE_LIBS: bool = True								# Make new zip of merged libraries with the datapack and resource pack using Smithed Weld


# Project information
AUTHOR: str = "Stoupy51"				# Author(s) name(s) displayed in pack.mcmeta, also used to add convention.debug tag to the players of the same name(s)
