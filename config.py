...
BUILD_COPY_DESTINATIONS: tuple[list, list] = ([f"{ROOT}/_switch_sync"], ["D:/minecraft/snapshot/resourcepacks"])	# Can be empty lists if you don't want to copy the generated files to other folders.
