#> iris:find_closest_surface/south/get_distance
# 
...
execute if score $distance iris < $min_distance_to_surface iris run function iris:find_closest_surface/south/find_intersection