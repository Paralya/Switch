...
execute unless score #new shopping_kart.data matches -2500000..2500000 run scoreboard players operation @s shopping_kart.engine *= #3 shopping_kart.data
execute unless score #new shopping_kart.data matches -2500000..2500000 run scoreboard players operation @s shopping_kart.engine /= #2 shopping_kart.data
...
execute if score #new shopping_kart.data matches -2500000..2500000 run scoreboard players operation @s shopping_kart.engine *= #2 shopping_kart.data
