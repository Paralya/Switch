...
execute unless score #new shopping_kart.data matches -2500000..2500000 run scoreboard players operation @s shopping_kart.engine *= #100 shopping_kart.data
execute unless score #new shopping_kart.data matches -2500000..2500000 run scoreboard players operation @s shopping_kart.engine /= #95 shopping_kart.data
...
execute if score #new shopping_kart.data matches -2500000..2500000 run scoreboard players operation @s shopping_kart.engine *= #95 shopping_kart.data
execute if score #new shopping_kart.data matches -2500000..2500000 run scoreboard players operation @s shopping_kart.engine /= #100 shopping_kart.data
...
playsound block.note_block.harp block @a[predicate=shopping_kart:has_vehicle_with_tag]
