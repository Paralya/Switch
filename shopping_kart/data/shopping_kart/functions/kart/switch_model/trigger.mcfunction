...
# If trigger == -4, get a random value between 0 and 52
...
execute if score @s shopping_kart.trigger_model matches -4 run scoreboard players set #53 shopping_kart.data 53
execute if score @s shopping_kart.trigger_model matches -4 run scoreboard players operation #random shopping_kart.current_model %= #53 shopping_kart.data
...
execute if score @s shopping_kart.current_model matches ..-1 run scoreboard players set @s shopping_kart.current_model 52
execute if score @s shopping_kart.current_model matches 53.. run scoreboard players set @s shopping_kart.current_model 0
...
tellraw @s ["",{"nbt":"ShoppingKart","storage":"shopping_kart:main","interpret":true},{"text":" Current Model: ","color":"dark_green"},{"score":{"name":"#temp","objective":"shopping_kart.current_model"},"color":"green"},{"text":"/","color":"dark_green"},{"text":"53","color":"green"}]
