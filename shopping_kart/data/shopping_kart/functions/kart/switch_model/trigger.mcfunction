...
# If trigger == -4, get a random value between 0 and 71
...
execute if score @s shopping_kart.trigger_model matches -4 run scoreboard players set #72 shopping_kart.data 72
execute if score @s shopping_kart.trigger_model matches -4 run scoreboard players operation #random shopping_kart.current_model %= #72 shopping_kart.data
...
execute if score @s shopping_kart.current_model matches ..-1 run scoreboard players set @s shopping_kart.current_model 71
execute if score @s shopping_kart.current_model matches 72.. run scoreboard players set @s shopping_kart.current_model 0
...
tellraw @s ["",{"nbt":"ShoppingKart","storage":"shopping_kart:main","interpret":true},{"text":" Current Model: ","color":"dark_green"},{"score":{"name":"#temp","objective":"shopping_kart.current_model"},"color":"green"},{"text":"/","color":"dark_green"},{"text":"72","color":"green"}]
