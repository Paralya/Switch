...
execute if score #surface shopping_kart.data matches 3 store result score @s shopping_kart.motion_x run data get storage shopping_kart:main Motion[0] 8000000
execute if score #surface shopping_kart.data matches 3 store result score @s shopping_kart.motion_z run data get storage shopping_kart:main Motion[2] 8000000
